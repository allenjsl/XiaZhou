...
namespace EyouSoft.DAL.CrmStructure
{
    ...
    public class DCrmMember : EyouSoft.Toolkit.DAL.DALBase,IDAL.CrmStructure.ICrmMember
    {
        ...
        //static constants
        const string SQL_SELECT_GetInfo = "SELECT A.CompanyId,A.Type,A.CountryId,A.ProvinceId,A.CityId,A.CountyId,A.OperatorId,A.BrevityCode,A.SellerId,A.SellerName,B.* FROM tbl_Crm AS A INNER JOIN tbl_CrmMember AS B ON A.CrmId=B.CrmId WHERE A.CrmId=@CrmId;";
        #endregion
