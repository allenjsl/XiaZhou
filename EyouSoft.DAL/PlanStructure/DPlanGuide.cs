...
namespace EyouSoft.DAL.PlanStructure
{
    ...
    /// 创建时间:2011-09-23
    /// </summary>
    public class DPlanGuide : EyouSoft.Toolkit.DAL.DALBase, EyouSoft.IDAL.PlanStructure.IPlanGuide
    {
        #region 构造
        /// <summary>
        /// 数据库对象
        ...
        {
            return GuideAddOrUpdate(model, false);
        }
        #endregion
        ...
        public bool DeleteGuide(string PlanID)
        {
            ...
            {
                DbCommand cmd = db.GetStoredProcCommand("proc_PlanGuide_Delete");
                db.AddInParameter(cmd, "PlanId", DbType.String, PlanID);
