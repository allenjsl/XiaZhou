                ...
                if (searchInfo.DanWeiType.HasValue)
                {
                    ...
                    switch (searchInfo.DanWeiType.Value)
                    {
                        ...
                        case EyouSoft.Model.EnumType.SmsStructure.DaoRuKeHuType.其他:
                            ...
                            break;
                        case EyouSoft.Model.EnumType.SmsStructure.DaoRuKeHuType.同行客户:
                            _danWeiType = 0;
                ...
                while (rdr.Read())
                {
                    ...
                    if (_danWeiType == 0)
                    {
                        ...
                        switch (crmType)
                        {
                            ...
                            case EyouSoft.Model.EnumType.CrmStructure.CrmType.同行客户: item.DanWeiType = EyouSoft.Model.EnumType.SmsStructure.DaoRuKeHuType.同行客户; break;
                        }
                    }
