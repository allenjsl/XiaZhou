...
namespace EyouSoft.DAL.SmsStructure
{
    ...
    public class DSmsDetail : DALBase, IDAL.SmsStructure.ISmsDetail
    {
        ...
        /// 短信发送明细添加Sql
        /// </summary>
        private const string SqlSmsDetailAdd = @" INSERT INTO [tbl_SmsDetail]
           ([PlanId]
           ,[CompanyId]
           ,[Channel]
           ,[Content]
     ...
     VALUES
        ...
        /// 添加短息发送明细号码Sql
        /// </summary>
        private const string SqlSmsDetail114Add = @" INSERT INTO [tbl_SmsDetail114]
           ([PlanId]
           ,[Code]
           ,[Type])
     VALUES
        ...
        /// 定时短信添加Sql
        /// </summary>
        private const string SqlSmsTimerTaskAdd = @" INSERT INTO [tbl_SmsTimerTask]
           ([TaskId]
           ,[CompanyId]
           ,[Content]
           ,[OperatorId]
     ...
     VALUES
        ...
        private const string SqlSmsTimerTask114Add = @" INSERT INTO [tbl_SmsTimerTask114]
           ([TaskId]
           ,[Code]
           ,[Type])
     VALUES
