...
namespace EyouSoft.DAL.TourStructure
{
    ...
    public class DTourOrder : EyouSoft.Toolkit.DAL.DALBase, ITourOrder
    {
        ...
        #region SQL 语句
        private const string SQL_UPDATE_SetTourOrderContract = "UPDATE tbl_TourOrder SET ContractId=@ContractId,ContractCode=@ContractCode WHERE OrderId=@OrderId";
        #endregion
        ...
        public int AddTourOrderExpand(MTourOrderExpand tourOrderExpand)
        {
            ...
            _db.AddInParameter(cmd, "TourOrderCarLocation", DbType.String, null);
            _db.AddInParameter(cmd, "TourOrderCarTypeSeat", DbType.String, null);
            _db.AddOutParameter(cmd, "Result", DbType.Int32, 4);
            _db.AddInParameter(cmd, "NeiBuXinXi", DbType.String, tourOrderExpand.NeiBuXinXi);
            _db.AddOutParameter(cmd, "IsJiFen", DbType.Int32, 4);
            DbHelper.RunProcedureWithResult(cmd, _db);
            tourOrderExpand.IsJiFen = Convert.ToInt32(_db.GetParameterValue(cmd, "IsJiFen"));
        ...
        public int UpdateOrderSettlement(MOrderSaleBase orderSale, MTourOrderChange orderChange)
        {
            string orderChangeXml = string.Empty;
            if (orderChange != null)
            {
                orderChangeXml = GetTourOrderChangeXml(orderChange);
            }
            DbCommand cmd = _db.GetStoredProcCommand("proc_TourOrder_Update_ConfirmMoney");
            _db.AddInParameter(cmd, "CompanyId", DbType.AnsiStringFixedLength, orderSale.CompanyId);
            _db.AddInParameter(cmd, "TourId", DbType.AnsiStringFixedLength, orderSale.TourId);
            _db.AddInParameter(cmd, "OrderId", DbType.AnsiStringFixedLength, orderSale.OrderId);
            _db.AddInParameter(cmd, "SumPriceAddCost", DbType.Currency, orderSale.SumPriceAddCost);
            _db.AddInParameter(cmd, "SumPriceReduceCost", DbType.Currency, orderSale.SumPriceReduceCost);
            _db.AddInParameter(cmd, "SumPriceAddCostRemark", DbType.String, orderSale.SumPriceAddCostRemark);
            _db.AddInParameter(cmd, "SumPriceReduceCostRemark", DbType.String, orderSale.SumPriceReduceCostRemark);
            _db.AddInParameter(cmd, "ConfirmMoney", DbType.Currency, orderSale.ConfirmMoney);
            _db.AddInParameter(cmd, "ConfirmMoneyStatus", DbType.AnsiStringFixedLength, orderSale.ConfirmMoneyStatus == true ? 1 : 0);
            _db.AddInParameter(cmd, "ConfirmRemark", DbType.String, orderSale.ConfirmRemark);
            _db.AddInParameter(cmd, "PayMentMonth", DbType.String, orderSale.PayMentMonth);
            _db.AddInParameter(cmd, "PayMentDay", DbType.String, orderSale.PayMentDay);
            _db.AddInParameter(cmd, "PayMentAccountId", DbType.Int32, orderSale.PayMentAccountId);
            _db.AddInParameter(cmd, "ConfirmPeople", DbType.String, orderSale.ConfirmPeople);
            _db.AddInParameter(cmd, "ConfirmPeopleId", DbType.AnsiStringFixedLength, orderSale.ConfirmPeopleId);
            _db.AddInParameter(cmd, "DeptId", DbType.AnsiStringFixedLength, orderSale.DeptId);
            _db.AddInParameter(cmd, "TourOrderChange", DbType.String, orderChangeXml);
            _db.AddOutParameter(cmd, "Result", DbType.Int32, 4);
        ...
        public MTourOrderExpand GetTourOrderExpandByOrderId(string orderId)
        {
            ...
            using (IDataReader dr = DbHelper.ExecuteReader(cmd, _db))
            {
                if (dr.Read())
                {
                    ...
                    order.BuyCompanyId = dr.GetString(dr.GetOrdinal("BuyCompanyId"));
                    ...
                    order.SaveSeatDate = !dr.IsDBNull(dr.GetOrdinal("SaveSeatDate")) ? (DateTime?)dr.GetDateTime(dr.GetOrdinal("SaveSeatDate")) : null;
                    ...
                    //计划信息
                    order.SourceId = !dr.IsDBNull(dr.GetOrdinal("SourceId")) ? dr.GetString(dr.GetOrdinal("SourceId")) : string.Empty;
                    order.TourStatus = (TourStatus)dr.GetByte(dr.GetOrdinal("TourStatus"));
                    order.TourSellerId = dr.GetString(dr.GetOrdinal("TourSellerId"));
                    order.TourSellerName = !dr.IsDBNull(dr.GetOrdinal("TourSellerName")) ? dr.GetString(dr.GetOrdinal("TourSellerName")) : string.Empty;
                    ...
                    {
                        order.TourPlanerList = GetTourPlanerListByXml(TourPlaner);
                    }
                    string TourOrderCarLocation = !dr.IsDBNull(dr.GetOrdinal("TourOrderCarLocation")) ? dr.GetString(dr.GetOrdinal("TourOrderCarLocation")) : string.Empty;
                    if (!string.IsNullOrEmpty(TourOrderCarLocation))
                    {
                        order.TourOrderCarLocation = GetTourOrderCarLocationList(TourOrderCarLocation);
                    }

                    order.UnSeat = dr.GetInt32(dr.GetOrdinal("UnSeat"));
                    ...
                    string TourCarType = !dr.IsDBNull(dr.GetOrdinal("TourCarType")) ? dr.GetString(dr.GetOrdinal("TourCarType")) : null;
                    if (!string.IsNullOrEmpty(TourCarType))
                    {
                        order.TourCarTypeList = GetTourCarTypeList(TourCarType);
                    }

                    order.NeiBuXinXi = dr["NeiBuXinXi"].ToString();
                    order.SumPriceAddCost = dr.GetDecimal(dr.GetOrdinal("SumPriceAddCost"));
                    order.SumPriceAddCostRemark = dr["SumPriceAddCostRemark"].ToString();
                    order.SumPriceReduceCost = dr.GetDecimal(dr.GetOrdinal("SumPriceReduceCost"));
                    order.SumPriceReduceCostRemark = dr["SumPriceReduceCostRemark"].ToString();
                    order.JieSuanStatus = dr.GetString(dr.GetOrdinal("JieSuanStatus")) == "1";
                    order.JieSuanTime = dr.GetDateTime(dr.GetOrdinal("JieSuanTime"));
                }
            }
        ...
        public OrderMoney GetOrderMoney(string orderId)
        {
            ...
            query.Append(" ,ConfirmMoneyStatus ");
        ...
        public IList<MTourOrder> GetTourOrderListById(string tourId, ref MOrderSum orderSum)
        {
            ...
            query.Append(",(Adults+Childs-(select count(1) from tbl_TourOrderCarTypeSeat where OrderId=tbl_TourOrder.OrderId)) as UnSeat ");
            query.Append(",JieSuanStatus ");
            query.Append(" FROM ");
            ...
            using (IDataReader dr = DbHelper.ExecuteReader(cmd, _db))
            {
                if (dr != null)
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        order.JieSuanStatus = dr["JieSuanStatus"].ToString() == "1";
        ...
        public IList<MTradeOrder> GetTourOrderList(
            ...
            string loginId,
            int[] deptIds,
            bool isOnlySeft, out object[] heJi)
        {
            heJi = new object[] { 0, 0, 0M };
            IList<EyouSoft.Model.TourStructure.MTradeOrder> list = new List<MTradeOrder>();
            ...
            fileds.Append(" ,PriceStandId,LevId,ConfirmMoneyStatus,OrderRemark,ContractId,ContractCode ");

            string heJiString = "SUM(Adults) AS ChengRenShuHeJi,SUM(Childs) AS ErTongShuHeJi,SUM(ConfirmMoney) AS JinEHeJi";
            ...
            if (searchOrderCenter.XiaoShouYuanDeptIds != null && searchOrderCenter.XiaoShouYuanDeptIds.Length > 0)
            {
                query.AppendFormat(" AND ODeptId IN({0}) ", Utils.GetSqlIn<int>(searchOrderCenter.XiaoShouYuanDeptIds));
            }
            #endregion
            ...
            using (IDataReader dr = DbHelper.ExecuteReader1(_db, pageSize, pageIndex, ref recordCount, tableName, fileds.ToString(), query.ToString(), orderByString, heJiString))
            {
                while (dr.Read())
                {
                    ...
                    order.DingDanBeiZhu = dr["OrderRemark"].ToString();
                    order.ContractId = !dr.IsDBNull(dr.GetOrdinal("ContractId")) ? dr.GetString(dr.GetOrdinal("ContractId")) : string.Empty;
                    order.ContractCode = !dr.IsDBNull(dr.GetOrdinal("ContractCode")) ? dr.GetString(dr.GetOrdinal("ContractCode")) : string.Empty;
                    list.Add(order);
                }
                ...
                if (dr.Read())
                {
                    if (!dr.IsDBNull(dr.GetOrdinal("ChengRenShuHeJi"))) heJi[0] = dr.GetInt32(dr.GetOrdinal("ChengRenShuHeJi"));
                    if (!dr.IsDBNull(dr.GetOrdinal("ErTongShuHeJi"))) heJi[1] = dr.GetInt32(dr.GetOrdinal("ErTongShuHeJi"));
                    if (!dr.IsDBNull(dr.GetOrdinal("JinEHeJi"))) heJi[2] = dr.GetDecimal(dr.GetOrdinal("JinEHeJi"));
                }
            }
            return list;
        ...
        public IList<MTourOrderSummary> GetTourOrderSummaryByTourId(string tourId)
        {
            ...
            query.Append(",OperatorId,DeptId,Adults,Childs,Others,AdultPrice,ChildPrice");
            query.Append(",OtherPrice,PriceStandId,LevId,PeerAdultPrice,PeerChildPrice");
            query.Append(",SettlementMoney,ConfirmSettlementMoney,SaleAddCost,SaleReduceCost");
            query.Append(",SaleAddCostRemark,SaleReduceCostRemark,PeerAddCost,PeerReduceCost");
            query.Append(",PeerAddCostRemark,PeerReduceCostRemark,OtherCost,SumPrice");
            query.Append(",ConfirmMoneyStatus,ConfirmMoney,ConfirmRemark,Profit,SalerIncome");
            query.Append(",GuideIncome,OrderRemark,SaveSeatDate,TourType,OrderType,Status");
            query.Append(",IsDelete,IssueTime,UpdateTime,CheckMoney,ReturnMoney,ReceivedMoney");
            query.Append(",IsClean,TheNum,ContractId,ContractCode,TravellerFile,PayMentMonth");
            query.Append(",PayMentDay,PayMentAccountId,SettlementPeople,SettlementPeopleId");
            query.Append(",SumPriceAddCost,SumPriceAddCostRemark,SumPriceReduceCost,SumPriceReduceCostRemark,");
            //退款信息
            query.Append("(");
            query.Append(" SELECT ");
            ...
            query.Append(",Approver,ApproverId,ApproveTime,IsCheck,Memo,OperatorId,Operator,IssueTime");
            query.Append(" FROM tbl_TourOrderSales as tsales");
            query.Append(" where torder.OrderId=tsales.OrderId");
            query.Append(" and CollectionRefundState='1' ");
            ...
            query.Append(",Remark,Status,RAmount,RAmountRemark,RTime,RRemark,IsInsurance");
            ...
            query.AppendFormat(" ORDER BY IssueTime ASC ");
        ...
        public MOrderSale GetSettlementOrderByOrderId(string OrderId, TourType tourType)
        {
            ...
            //团队订单
            if (tourType == TourType.出境团队 || tourType == TourType.地接团队 || tourType == TourType.组团团队)
            {
                query = new StringBuilder();
                query.Append(" select");
                query.Append(" torder.TourId,OrderId,LDate,RouteName,OrderCode,BuyCompanyName,");
                query.Append(" ContactName,ContactTel,OtherCost,TourCode,torder.Adults,torder.Childs,torder.Others,");

                query.Append("(select Fax from tbl_CrmLinkman  where tbl_CrmLinkman.Id=torder.ContactDepartId) as ContactFax,");//联系人的传真（用于打印单）

                query.Append("(select ServiceStandard from tbl_TourService where tbl_TourService.TourId=torder.TourId) as ServiceStandard,");

                query.Append(" (SELECT");
                query.Append(" TourId,Unit,Quote,ServiceStandard,ServiceType,ServiceName,ServiceId,Remark");
                query.Append(" FROM tbl_TourTeamPrice ");
                query.Append(" as tprice");
                query.Append(" where torder.TourId=tprice.TourId FOR xml raw, root('Root')) as TeamPrice,");

                query.Append("(");
                query.Append(" SELECT ");
                query.Append("Id,OrderId,CollectionRefundDate,CollectionRefundOperator,CollectionRefundOperatorID");
                query.Append(",CollectionRefundAmount,CollectionRefundMode,CollectionRefundState,ApproverDeptId");
                query.Append(",Approver,ApproverId,ApproveTime,IsCheck,Memo,OperatorId,Operator,IsGuideRealIncome,IssueTime,");
                //
                query.Append("(Select Name from tbl_ComPayment where tbl_ComPayment.PayMentId=tsales.CollectionRefundMode) as Name");
                query.Append(" FROM tbl_TourOrderSales as tsales");
                query.Append(" where torder.OrderId=tsales.OrderId and tsales.CollectionRefundState=1");
                query.Append("  for xml raw,root('Root')) as OrderSales,");

                query.Append(" torder.SumPrice,SumPriceAddCost,SumPriceReduceCost,SumPriceAddCostRemark,SumPriceReduceCostRemark,");
                query.Append(" ConfirmMoney,ConfirmMoneyStatus,ConfirmPeople,ConfirmPeopleId,ConfirmRemark,");
                query.Append(" CheckMoney,ReturnMoney,PayMentMonth,PayMentDay,PayMentAccountId,");
                query.Append(" torder.AdultPrice,torder.ChildPrice,");
                query.Append(" SaleAddCost,SaleReduceCost,SaleAddCostRemark,SaleReduceCostRemark");
                query.Append(" ,torder.SellerId,torder.CompanyId,torder.LevId,torder.PriceStandId ");
                query.Append(" ,tour.TourType ");
                query.Append(" ,torder.NeiBuXinXi,torder.OrderRemark ");
                query.Append(" from tbl_TourOrder");
                query.Append(" as torder");
                query.Append(" inner join tbl_Tour ");
                query.Append(" as tour");
                query.Append(" on torder.TourId=tour.TourId");
                query.AppendFormat(" where OrderId='{0}'", OrderId);
            }
            else
            {
                ...
                query.Append("(select Fax from tbl_CrmLinkman  where tbl_CrmLinkman.Id=torder.ContactDepartId) as ContactFax,");//联系人的传真（用于答应单）
                ...
                query.Append(" (select Id,TourId,Standard,");
                query.Append(" (select Name from tbl_ComStand");
                query.Append(" where tbl_ComStand.Id=tsanpin.Standard) ");
                query.Append(" as StandardName,LevelId,");
                query.Append(" (select Name from tbl_ComLev ");
                query.Append(" where tbl_ComLev.Id =tsanpin.LevelId) as LevelName,");
                query.Append(" AdultPrice,ChildPrice");
                query.Append(" from tbl_TourSanPinPrice");
                query.Append(" as tsanpin ");
                query.Append(" where torder.TourId=tsanpin.TourId");
                query.Append(" for xml raw,root('Root')) as SanPinPrice,");
            ...
            using (IDataReader dr = DbHelper.ExecuteReader(cmd, _db))
            {
                if (dr != null)
                {
                    if (dr.Read())
                    {
                        ...
                        order.ContactTel = !dr.IsDBNull(dr.GetOrdinal("ContactTel")) ? dr.GetString(dr.GetOrdinal("ContactTel")) : string.Empty;
                        order.ServiceStandard = !dr.IsDBNull(dr.GetOrdinal("ServiceStandard")) ? dr.GetString(dr.GetOrdinal("ServiceStandard")) : string.Empty;
                        order.ContactName = !dr.IsDBNull(dr.GetOrdinal("ContactName")) ? dr.GetString(dr.GetOrdinal("ContactName")) : string.Empty;
                        order.ContactFax = !dr.IsDBNull(dr.GetOrdinal("ContactFax")) ? dr.GetString(dr.GetOrdinal("ContactFax")) : string.Empty;

                        if (tourType == TourType.出境团队 || tourType == TourType.地接团队 || tourType == TourType.组团团队)
                        {
                            //分项报价的价格信息(团队计划)
                            string TeamPriceXml = !dr.IsDBNull(dr.GetOrdinal("TeamPrice")) ? dr.GetString(dr.GetOrdinal("TeamPrice")) : string.Empty;
                            if (!string.IsNullOrEmpty(TeamPriceXml))
                            {
                                order.TourTeamPriceList = GetTourTeamPriceByXml(TeamPriceXml);
                            }
                        }
                        else
                        {
                            //价格组成（散拼计划）
                            string SanPinPriceXml = !dr.IsDBNull(dr.GetOrdinal("SanPinPrice")) ? dr.GetString(dr.GetOrdinal("SanPinPrice")) : string.Empty;
                            if (!string.IsNullOrEmpty(SanPinPriceXml))
                            {
                                order.TourPriceStandard = GetTourPriceStandardByXml(SanPinPriceXml);

                            }
                        }

                        //订单退款信息的xml
                        string OrderSalesXml = !dr.IsDBNull(dr.GetOrdinal("OrderSales")) ? dr.GetString(dr.GetOrdinal("OrderSales")) : string.Empty;
                        if (!string.IsNullOrEmpty(OrderSalesXml))
                        {
                            order.TourOrderSalesList = GetTourOrderSalesByXml(OrderSalesXml);
                        }
                        ...
                        order.CheckMoney = dr.GetDecimal(dr.GetOrdinal("CheckMoney"));
                        //订单未接余款
                        order.Balance = order.ConfirmMoney + dr.GetDecimal(dr.GetOrdinal("ReturnMoney")) - order.CheckMoney;
                        order.PayMentMonth = !dr.IsDBNull(dr.GetOrdinal("PayMentMonth")) ? dr.GetString(dr.GetOrdinal("PayMentMonth")) : string.Empty;
                        order.PayMentDay = !dr.IsDBNull(dr.GetOrdinal("PayMentDay")) ? dr.GetString(dr.GetOrdinal("PayMentDay")) : string.Empty;
                        order.PayMentAccountId = !dr.IsDBNull(dr.GetOrdinal("PayMentAccountId")) ? dr.GetInt32(dr.GetOrdinal("PayMentAccountId")) : 0;
                        order.AdultPrice = dr.GetDecimal(dr.GetOrdinal("AdultPrice"));
                        ...
                        order.KeHuLevId = dr.GetInt32(dr.GetOrdinal("LevId"));
                        order.BaoJiaBiaoZhunId = dr.GetInt32(dr.GetOrdinal("PriceStandId"));
                        if (!dr.IsDBNull(dr.GetOrdinal("SellerId"))) order.SellerId = dr.GetString(dr.GetOrdinal("SellerId"));
                        order.TourType = (TourType)dr.GetByte(dr.GetOrdinal("TourType"));
        ...
        public MTourOrderSales GetTourOrderSalesById(string id)
        {
            ...
            StringBuilder query = new StringBuilder();
            query.Append(" SELECT ");
            query.Append("Id,OrderId,CollectionRefundDate");
            ...
            query.Append(",IsCheck,Memo,OperatorId,Operator,IsGuideRealIncome");
            ...
            using (IDataReader dr = DbHelper.ExecuteReader(cmd, _db))
            {
                if (dr != null)
                {
                    if (dr.Read())
                    {
                        ...
                        sales.CollectionRefundState = (CollectionRefundState)Utils.GetInt(dr.GetString(dr.GetOrdinal("CollectionRefundState")));
                        ...
                        sales.IsCheck = dr.GetString(dr.GetOrdinal("IsCheck")) == "1" ? true : false;
        ...
        public IList<MTourOrderCollectionSales> GetTourOrderCollectionSalesListByOrderId(params string[] orderIds)
        {
            ...
            StringBuilder query = new StringBuilder();
            query.Append(" Select ");
            query.Append("tbl_TourOrder.TourId,TourCode,OrderId,OrderCode,RouteName,LDate,BuyCompanyName,");
            ...
            CollectionRefundState collectionRefundState)
        {
            ...
            sql.Append(" SELECT ");
            sql.Append("Id,OrderId,CollectionRefundDate,CollectionRefundOperator,CollectionRefundOperatorID");
            sql.Append(",CollectionRefundAmount,CollectionRefundMode,CollectionRefundState,ApproverDeptId");
            sql.Append(",Approver,ApproverId,ApproveTime,IsCheck,Memo,OperatorId,Operator,IsGuideRealIncome,IssueTime");
            ...
            //导游现收未审核则不显现在列表
            sql.Append(" And ((IsGuideRealIncome=1 and IsCheck=1) or (IsGuideRealIncome=0 and IsCheck=0) or (IsGuideRealIncome=0 and IsCheck=1)) ");
        ...
        public IList<BuyCompanyTraveller> GetTourOrderBuyCompanyTravellerById(string tourId, params int[] orderStatus)
        {
            ...
            {
                query.AppendFormat(" and B.Status in ({0}) ", GetIdsByArr(orderStatus));
            }
            //排序
        ...
        /// <summary>
        /// 获取订单导游收入保存状态，0：可以不保存，1：未保存，2：已保存
        /// </summary>
        /// <param name="orderId">订单编号</param>
        /// <returns></returns>
        public int GetBaoCunDaoYouShouRuStatus(string orderId)
        {
            DbCommand cmd = _db.GetStoredProcCommand("proc_TourOrder_BaoCunDaoYouShouRuStatus");
        ...
        public bool UpdateTourOrderContaract(string orderId, string contractCode, string contractCodeId)
        {
            if (string.IsNullOrEmpty(orderId)) return false;
            DbCommand cmd = this._db.GetSqlStringCommand(SQL_UPDATE_SetTourOrderContract);
            this._db.AddInParameter(cmd, "OrderId", DbType.AnsiStringFixedLength, orderId);
            _db.AddInParameter(cmd, "ContractId", DbType.AnsiStringFixedLength, contractCodeId);//合同编号
            _db.AddInParameter(cmd, "ContractCode", DbType.String, contractCode);//合同号
        ...
        /// <returns></returns>
        public int SheZhiDingDanHeTong(string companyId, string dingDanId, string heTongId)
        {
            DbCommand cmd = _db.GetStoredProcCommand("porc_TourOrder_SetHeTong");
            _db.AddInParameter(cmd, "CompanyId", DbType.AnsiStringFixedLength, companyId);
            _db.AddInParameter(cmd, "OrderId", DbType.AnsiStringFixedLength, dingDanId);
