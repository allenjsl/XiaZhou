...
namespace EyouSoft.IDAL.GovStructure
{
    ...
    public interface INotice
    {
        ...
        /// <returns></returns>
        IList<Model.GovStructure.MGovNotice> GetGovNoticeList(string NoticeType,string CompanyId, string Title, string OperatorId, string Operator, EyouSoft.Model.EnumType.ComStructure.AttachItemType ItemType, int PageSize, int PageIndex, ref int RecordCount);
        ...
        /// <param name="RecordCount">每页显示的记录数</param>
        /// <returns></returns>
        IList<Model.GovStructure.MGovNotice> GetGovNoticeList(string NoticeType, string CompanyId, EyouSoft.Model.EnumType.GovStructure.ItemType Type, EyouSoft.Model.EnumType.ComStructure.AttachItemType ItemType, int PageSize, int PageIndex, ref int RecordCount);
        ...
        /// 增加一条回复
        /// </summary>
        bool AddNoticeReply(Model.GovStructure.MGovNoticeReply model);
         /// <summary>
        /// 获得回复信息列表
        /// </summary>
        ...
        /// <param name="RecordCount">每页显示的记录数</param>
        /// <returns></returns>
        IList<Model.GovStructure.MGovNoticeReply> GetGovNoticeReplyList(string NoticeId, int PageSize, int PageIndex, ref int RecordCount);
        #endregion  成员方法
    }
}
