...
namespace EyouSoft.IDAL.TourStructure
{
    ...
    public interface IQuote
    {
        ...
        /// <returns></returns>
        IList<EyouSoft.Model.TourStructure.MTourQuoteInfo> GetTourQuoteList(string CompanyId, int pageSize, int pageIndex, ref int recordCount, EyouSoft.Model.TourStructure.MTourQuoteSearch info, EyouSoft.Model.EnumType.TourStructure.ModuleType ModuleType, int[] DeptId, bool isOnlySelf, string LoginUserId, int ShowBeforeMonth, int ShowAfterMonth);
