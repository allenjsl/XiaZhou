...
namespace EyouSoft.IDAL.TourStructure
{
    ...
    public interface ITour
    {
        ...
        /// <returns></returns>
        IList<EyouSoft.Model.TourStructure.MTourTeamInfo> GetTourTeamList(string CompanyId, int pageSize, int pageIndex, ref int recordCount, EyouSoft.Model.EnumType.TourStructure.ModuleType ModuleType, EyouSoft.Model.TourStructure.MTourTeamSearch TourTeamSearch, int[] DeptIds, bool isOnlySeft, string LoginUserId);
        ...
        /// <param name="LoginUserId">当前登录的用户编号</param>  
        /// <returns></returns>
        IList<EyouSoft.Model.TourStructure.MTourSanPinInfo> GetTourSanPinList(string CompanyId, int pageSize, int pageIndex, ref int recordCount, EyouSoft.Model.EnumType.TourStructure.ModuleType ModuleType, EyouSoft.Model.TourStructure.MTourSanPinSearch TourSanPinSearch, int[] DeptIds, bool isOnlySeft, string LoginUserId);
        ...
        /// <returns></returns>
        IList<EyouSoft.Model.TourStructure.MPlanList> GetPlanList(string CompanyId, int pageSize, int pageIndex, ref int recordCount, EyouSoft.Model.EnumType.TourStructure.ModuleType ModuleType, EyouSoft.Model.TourStructure.MPlanListSearch MPlanListSearch, int[] DetpIds, bool isOnlySeft, string LoginUserId);
        ...
        /// <returns></returns>
        bool AddTourSanPin(EyouSoft.Model.TourStructure.MTourSanPinInfo info);
        ...
        /// <param name="info"></param>
        /// <returns></returns>
        bool UpdateTourSanPin(EyouSoft.Model.TourStructure.MTourSanPinInfo info);
        ...
        /// <param name="LoginUserId"></param>
        /// <returns></returns>
        IList<EyouSoft.Model.TourStructure.MTourPlanChange> GetTourPlanChange(string CompanyId, int pageSize, int pageIndex, ref int recordCount, int[] DetpIds, bool isOnlySeft, string LoginUserId);
        ...
        /// <returns></returns>
        bool TourChangeSure(EyouSoft.Model.TourStructure.MTourPlanChange model);
        ...
        /// <returns></returns>
        string GetTourNum(string CompanyId, DateTime chuTuanRiQi);
        ...
        /// <returns></returns>
        IList<EyouSoft.Model.TourStructure.MTourStatusChange> GetTourStatusXXs(string tourId);
    } 
}
