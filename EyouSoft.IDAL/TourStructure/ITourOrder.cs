...
namespace EyouSoft.IDAL.TourStructure
{
    ...
    public interface ITourOrder
    {
        ...
        /// <returns></returns>
        int UpdateOrderSettlement(MOrderSaleBase orderSale, MTourOrderChange orderChange);
        ...
        IList<MTradeOrder> GetTourOrderList(MSearchOrderCenter searchOrderCenter,
           int pageSize,
           int pageIndex,
           ref int recordCount, string loginId, int[] deptIds, bool isOnlySeft, out object[] heJi);
        ...
        /// <param name="orderId">订单编号</param>
        /// <returns></returns>
        int GetBaoCunDaoYouShouRuStatus(string orderId);
        /*/// <summary>
        /// 修改订单合同号
        /// </summary>
        /// <param name="orderId">订单编号</param>
        ...
        bool UpdateTourOrderContaract(string orderId, string contractCode, string contractCodeId);*/
        /// <summary>
        /// 设置订单合同，返回1成功，其它失败
        /// </summary>
        /// <param name="companyId">公司编号</param>
        ...
        /// <returns></returns>
        int SheZhiDingDanHeTong(string companyId, string dingDanId, string heTongId);
    }
}
