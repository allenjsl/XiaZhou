...
namespace EyouSoft.Model.PlanStructure
{
    ...
    public class MTourTotalInOut
    {
        ...
        public decimal TourProfit
        {
            get
            {
                return this.TourIncome + this.QiTaShouRu - this.TourOutlay;
            }
        }
        ...
        /// 利润率
        /// </summary>
        public decimal TourProRate
        {
            get
            {
                if (TourIncome + QiTaShouRu == 0) return 0;
                return (TourProfit / (TourIncome + QiTaShouRu)) * 100;
            }
        }
        /// <summary>
        /// 其它收入
        ...
        /// <summary>
        /// 导游支付金额（支付方式为导游现付、导游签单）
        /// </summary>
        public decimal DaoYouZhiFuJinE { get; set; }
    }
    #endregion
