...
namespace Web.CommonPage
{
    public partial class upload : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string p1 = Utils.GetFormValue("P1");
            ...
            if (!string.IsNullOrEmpty(fileExt)) fileExt = fileExt.ToLower();
            string fileName = Utils.GenerateFileName(fileExt);
            // 允许上传的文件格式
            string[] fileTypeList = new[] { ".xls", ".rar", ".pdf", ".doc", ".swf", ".jpg", ".gif", ".jpeg", ".png", ".dot", ".bmp", ".zip", ".docx", ".xlsx", ".txt", ".ppt" };
            ...
            if (p1 == "YL")
            {
                relativePath = "/UploadFiles/YouLun/" + companyID + "/" + year + "/" + month + "/" + fileName;
                relativeDirPath = "/UploadFiles/YouLun/" + companyID + "/" + year + "/" + month + "/";
