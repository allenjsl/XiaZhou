...
namespace Web.ContractManage
{
    ...
    /// 创建人：邵权江
    /// 创建时间：2011-10-14
    public partial class ContractNumUsedList : BackPage
    {
        #region 分页参数
        /// <summary>
        /// 每页显示条数(常量)
        ...
        private void DataInit()
        {
            ...
            //IList<EyouSoft.Model.ConStructure.MContractUsed> list = BLL.GetContractUsedList(Utils.GetQueryStringValue("id"), this.pageSize, this.pageIndex, ref recordCount, ref pageCount);
