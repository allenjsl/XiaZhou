<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Web.CrmCenter.GeRenHuiYuan.Edit"
        ...
        <div style="margin: 0 auto; width: 99%;">
            ...
            <table width="100%" align="center" cellpadding="0" cellspacing="0" bgcolor="#e9f4f9">
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtIdNumber" name="txtIdNumber" runat="server" class="inputtext formsize180"
                            valid="isIdCard" errmsg="请输入正确的身份证号码!" MaxLength="18"></asp:TextBox>
                    </td>
                    <td align="right" bgcolor="#B7E0F3">
                ...
                <tr>
                    ...
                    <td align="left" bgcolor="#e0e9ef">
                        <asp:TextBox ID="txtContactPhone" name="txtContactPhone" runat="server" valid="isPhone"
                            errmsg="请填写正确的联系电话" class="inputtext formsize120" MaxLength="20"></asp:TextBox>
                    </td>
                    <td align="right" bgcolor="#B7E0F3">
                        <span class="alertboxTableT">手机：</span>
                    </td>
                    <td align="left" bgcolor="#e0e9ef">
                        <asp:TextBox ID="txtMobilePhone" name="txtMobilePhone" runat="server" valid="isMobile"
                            errmsg="请填写正确的手机" class="inputtext formsize120" MaxLength="20"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td height="28" align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtQQ" valid="isQQ" errmsg="请填写正确的QQ" runat="server" class="inputtext formsize120"
                            MaxLength="20"></asp:TextBox>
                    </td>
                    <td align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                        E-mail：
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtEMail" runat="server" valid="isEmail" errmsg="请填写正确的Email" class="inputtext formsize180"
                ...
                <tr>
                    ...
                    <td align="left" bgcolor="#e0e9ef">
                        <asp:TextBox ID="txtZipCode" name="txtZipCode" runat="server" valid="isZip" errmsg="请填写正确的邮编"
                            class="inputtext formsize120" MaxLength="10"></asp:TextBox>
                    </td>
                    <td align="right" bgcolor="#B7E0F3">
