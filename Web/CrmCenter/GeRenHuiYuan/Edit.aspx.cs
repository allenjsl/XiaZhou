...
namespace Web.CrmCenter.GeRenHuiYuan
{
    ...
    public partial class Edit : EyouSoft.Common.Page.BackPage
    {
        ...
        void PowerControl()
        {
            if (IsEdit)
            {
                if (!this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_修改))
                {
                    Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_修改, false);
                    return;
                }
            }
            ...
            if (IsAdd)
            {
                if (!this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_新增))
                {
                    Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_新增, false);
                    return;
                }
            }
        }
