<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JiFen.aspx.cs" Inherits="EyouSoft.Web.CrmCenter.GeRenHuiYuan.JiFen" %>
        ...
        var JiFen = {
            PaegSave: function() {
                if (ValiDatorForm.validator($("#btnSave").closest("form").get(0), "parent")) {
                    ...
                    $.newAjax({
                        type: "post",
                        url: "/CrmCenter/GeRenHuiYuan/JiFen.aspx?" + $.param(JiFen.Data),
