...
namespace Web.CrmCenter.GeRenHuiYuan
{
    /// <summary>
    /// 客户管理 个人会员列表
    /// 创建者:钱琦
    ...
    public partial class List : EyouSoft.Common.Page.BackPage
    {
        ...
        void PowerControl()
        {
            if (!this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_栏目))
            {
                Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_栏目, false);
                return;
            }

            if (CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_新增)) phXinZeng.Visible = true;
            if (CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_修改)) phXiuGai.Visible = true;
            if (CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_删除)) phShanChu.Visible = true;
        }
        ...
        void Delete()
        {
            if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.客户管理_个人会员_删除))
            {
