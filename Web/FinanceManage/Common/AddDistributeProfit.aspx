<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDistributeProfit.aspx.cs"
    Inherits="Web.FinanceManage.Common.AddDistributeProfit" %>
...
<body style="background: 0 none;">
    ...
    <script type="text/javascript">
        var DistributeProfit = {
            ...
            Save: function(obj) {
                var that = this, url = "/FinanceManage/Common/AddDistributeProfit.aspx?", obj = $(obj);
                obj.unbind("click")
            ...
            PageInit: function() {
                ...
                $("#a_OrderSelect").click(function() {
                    parent.Boxy.iframeDialog({
                        iframeUrl: "/FinanceManage/Common/OrderList.aspx?" +
                        $.param({
                            tourId: '<%=EyouSoft.Common.Utils.GetQueryStringValue("tourId") %>',
