<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuantitySetMoney.aspx.cs"
    Inherits="Web.FinanceManage.Common.QuantitySetMoney" %>
...
<body style="background: 0 none;">
    ...
    <script type="text/javascript">
        var QuantitySetMoney = {
            ...
            Save: function(obj) {
                var url = '/FinanceManage/Common/QuantitySetMoney.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>';
