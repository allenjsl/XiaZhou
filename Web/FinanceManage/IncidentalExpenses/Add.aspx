<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Web.FinanceManage.IncidentalExpenses.Add" %>
    ...
    <div class="alertbox-outbox">
        <div style="margin: 0 auto; width: 99%; padding-bottom: 5px;">
            <table width="99%" align="center" cellpadding="0" cellspacing="0" bgcolor="#e9f4f9"
                ...
                <tr id="tr_dealer" class="alertboxTableT" align="right" height="28" bgcolor="#b7e0f3">
                    <td>
                        请款人：
                    </td>
            ...
            Save: function(obj) {
                ...
                if (that.FormCheck($("form"))) {
                    ...
                    $.newAjax({
                        ...
                        cache: false,
                        url: '/FinanceManage/IncidentalExpenses/Add.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>',
                        dataType: "json",
