<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamineV.aspx.cs" Inherits="Web.FinanceManage.IncidentalExpenses.ExamineV" %>
...
<body style="background: 0 none;">
    ...
    <script type="text/javascript">
        var ExamineV = {
            ...
            Save: function(obj) {
                var that = this, url = '/FinanceManage/IncidentalExpenses/ExamineV.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>', obj = $(obj);
