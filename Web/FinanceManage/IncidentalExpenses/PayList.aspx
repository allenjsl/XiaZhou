<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="PayList.aspx.cs" Inherits="Web.FinanceManage.IncidentalExpenses.PayList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbox">
        <form id="SelectFrom" action="PayList.aspx" method="get">
                        ...
                        <tr data-otherfeeid="<%#Eval("Id") %>" data-intstatus="<%#(int)Eval("Status") %>"
                            ...
                            <td align="center" data-intstatus="<%#(int)Eval("Status") %>">
                                <a data-class="a_ExamineV" href="javascript:void(0);">审核 </a><a data-class="a_Pay"
                                    href="javascript:void(0);">支付</a> <a data-class="a_InMoney" href="javascript:void(0);"
                                        data-type="InMoney"><%#this.GetFinIn(Eval("Id")) %> </a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
    ...
    <script type="text/javascript">
        var PayList = {
            ...
            Updata: function(arr) {/*修改*/
                ...
                data.title += EnglishToChanges.Ping("Updata");
            ...
            DelAll: function(arr) {/*删除*/
                var Ids = [], url = '/FinanceManage/IncidentalExpenses/PayList.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>';
                $(arr).each(function() {
            ...
            BindBtn: function() {/*绑定功能按钮*/
                ...
                $("#li_Add").click(function() {
                    ...
                    data.url += ("/Add.aspx?" + $.param({ sl: '<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>', parent: 2 }));
                    that.ShowBoxy(data);
                    return false;
