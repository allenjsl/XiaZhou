<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayMoney.aspx.cs" Inherits="Web.FinanceManage.IncidentalExpenses.PayMoney" %>
    ...
    <script type="text/javascript">
        var PayMoney = {
            ...
            Save: function(obj) {
                ...
                var url = '/FinanceManage/IncidentalExpenses/PayMoney.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>';
                var obj = $(obj);
                obj.unbind("click")
