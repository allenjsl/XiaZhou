<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamineA.aspx.cs" Inherits="Web.FinanceManage.Loan.ExamineA" %>
...
<body style="background: 0 none;">
    ...
    <script type="text/javascript">
        var ExamineA = {
            ...
            Save: function(obj) {
                var that = this, url = "/FinanceManage/Loan/ExamineA.aspx?", obj = $(obj);
