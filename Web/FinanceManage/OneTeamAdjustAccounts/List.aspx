<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="Web.FinanceManage.OneTeamAdjustAccounts.List" %>

<%@ Register Assembly="ControlLibrary" Namespace="Adpost.Common.ExporPage" TagPrefix="cc1" %>
<%@ Register Src="/UserControl/SellsSelect.ascx" TagName="SellsSelect" TagPrefix="uc1" %>
<%@ Register Src="/UserControl/selectGuid.ascx" TagName="GuideSelect" TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="searchbox fixed">
        <span class="searchT">
            <p>
                ...
                <%if (IsYiHeSuan)
                  {%>
                核算时间：<input value="<%= Request.QueryString["txtHeSuanTime1"] %>" name="txtHeSuanTime1" type="text" class="inputtext formsize80"
                    onfocus="WdatePicker();" />
                -
                <input type="text" value="<%= Request.QueryString["txtHeSuanTime2"] %>" name="txtHeSuanTime2" class="inputtext formsize80"
                    onfocus="WdatePicker();" /><%} %>
                <br />
                销售：<uc1:SellsSelect ID="txt_Seller" runat="server" selectfrist="false" SetTitle="销售员" />
                计调：<uc1:SellsSelect ID="txt_Plan" runat="server" selectfrist="false" SetTitle="计调员" />
                导游：<uc1:GuideSelect ID="txt_Guide" runat="server" SetTitle="导游" />
    ...
    <div id="tablehead" class="tablehead">
        <ul>
            ...
            <%if (IsYiHeSuan)
                  {%>
            <li><s class="daochu"></s><a id="selector_toolbar_toXls" class="toolbar_daochu" hidefocus="true" href="###">
                    <span>导出列表</span></a></li><%} %>
        </ul>
        <div class="pages">
            ...
            <asp:Repeater ID="rpt_list" runat="server">
                <ItemTemplate>
                    <tr data-tourid="<%#Eval("TourId") %>">
                        ...
                        <td align="center">
                            <%#EyouSoft.Common.UtilsCommons.PingPlaner(Eval("MPlanerInfo"))%>
                        </td>
                        <td align="center">
                            <%#EyouSoft.Common.UtilsCommons.PingGuide(Eval("MGuidInfo"))%>
                        </td>
                        <td align="right">
                            <b class="fontblue">
                        ...
                        <td align="center">
                            ...
                            <a href="javascript:void(0);" class="fontblue" data-class="a_show">查看</a>| <a target="_blank"
                                href="<%=PrintUri %>?tourId=<%#Eval("TourId") %>" class="fontblue" data-class="">
                                核算单</a>
                        </td>
                    </tr>
                </ItemTemplate>
        ...
        var PageJsDataObj = {
            BindBtn: function() {/*绑定功能按钮*/
                ...
                $("#liststyle a[data-class='a_accounting'],#liststyle a[data-class='a_show']").click(function() {
                    ...
                    var url = "/CommonPage/FinalAppeal.aspx?" + $.param({
