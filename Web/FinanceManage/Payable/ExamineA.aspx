<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamineA.aspx.cs" Inherits="Web.FinanceManage.Payable.ExamineA" %>
    ...
    <script type="text/javascript">
        var ExamineA = {
            ...
            Save: function(obj) {
                ...
                var url = "/FinanceManage/Payable/ExamineA.aspx?" + $.param({ sl: '<%=Request.QueryString["sl"] %>', doType: "Save" });
