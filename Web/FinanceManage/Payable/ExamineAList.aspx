<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="ExamineAList.aspx.cs" Inherits="Web.FinanceManage.Payable.ExamineAList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbox">
        <form id="SelectFrom" action="ExamineAList.aspx" method="get">
        <div class="tablehead">
            <ul class="fixed">
                        ...
                        <tr data-registerid="<%#Eval("RegisterId") %>" data-status="<%#(int)Eval("Status") %>"
                            ...
                            <td align="center">
                                <a href="javascript:void(0);" data-class="a_examineA">审批</a> <a href="javascript:void(0);"
                                    data-class="a_payMoney">支付</a> <a data-class="a_InMoney" href="javascript:void(0);">
                                        <%# this.GetFinIn(Eval("RegisterId")) %> </a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
    ...
    <script type="text/javascript">
        var ExamineAListObj = {
            ...
            ExamineA: function(registerIds) {/*审批,批量审批*/
                ...
                data.url += "/ExamineA.aspx?" + $.param({ sl: that.sl, registerIds: registerIds });
                that.ShowBoxy(data);
                return false;
            },
            PayMoney: function(registerIds, isInAccount, tourID) {/*支付,批量支付*/
                ...
                data.url += "/PayMoney.aspx?" + $.param({ sl: that.sl, registerIds: registerIds, isInAccount: isInAccount || "", tourID: tourID || "" });
                that.ShowBoxy(data);
                return false;
            },
            BindBtn: function() {
