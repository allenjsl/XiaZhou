...
namespace Web.FinanceManage.Payable
{
    ...
    /// 创建人：柴逸宁
    /// 创建时间：2011-9-14
    public partial class ExamineAList : BackPage
    {
        ...
        private void ToXls()
        {
            ...
            //金额汇总信息
            decimal sum = 0;
            MPayableApproveBase queryModel = new MPayableApproveBase { CompanyId = CurrentUserCompanyID };
            IList<MPayableApprove> ls = new BFinance().GetMPayableApproveLst(
        ...
        {
            return new BFinance().IsFinIn(DefaultProofType.计调付款, id.ToString(), this.SiteUserInfo.CompanyId)
                       ? "已入帐"
                       : "未入账";
        }
        #endregion
