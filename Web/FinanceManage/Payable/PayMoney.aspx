<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayMoney.aspx.cs" Inherits="Web.FinanceManage.Payable.PayMoney" %>
    ...
    <script type="text/javascript">
        var PayMoney = {
            ...
            Save: function(obj) {
                ...
                var url = "/FinanceManage/Payable/PayMoney.aspx?" + $.param({ sl: '<%=Request.QueryString["sl"] %>', doType: "Save" }); ;
                var obj = $(obj);
                obj.unbind("click")
