<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="PayableList.aspx.cs" Inherits="Web.FinanceManage.Payable.PayableList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbox">
        <form id="SelectFrom" action="PayableList.aspx" method="get">
        <div id="div_skipBtn" class="tablehead">
            <ul class="fixed">
                <li><s class="orderformicon"></s><a href="PayableList.aspx?sl=<%=Request.QueryString["sl"] %>"
                    hidefocus="true" class="ztorderform de-ztorderform"><span>应付账款</span></a></li>
                <li><s class="orderformicon"></s><a href="ExamineAList.aspx?sl=<%=Request.QueryString["sl"] %>"
                    hidefocus="true" class="ztorderform"><span>付款审批</span></a></li>
                <li><s class="orderformicon"></s><a href="PayableList.aspx?sl=<%=Request.QueryString["sl"] %>&IsClean=1"
        ...
        <div class="searchbox fixed">
            <span class="searchT">
                <p>
                    ...
                    计调员：<uc1:SellsSelect SetTitle="计调员" ID="txt_Plan" runat="server" selectfrist="false" />
                    <br />
                    已付金额：
        ...
        <div id="tablehead" class="tablehead">
            <ul class="fixed">
                ...
                <li><s class="duizhang"></s><a href="/FinanceManage/Payable/DangRiDuiZhang.aspx?sl=<%=Request.QueryString["sl"] %>"
    ...
    <script type="text/javascript">
        var Payable = {
            ...
            ShowQuantityRegister: function(planIDs, tourIDs) {/*批量登记*/
                ...
                data.url += "/QuantityRegister.aspx?" + $.param({
                    sl: that.sl,
                    planIDs: planIDs,
                    tourIDs: tourIDs
                });
            ...
            BindBtn: function() {
                ...
                var _otherbtn1 = {
                    ...
                    , buttonCallBack: function(arrTr) {
                        ...
                        $(arrTr).each(function(i) {
                            var obj = $(this);
                            if (obj.find("input[name='hidePaymentType']").val() == "<%=(int)EyouSoft.Model.EnumType.PlanStructure.Payment.导游现付%>") {
                ...
                var _otherbtn2 = {
                    ...
                    , buttonCallBack: function(_trobjs) {
                        ...
                        var _posturl = "PayableList.aspx?sl=<%=SL %>&doType=PiLiangChengBenQueRen";
                        $.newAjax({
                ...
                $("#a_PlanCostConfirmed").click(function() {
                    ...
                    $.newAjax({
                        ...
                        cache: false,
                        url: "/FinanceManage/Payable/PayableList.aspx?" + $.param({ sl: that.sl, doType: "PlanCostConfirmed" }),
                        dataType: "json",
