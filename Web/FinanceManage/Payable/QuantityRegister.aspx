<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuantityRegister.aspx.cs"
    Inherits="Web.FinanceManage.Payable.QuantityRegister" %>
        ...
        var QuantityRegister = {
            ...
            Save: function(obj) {
                ...
                $.newAjax({
                    ...
                    cache: false,
                    url: "/FinanceManage/Payable/QuantityRegister.aspx?" + $.param({ doType: "Save", sl: '<%=Request.QueryString["sl"] %>' }),
                    dataType: "json",
