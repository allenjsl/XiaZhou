<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Web.FinanceManage.Payable.Register" %>
    ...
    <script type="text/javascript">
        var Register = {
            ...
            Save: function(obj, type) {
                var that = this;
                var url = "/FinanceManage/Payable/Register.aspx?" + $.param({ doType: type, sl: '<%=Request.QueryString["sl"] %>' });
