<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuantityExamineV.aspx.cs"
    Inherits="Web.FinanceManage.Receivable.QuantityExamineV" %>
...
<body style="background: 0 none;">
    ...
    <script type="text/javascript">
        var QuantityExamineV = {
            Save: function(obj) {
                var url = '/FinanceManage/Receivable/QuantityExamineV.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>&doType=Save';
