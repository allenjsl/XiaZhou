<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcceptPlanApply.aspx.cs"
    Inherits="Web.GroupEnd.Distribution.AcceptPlanApply" %>
        ...
        <div class="listtablebox">
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    ...
                    <asp:PlaceHolder runat="server" ID="ph_PickUpPostion">
                        <tr>
                            ...
                            <td colspan="5" class="kuang2">
                                <select id="selPickUpPosition" class="inputselect" name="selPickUpPosition" valid="required"
                                    errmsg="请选择上车地点！">
                                    <%=strPickUpPosition %>
                                </select>
                    ...
                    <asp:PlaceHolder runat="server" ID="PhCarModel">
                        <tr>
                            <td width="77" bgcolor="#DCEFF3" align="right" class="addtableT">
                                座位分配：
                            </td>
                            <td colspan="5" class="kuang2">
                                <uc2:SetSeat ID="SetSeat1" runat="server" SetTitle="座位分配" CallBackFun="orderApply.SetSeatCallBackFun" />
                            </td>
                        </tr>
                    </asp:PlaceHolder>
                    <tr>
            ...
            <asp:PlaceHolder ID="phdTravelControl" runat="server">
                <uc4:TravelControl ID="TravelControl2" runat="server" />
            </asp:PlaceHolder>
    ...
    var orderApply = {
        ...
        Bind: function() {
            ...
            $("#btnCancle").click(function() {
                window.location.href = "/GroupEnd/Distribution/AcceptPlan.aspx?sl=" + orderApply.Data.sl;
                return false;
            });
        },
        UnBind: function() {
        ...
        Save: function() {
            ...
            orderApply.UnBind();
            $.newAjax({
                url: "/GroupEnd/Distribution/AcceptPlanApply.aspx?Type=Save&" + $.param(orderApply.Data),
                type: "post",
        ...
        PageInit: function() {
             $("#selPickUpPosition").change(function() {
                ...
                var onprice = self.find("option:selected").attr("data-onprice"),
                offprice = self.find("option:selected").attr("data-offprice"),
                desc = self.find("option:selected").attr("data-desc"),
                location=self.find("option:selected").attr("data-location");
            ...
            $("#txtAdults,#txtChilds").blur(function() {
                $("#<%=SetSeat1.PeoNumClientID %>").val(parseInt($("#txtAdults").val()||0) + parseInt($("#txtChilds").val()||0));
            })
