<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinancialControl.aspx.cs"
    Inherits="Web.GroupEnd.Distribution.FinancialControl" %>
    ...
    <div class="list-main">
        <div class="list-maincontent">
            ...
            <div class="listsearch">
                <form id="frm" action="/GroupEnd/Distribution/FinancialControl.aspx">
                        ...
                        <asp:Repeater runat="server" ID="RpFinancial">
                            <ItemTemplate>
                                <tr class='<%#Container.ItemIndex%2==0?"odd":"" %>'>
                                    ...
                                    <td align="left">
                                        <a class="lineInfo" href="#" bt-xtitle="" title="">
                                            <%#Eval("RouteName") %></a>
                                    </td>
                                    <td align="center">
                                    ...
                                    <td align="right">
                                        <strong class="fontbsize12">
                                            <%#EyouSoft.Common.UtilsCommons.GetMoneyString(Eval("Receivable"),this.ProviderToMoney) %></strong>
                                    </td>
                                    <td align="right">
                                    ...
                                    <td align="right">
                                        <strong class="fontblue">
                                            <%#EyouSoft.Common.UtilsCommons.GetMoneyString(Convert.ToDecimal(Eval("Receivable"))-Convert.ToDecimal(Eval("Received")),this.ProviderToMoney) %></strong>
                                    </td>
                                    <td align="center">
...
<script type="text/javascript">
    $(function() {
        $(".link1").click(function() {
            var url = "/GroupEnd/Distribution/FinancialRegistration.aspx?" + $.param({
