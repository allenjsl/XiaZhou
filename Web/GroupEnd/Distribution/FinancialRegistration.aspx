<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinancialRegistration.aspx.cs"
    Inherits="EyouSoft.Web.GroupEnd.Distribution.FinancialRegistration" %>
    ...
    <script type="text/javascript">
        var FinancialRegistration = {
            ...
            Submit: function(obj, type) {/*提交数据*/
                ...
                $.newAjax({
                    url: "/GroupEnd/Distribution/FinancialRegistration.aspx?sl=" + FinancialRegistration.Data.sl,
                    type: "post",
                    data: $.param(data),
                    dataType: "json",
                    success: function(back) {
                        if (back.result == "1") {
                            parent.tableToolbar._showMsg(back.msg, function() {
                                window.location.href = "/GroupEnd/Distribution/FinancialRegistration.aspx?" + $.param(FinancialRegistration.Data);
                            });
