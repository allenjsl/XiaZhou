<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyOrder.aspx.cs" Inherits="Web.GroupEnd.Distribution.MyOrder" %>
                    ...
                    <asp:Repeater ID="RtOrder" runat="server">
                        <ItemTemplate>
                            <tr class="<%#Container.ItemIndex%2==0?"odd":"" %>">
                                ...
                                <td align="center">
                                    <%#GetIsShow(Eval("OrderId"),Eval("TourId")) %>
                                </td>
                                <td align="center">
                                    <a class="link1" href="javascript:void(0)" data-tourid='<%#Eval("TourId") %>' data-orderid="<%#Eval("OrderId") %>">
                                        查看</a> <a target="_blank" href="<%#GetPrintPage(Eval("TourId").ToString(),Eval("OrderId").ToString()) %>">
                                            名单</a> <a class="linkCancle" data-orderstatus="<%#Eval("OrderStatus") %>" data-orderid="<%#Eval("OrderId") %>"
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $(".link1").click(function() {
            // alert("begin")
            var url = "/GroupEnd/Distribution/OrderSee.aspx?" + $.param({
        ...
        $(".linkCancle").click(function() {
            ...
            tableToolbar.ShowConfirmMsg("是否确认取消该订单？", function() {
                $.newAjax({
                    url: "/GroupEnd/Distribution/MyOrder.aspx?sl=" + data.s1,
                    type: "post",
                    data: $.param(data),
                    dataType: "json",
