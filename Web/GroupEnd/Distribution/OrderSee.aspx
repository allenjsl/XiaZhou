<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderSee.aspx.cs" Inherits="EyouSoft.Web.GroupEnd.Distribution.OrderSee" %>
        ...
        <div style="margin: 0 auto; width: 99%;">
            ...
            <table width="99%" cellspacing="0" cellpadding="0" bgcolor="#e9f4f9">
                <tbody>
                    ...
                    <asp:PlaceHolder runat="server" ID="PhCarLocation">
                        <tr>
                            <td height="28" bgcolor="#b7e0f3" align="right" class="alertboxTableT">
                                上车地点：
                            </td>
                            <td height="28" class="alertboxTableT">
                                <asp:Literal ID="setCarLocation" runat="server"></asp:Literal>
                            </td>
                            <td height="28" bgcolor="#B7E0F3" align="right" class="alertboxTableT">
                                车型：
                            </td>
        ...
        $(function() {
            $(".link2").click(function() {
                ...
                if (IsInsurance == "True") {
                    ...
                    var url = "/GroupEnd/Distribution/TravellerInsurance.aspx?" + $.param(data);
