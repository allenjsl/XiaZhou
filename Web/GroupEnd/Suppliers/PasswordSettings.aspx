<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PasswordSettings.aspx.cs"
    Inherits="Web.GroupEnd.Suppliers.PasswordSettings" %>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <div class="mainbox cunline fixed">
                                <ul>
                                    <li class="cun-cy"><a href="javascript:void(0)" id="btnUpdate">修改密码</a></li>
    ...
    <script type="text/javascript">
        ...
        var PasswordSettings = {
            ...
            Update: function() {
                ...
                $.newAjax({
                    type: "post",
                    url: "/GroupEnd/Suppliers/PasswordSettings.aspx?" + $.param(PasswordSettings.Data),
            ...
            Bind: function() {
                ...
                $("#btnCancle").css("cursor", "pointer").click(function() {
                    PasswordSettings.Cancle();
                    return false;
                });
            },
