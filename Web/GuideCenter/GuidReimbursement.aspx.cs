...
namespace Web.GuideCenter
{
    ...
    /// 创建时间：2011-09-20
    /// </summary>
    public partial class GuidReimbursement : EyouSoft.Common.Page.BackPage
    {
        #region 分页参数
        /// <summary>
        /// 每页显示条数(常量)
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //导游
            string guidID = Utils.GetQueryStringValue(this.guid1.GuidIDClient);
            string guidName = Utils.GetQueryStringValue(this.guid1.GuidNameClient);
            if (!string.IsNullOrEmpty(guidID))
            {
                this.guid1.GuidID = guidID;
            }
            if (!string.IsNullOrEmpty(guidName))
            {
                this.guid1.GuidName = guidName;
            }
        ...
        private void PowerControl()
        {
            ...
            {
                Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.导游中心_导游报账_栏目, false);
                return;
            }
        }
