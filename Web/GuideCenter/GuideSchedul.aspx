<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuideSchedul.aspx.cs" Inherits="Web.GuideCenter.GuideSchedul"
        ...
        var GuidePage = {
            ...
            PageInit: function() {
                $("a.linkaa").click(function() {
                    ...
                    Boxy.iframeDialog({
                        iframeUrl: "/GuideCenter/GuidPlanInfo.aspx?name=" + encodeURIComponent($(this).parents("tr").attr("data-name")) + "&time=" + $(this).attr("data-time") + "&type=" + $(this).attr("data-type") + "&guideid=" + $(this).parents("tr").attr("data-guideid") + '&sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>',
                        title: "选择任务",
                        modal: true,
                        width: "1000px",
                        height: "425px"
