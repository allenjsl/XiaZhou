...
' </table>',
    ...
    createCalendarDays: function(isNextMonth) {
        ...
        do {
            ...
            //s.push('<td class="Xdays "><input type="checkbox"' + (sd < this.minDate.getDate() && isCurrentMonth ? ' disabled="disabled"' : '') + ' value="' + tmpDate + '"><span>' + sd + '</span><br/><span class="price"><a class="sheding"  id="' + tmpDate + '" href="javascript:;"></a><span></span></span></td>');
