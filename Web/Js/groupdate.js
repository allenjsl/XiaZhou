...
var QGD = {
  ...
  '<tbody><tr>' +
    '<td height="25" bgcolor="#def2fc" align="center" style="padding: 3px;">&nbsp;<a href="javascript:void(0);" id="linkPreMonth"><img width="14" height="14" src="/images/rili_l.gif">上一月</a>&nbsp;&nbsp;</td>' +
    '<td height="25" bgcolor="#def2fc" align="center" style="padding: 3px;">&nbsp; <a href="javascript:void(0);" id="linkNextMonth">下一月<img width="14" height="14" src="/images/rili_r.gif"></a>&nbsp;</td>' +
  '</tr>' +
  '<tr>' +
...
'</tbody></table>',
    ...
    createCalendarMonth: function(isNextMonth) {
        ...
        var s = [];
        s.push('<table class="calendarTable" width="100%" border="1" style="border: #999999 solid 1px;" cellpadding="0" cellspacing="0" id="' + tableId + '">');
        s.push('<tr><th style="height:30px;" colspan="8" bgcolor="#A5D2E8"><input type="checkbox" id="' + isNextMonth + 'ckAll"><label for="' + isNextMonth + 'ckAll">全选 ' + (isNextMonth ? this.SDConfig.NY : this.SDConfig.CY) + '年' + (isNextMonth ? this.SDConfig.NM : this.SDConfig.CM) + '月整月</label></th></tr>');
        s.push('<tr bgcolor="#F5F4CE"><td style="width:16%"><td style="width: 12%"><input type="checkbox" id="' + isNextMonth + '0"><label for="' + isNextMonth + '0">日</label></td></td><td style="width: 12%"><input type="checkbox" id="' + isNextMonth + '1"><label for="' + isNextMonth + '1">一</label></td><td style="width: 12%"><input type="checkbox" id="' + isNextMonth + '2"><label for="' + isNextMonth + '2">二</label></td><td style="width: 12%"><input type="checkbox" id="' + isNextMonth + '3"><label for="' + isNextMonth + '3">三</label></td><td style="width: 12%"><input type="checkbox" id="' + isNextMonth + '4"><label for="' + isNextMonth + '4">四</label></td><td style="width: 12%"><input type="checkbox" id="' + isNextMonth + '5"><label for="' + isNextMonth + '5">五</label></td><td style="width: 12%"><input type="checkbox" id="' + isNextMonth + '6"><label for="' + isNextMonth + '6">六</label></td></tr>');
        s.push('</table>');
    ...
    createCalendarDays: function(isNextMonth) {
        ...
        do {
            ...
            s.push('<td class="days"><input type="checkbox"' + (sd < this.minDate.getDate() && isCurrentMonth ? ' disabled="disabled"' : '') + ' value="' + tmpDate + '"><span>' + sd + '</span></td>');
        ...
        if (this.config.arrOldLeaveDate != '' && this.config.arrOldLeaveDate != null) {
            ...
            for (var j = 0; j < objs.length; j++) {
                for (var i = 0; i < this.config.arrOldLeaveDate.length; i++) {
                    ...
                    if (m == objs[j].month) {
                        var day = d - 1;
                        objs[j].obj.find('td.days input[type=checkbox]:eq(' + day + ')').attr("checked", true);
                    }
                }
            }
        }
