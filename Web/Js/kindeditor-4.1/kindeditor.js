...
(function(window, undefined) {
    ...
    K.options = {
		...
		'flash', 'media', 'insertfile','accessory', 'table', 'hr', 'emoticons', 'baidumap', 'pagebreak',
    ...
    _extend(KUploadButton, {
        ...
        submit: function() {
			...
			var LoadCallBack = function(){
                ...
                try {
                    data = {title:document.getElementById(EditImgUpload.HideID).value.split('|')[0],url:document.getElementById(EditImgUpload.HideID).value.split('|')[1],error:0};
                } catch (e) {
            ...
            if (EditImgUpload.SwfUpload != null && EditImgUpload.SwfUpload.getStats().files_queued>0)
			{
			        EditImgUpload.SwfUpload.customSettings.UploadSucessCallback = LoadCallBack;
                    EditImgUpload.SwfUpload.startUpload();
			}else{
				alert("请选择要上传的文件!")
			}
            return self;
