...
(function($) {
    $.fn.autoAdd = function(options) {
        ...
        content.find("." + settings.tempRowClass).each(function() {
            $(this).find(".richText,input,select").each(function() {
        ...
        function addRow(num, isInsert, target) {
            ...
            for (var i = 0; i < num - count; i++) {
                ...
                if (isInsert) {
                    if (target.attr("data-fs") == "after") {
                        temp.insertAfter(target.closest("." + settings.tempRowClass));
                    } else {
...
var toXls = {
    ...
    __toXls: function(options) {
        ...
        window.location.href = _win.Boxy.createUri(options["url"], _params);
...
var keSimpleYL = ['source', '|', 'undo', 'redo','|', 'cut', 'copy', 'paste', 'plainpaste', 'wordpaste', '|', 'justifyleft', 'justifycenter', 'justifyright',
...
var keSimpleYL1 = ['source', '|', 'undo', 'redo','|', 'cut', 'copy', 'paste', 'plainpaste', 'wordpaste', '|', 'justifyleft', 'justifycenter', 'justifyright',
        'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'clearhtml', 'selectall', '|', 'formatblock', 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline', '|', 'table', 'hr', 'emoticons', 'link', 'unlink', '|', 'image', 'insertfile']
