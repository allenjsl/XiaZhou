<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeAdd.aspx.cs" Inherits="Web.ManageCenter.Notice.NoticeAdd" %>
        ...
        var PageJsData = {
            ...
            Save: function() {
                if (PageJsData.FormCheck()) {
                    ...
                    var url = "/ManageCenter/Notice/NoticeAdd.aspx?";
                    url += $.param({
