...
namespace Web.ManageCenter.Notice
{
    ...
    public partial class NoticeAdd : BackPage
    {
        ...
        protected void PowerControl()
        {
            ...
            else
            {
                ...
                if (doType == "add")
                {
                    ...
                    {
                        Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.行政中心_通知公告_新增, false);
                    }
                }
                else
                {
                    ...
                    {
                        Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.行政中心_通知公告_修改, false);
                    }
                }
            }
        }
