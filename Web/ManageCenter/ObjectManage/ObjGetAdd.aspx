<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ObjGetAdd.aspx.cs" Inherits="Web.ManageCenter.ObjectManage.ObjGetAdd" %>
...
<%@ Register Src="../../UserControl/SelectObject.ascx" TagName="SelectObject" TagPrefix="uc2" %>
...
<body style="background: 0 none;">
    ...
    <div class="alertbox-outbox02">
        <table width="99%" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td width="34%" height="28" align="right" class="alertboxTableT">
                    <span class="errmsg">*</span>物品名称：
                </td>
                <td width="66%" height="28" align="left">
            ...
            <tr>
                <td height="28" align="right" class="alertboxTableT">
                    <span class="errmsg">*</span>领用时间：
                </td>
                <td height="28" align="left">
                    <asp:TextBox runat="server" ID="txtGetTime" class="inputtext formsize120" valid="required"
                        errmsg="领用时间不能为空！" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td height="28" align="right" class="alertboxTableT">
                    <span class="errmsg">*</span>领用部门：
                </td>
                <td height="28" align="left">
            ...
            <tr>
                <td align="right" class="alertboxTableT">
                    <span class="errmsg">*</span>领用数量：
                </td>
                <td height="28" align="left">
                    <asp:TextBox runat="server" ID="txtCount" class="inputtext formsize120" valid="required|range"
            ...
            <tr>
                ...
                <td height="28" align="left">
                    <asp:TextBox runat="server" ID="txtUsed" Width="300" Height="45" class="inputtext formsize450"
        ...
        var PageJsData = {
            ...
            Save: function() {
                ...
                if (that.FormCheck()) {
                    ...
                    var url = "/ManageCenter/ObjectManage/ObjGetAdd.aspx?";
                    url += $.param({
