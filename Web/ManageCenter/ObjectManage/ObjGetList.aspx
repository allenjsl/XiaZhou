<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ObjGetList.aspx.cs" Inherits="Web.ManageCenter.ObjectManage.ObjGetList" %>
...
<body style="background: 0 none;">
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            del: function(obj) {
                if (!confirm("领用信息删除后不可恢复，你确定要删除吗？")) return false;
