<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ObjSendAdd.aspx.cs" Inherits="Web.ManageCenter.ObjectManage.ObjSendAdd" %>
        ...
        <table width="99%" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td height="28" align="right" class="alertboxTableT">
                    <span class="errmsg">*</span>发放时间：
                </td>
                <td height="28" align="left">
                    <asp:TextBox runat="server" ID="txtTime" class="inputtext formsize120" valid="required"
                        errmsg="发放时间不能为空！" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td height="28" align="right" class="alertboxTableT">
                    <span class="errmsg">*</span>签收部门：
                </td>
                <td height="28" align="left">
                    <uc1:SelectSection ID="SelectSection1" runat="server" ReadOnly="true" />
                    <span id="errMsg_<%=SelectSection1.SelectNameClient %>" class="errmsg"></span>
                </td>
            </tr>
            <tr>
                <td height="28" align="right" class="alertboxTableT">
                    <span class="errmsg">*</span>签 收 人：
                </td>
                <td height="28" align="left">
            ...
            <tr>
                ...
                <td height="28" align="left">
                    <asp:TextBox runat="server" ID="txtUsed" class="inputtext formsize450" TextMode="MultiLine"
        ...
        var PageJsData = {
            ...
            Save: function() {
                ...
                if (that.FormCheck()) {
                    ...
                    var url = "/ManageCenter/ObjectManage/ObjSendAdd.aspx?";
                    url += $.param({
