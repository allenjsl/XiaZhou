<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrgList.aspx.cs" Inherits="Web.ManageCenter.Organize.OrgList"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="gerenzx-mainbox">
        <div class="tablehead zuzjg_bg">
            <ul class="fixed">
                <li><s class="orderformicon"></s><a href="OrgList.aspx?sl=<%=Request.QueryString["sl"]%>"
    ...
    <script type="text/javascript">
        ...
        var DM = {
            openDialog: function(p_url, p_title, tar_a) {
                Boxy.iframeDialog({ title: p_title, iframeUrl: p_url, width: "660px", height: "410px", tar: tar_a });
            },
            ...
            updateD: function(dId, tar_a) {
                DM.openDialog("OrgAdd.aspx?dotype=update&id=" + dId + '&sl=<%=Request.QueryString["sl"]%>', "修改部门", tar_a);
                return false;
            },
            //添加下级部门
            addD: function(dId, tar_a) {
                DM.openDialog("OrgAdd.aspx?doType=add&id=" + dId + '&sl=<%=Request.QueryString["sl"]%>', "添加部门");
                return false;
            },
            //添加下级部门后回调
