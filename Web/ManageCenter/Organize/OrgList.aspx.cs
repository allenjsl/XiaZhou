...
namespace Web.ManageCenter.Organize
{
    ...
    /// 修改人：方琪
    /// 创建时间：2012-3-26
    public partial class OrgList : BackPage
    {
        ...
        private void PowerControl()
        {
            ...
            IsBuMenGuanLi = this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.行政中心_组织机构_部门管理);
            IsFenGongSi = this.ph_Add.Visible = this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.行政中心_组织机构_分公司管理);
        }
        #endregion
    }
}