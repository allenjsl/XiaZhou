<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="StudyAdd.aspx.cs" Inherits="EyouSoft.Web.ManageCenter.Study.StudyAdd" %>
...
<body style="background: 0 none;">
    <div class="alertbox-outbox">
        ...
        <table width="99%" align="center" cellpadding="0" cellspacing="0" bgcolor="#e9f4f9"
            style="margin: 0 auto">
            <tr>
                <td width="120" height="28" align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                ...
                <td height="28" align="left" bgcolor="#e0e9ef">
                    <asp:TextBox runat="server" ID="txtTitle" CssClass="inputtext formsize120" valid="required"
                        errmsg="标题不能为空！" Width="321px"></asp:TextBox>
            ...
            <tr class="selectReceived">
                ...
                <td align="left" bgcolor="#e0e9ef">
                    <asp:TextBox runat="server" ID="txtContent" Width="98%" Height="265"
        ...
        var PageJsData = {
            ...
            Save: function() {
                if (PageJsData.FormCheck()) {
                    ...
                    var url = "/ManageCenter/Study/StudyAdd.aspx?";
                    url += $.param({
