...
namespace EyouSoft.Web.ManageCenter.Study
{
    ...
    /// 添加学习交流
    /// </summary>
    public partial class StudyAdd : BackPage
    {
        ...
        protected void PowerControl()
        {
            ...
            else
            {
                ...
                if (doType == "add")
                {
                    ...
                    {
                        Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.行政中心_学习交流_新增, false);
                    }
                }
                else
                {
                    ...
                    {
                        Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.行政中心_学习交流_修改, false);
                    }
                }
            }
        }
