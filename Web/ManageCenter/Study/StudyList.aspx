<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true" CodeBehind="StudyList.aspx.cs" Inherits="EyouSoft.Web.ManageCenter.Study.StudyList" %>
                ...
                <asp:Repeater ID="RepList" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="left">
                                <a href="StudyRead.aspx?id=<%#Eval("NoticeId")%>&sl=<%=Request.QueryString["sl"]%>"
                                    class="gg_show" title="<%#Eval("Title") %>">
                                    <%#EyouSoft.Common.Utils.GetText(Eval("Title").ToString(),15,true)%></a> &nbsp;
                                <%# GetAttach(Eval("ComAttachList"))%>
                            </td>
                            <td align="center">
                                <a href="ReadCount.aspx?id=<%#Eval("NoticeId")%>&sl=<%=Request.QueryString["sl"]%>"
                                    class="gg_liulan">
                                    <%#Eval("Views")%></a>
                            </td>
                            <td align="center">
