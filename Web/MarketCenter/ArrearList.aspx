<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArrearList.aspx.cs" Inherits="EyouSoft.Web.MarketCenter.ArrearList" %>
...
<body style="background: 0 none;">
    <div class="alertbox-outbox">
        <div class="tanchuT" style="text-align: left">
            <a href="#" class="toolbar_dayin">
                <img src="/images/dayin1-cy.gif" border="0" /></a>&nbsp;<a href="#" class="toolbar_daochu"><img
                    src="/images/daochu-cy.gif" border="0" /></a></div>
        <div class="tanchuT">
