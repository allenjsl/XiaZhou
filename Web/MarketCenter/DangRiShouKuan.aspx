<%@ Page Title="销售中心-销售收款-当日收款对账" Language="C#" MasterPageFile="~/MasterPage/Front.Master"
    AutoEventWireup="true" CodeBehind="DangRiShouKuan.aspx.cs" Inherits="EyouSoft.Web.MarketCenter.DangRiShouKuan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        , init: function() {
            self.winParams = Boxy.getUrlParams();
