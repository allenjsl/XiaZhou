<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KeHuYuJing.aspx.cs" Inherits="Web.MarketCenter.KeHuYuJing"
...
<asp:Content ID="MainBodyContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbox">
        <div class="tablehead" style="background: none #f6f6f6;">
            <ul class="fixed">
                <li><s class="orderformicon"></s><a href="KeHuYuJing.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>"
                    hidefocus="true" class="ztorderform de-ztorderform"><span>客户预警</span></a></li>
        ...
        <div class="searchbox fixed">
            <form id="SelectFrom" action="KeHuYuJing.aspx" method="get">
            <span class="searchT">
                <p>
                    客户单位：
        ...
        <!--列表结束-->
        <div id="div_clone" class="tablehead" style="border-top: 0pt none;">
        </div>
    </div>
    ...
    <script type="text/javascript">
        var KeHuYuJing = {
            ...
            PageInit: function() {
                ...
                paidwuc.setOperator(Boxy.queryString("<%=CaiWuShaiXuan1.ClientUniqueIDOperator %>"))
                paidwuc.setOperatorNumber(Boxy.queryString("<%=CaiWuShaiXuan1.ClientUniqueIDOperatorNumber %>"))
                //未付金额
                paidwuc = new wuc.caiWuShaiXuan(window['<%=CaiWuShaiXuan2.ClientUniqueID  %>']);
                paidwuc.setOperator(Boxy.queryString("<%=CaiWuShaiXuan2.ClientUniqueIDOperator %>"))
                paidwuc.setOperatorNumber(Boxy.queryString("<%=CaiWuShaiXuan2.ClientUniqueIDOperatorNumber %>"))
