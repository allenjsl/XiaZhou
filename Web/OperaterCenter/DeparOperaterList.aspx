<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeparOperaterList.aspx.cs"
    Inherits="Web.OperaterCenter.DeparOperaterList" MasterPageFile="~/MasterPage/Front.Master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server">
    ...
    <div class="mainbox">
        <form id="searchform" action="/OperaterCenter/DeparOperaterList.aspx" method="get">
        ...
        <div class="tablelist-box">
            <table width="100%" id="liststyle">
                ...
                <asp:Repeater ID="DeparList" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td align="center">
                            ...
                            <td align="center">
                                <a href="javascript:void(0);" class="customershow">
