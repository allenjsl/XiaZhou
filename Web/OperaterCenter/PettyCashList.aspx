<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PettyCashList.aspx.cs"
    Inherits="Web.OperaterCenter.PettyCashList" MasterPageFile="~/MasterPage/Front.Master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content2" runat="server">
    ...
    <div class="mainbox mainbox-whiteback">
        ...
        <div class="jd-mainbox fixed">
            <uc1:OperaterMenu ID="menu1" runat="server" />
            <div class="jdcz-main">
                <div class="addContent-box">
                    <span class="formtableT">线路信息</span>
                    <table width="100%" cellpadding="0" cellspacing="0" class="firsttable">
                        ...
                        <tr>
                            ...
                            <td class="kuang2">
                                <asp:Literal ID="litNums" runat="server"></asp:Literal>
                            </td>
                            <td class="addtableT">
                                出团时间：
                            </td>
                ...
                <div class="tablelist-box " style="width: 98.5%">
                    ...
                    <asp:PlaceHolder ID="tabCarsView" runat="server" Visible="false">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="6%" align="center" bgcolor="#D4ECF7" class="th-line">
                                    <strong>数量</strong>
                                </td>
                                <td align="left" bgcolor="#D4ECF7" class="th-line">
                                    <strong>费用明细</strong>
                            ...
                            <asp:Repeater ID="repcarslist" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td align="center" class="jd-table01">
                                            <%#Eval("StartDate") == null ? "" : (Convert.ToDateTime(Eval("StartDate")).ToString("M/d"))%>
                                            <%# Eval("StartTime") == null ? "" : Eval("StartTime") %>-
                                            <%# Eval("EndDate") == null ? "" : (Convert.ToDateTime(Eval("EndDate")).ToString("M/d"))%>
                                            <%# Eval("EndTime") == null ? "" : Eval("EndTime") %>
                                        </td>
                                        <td align="center" class="jd-table01">
                                            <%# Eval("Models")%>
                                        </td>
                    ...
                    <asp:PlaceHolder ID="tabForeignShipView" runat="server" Visible="false">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <th rowspan="<%=this.repforeignshiplist.Items.Count+1 %>" class="th-line w30">
                                    <b>涉<br />
                                        外<br />
                                        游<br />
                                        轮</b>
                            ...
                            <asp:Repeater ID="reppicklist" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <%#EyouSoft.Common.UtilsCommons.GetMoneyString(Convert.ToDecimal(Eval("Price")), ProviderToMoney)%>
                                        </td>
                                        <td align="center">
                                            <span <%# (EyouSoft.Model.EnumType.PlanStructure.PlanState)Eval("Status") == EyouSoft.Model.EnumType.PlanStructure.PlanState.未落实?"class='fontred'":"" %>>
                                                <%# Eval("Status").ToString() %>
                    ...
                    <table width="100%" id="tabPreAppView" cellpadding="0" cellspacing="0" class="add-baojia">
                        ...
                        <asp:Repeater ID="repGuidPayList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td align="center">
                                        <uc2:SelectGuid ID="SelectGuid1" ReadOnly="true" runat="server" GuidName='<%# Eval("Borrower") %>'
                                            GuidID='<%# Eval("BorrowerId") %>' />
                                    </td>
                                    <td align="center">
                                    ...
                                    <td align="center">
                                        <textarea name="txtUseFor" id="txtUseFor" style="height: 28px;"
                                            class="inputtext formsize250"><%# Eval("UseFor")%></textarea>
                                    </td>
                        ...
                        <tr>
                            <td align="center">
                                <uc2:SelectGuid ID="SelectGuid1" runat="server" ReadOnly="true" />
                            </td>
                            <td align="center">
                                <input name="txtBorrowTime" onfocus="WdatePicker({minDate: '%y-%M-#{%d' });" type="text"
                                    style="width: 60px;" class="inputtext" />
    ...
    <script type="text/javascript">
        var PrePage = {
            ...
            _DeletePre: function(objId) {
                $.newAjax({
                    type: "get",
                    url: '/OperaterCenter/PettyCashList.aspx?sl=' + PrePage.sl + '&action=delete&ID=' + objId,
                    cache: false,
                    dataType: "json",
                    success: function(data) {
                        if (data.result == "1") {
                            tableToolbar._showMsg(data.msg, function() {
                                window.location.href = '/OperaterCenter/PettyCashList.aspx?type=' + PrePage.type + '&sl=' + PrePage.sl + '&TourId=' + PrePage.tourID;
                            });
                            return false;
                        }
                        else {
            ...
            _SavePre: function(datas, objId) {
                $.newAjax({
                    type: "get",
                    url: '/OperaterCenter/PettyCashList.aspx?sl=' + PrePage.sl + '&TourId=' + PrePage.tourID + '&action=update&ID=' + objId,
                    cache: false,
                    dataType: "json",
                    data: datas,
            ...
            _BindBtn: function() {
                ...
                $("#tabPreAppView").find("[data-class='savePreApp']").click(function() {
                    ...
                    var data = { guid: "", guidName: "", txtBorrowTime: "", txtBorrowAmount: "", txtPreSignNum: "", txtUseFor: "" };
