<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Print.Master"
    ValidateRequest="false" CodeBehind="baochekeyunjihuadan.aspx.cs" Inherits="EyouSoft.Web.PrintPage.xz.baochekeyunjihuadan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PrintC1" runat="server">
    ...
    <table width="696" border="0" align="center" cellpadding="0" cellspacing="0" class="list_2 borderbot_2">
        <tr>
            ...
            <td width="132">
                <input type="text" class="input120" />
            </td>
        </tr>
        <tr>
            <th align="right">
            ...
            <td width="132">
                <asp:Label runat="server" ID="lbModels">
                </asp:Label>
            </td>
            <th width="100" align="right">
                用车数量
        ...
        <tr>
            ...
            <td colspan="5">
                <asp:Label runat="server" ID="lblCarType">
                </asp:Label>
            </td>
        </tr>
        <tr>
