<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Print.Master"
    ValidateRequest="false" CodeBehind="dingdanxinxihuizongbiao.aspx.cs" Inherits="EyouSoft.Web.PrintPage.xz.dingdanxinxihuizongbiao" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PrintC1" runat="server">
    ...
    <asp:Repeater runat="server" ID="rpt_OrderList" OnItemDataBound="rpt_OrderList_ItemDataBound">
        <ItemTemplate>
                ...
                <table width="696" border="0" align="center" cellpadding="0" cellspacing="0" class="list_2"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            X 儿童数：<strong><%#Eval("Childs")%></strong>+ 其它费用：<b><%#EyouSoft.Common.UtilsCommons.GetMoneyString(
                                             EyouSoft.Common.Utils.GetDecimal(Eval("OtherPrice").ToString()), ProviderToMoney)%></b>
                        </td>
                    </tr>
                    <asp:Literal runat="server" ID="ltrXiaoShouZengJian"></asp:Literal>
                    <tr>
                        <th align="right">
                            合计金额
                        </th>
                ...
                <asp:Repeater runat="server" ID="rpt_BackList">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%# EyouSoft.Common.Function.StringValidate.TextToHtml(Eval("Memo").ToString())%>
                            </td>
                            <td align="center">
            ...
            <table width="696" border="0" align="center" cellpadding="0" cellspacing="0" class="list_2">                
                <asp:Literal runat="server" ID="ltrBianGengZengJian"></asp:Literal>
                <tr>
