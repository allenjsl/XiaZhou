...
namespace EyouSoft.Web.PrintPage.xz
{
    ...
    /// 方琪 2012-05-15
    /// </summary>
    public partial class guoneiyouluntongzhidan : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Title = PrintTemplateType.国内游轮确认单.ToString();
        }

        protected void InitPage(string planId)
        {
            EyouSoft.BLL.PlanStructure.BPlan BLL = new EyouSoft.BLL.PlanStructure.BPlan();
            MPlanBaseInfo model = BLL.GetModel(EyouSoft.Model.EnumType.PlanStructure.PlanProject.国内游轮, planId);
