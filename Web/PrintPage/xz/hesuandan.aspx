<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Print.Master"
    ValidateRequest="false" CodeBehind="hesuandan.aspx.cs" Inherits="EyouSoft.Web.PrintPage.xz.hesuandan" Title="核算单" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PrintC1" runat="server">
    <table width="696" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="40" align="left">
                <b class="font14"><asp:Literal runat="server" ID="ltrDanJuTitle">核算单</asp:Literal></b>
            </td>
            <td align="left">
                <b class="font24">
    ...
    <asp:PlaceHolder runat="server" ID="ph_daishou">
        <table width="696" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="30" class="small_title">
                    <b class="font16">
                        <input type="checkbox" name="checkbox" data-class="checkbox" id="daishou" />
                        <label for="baozhang">
                            供应商代收</label></b>
                </td>
            </tr>
        ...
        <table cellspacing="0" cellpadding="0" width="696" align="center" border="0" class="list_2"
            data-class="tab_daishou">
            <tr>
                <th width="14%" height="20" align="left">
                    订单号
                </th>
            ...
            <asp:Repeater runat="server" ID="rptDaiShou">
                <ItemTemplate>
                    <tr i_daishouid="<%#Eval("DaiShouId") %>">
                        ...
                        <td style="text-align: right; color: <%#(int)Eval("Status")==1?"":"#ff0000" %>">
                            <%#Eval("JinE","{0:C2}") %>&nbsp;
                        </td>
                        <td style="color: <%#(int)Eval("Status")==1?"":"#ff0000" %>">
                            <%#Eval("Status") %>
                        </td>
                        <td class="word_break">
                            <%#Eval("BeiZhu") %>
