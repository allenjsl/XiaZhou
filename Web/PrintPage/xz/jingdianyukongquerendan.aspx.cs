...
{
    public partial class jingdianyukongquerendan : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Page.Title = PrintTemplateType.景点预控确认单.ToString();
        }
        ...
        protected void InitPage(string sueId)
        {
            ...
            int recordCount = 0;
            ls = new BSourceControl().GetSightUseList(this.SiteUserInfo.CompanyId, sueId, 1, 1, ref recordCount);
            if (recordCount > 0)
            {
                newls = new BSourceControl().GetSightUseList(this.SiteUserInfo.CompanyId, sueId, 1, recordCount, ref recordCount);
            }
            ...
            var carModel = new EyouSoft.BLL.SourceStructure.BSourceControl().GetModelBySightId(sueId, this.SiteUserInfo.CompanyId);
            if (carModel != null)
            {
                this.lbCarName.Text = carModel.SourceName;
                this.lbCarType.Text = carModel.SpotName;
