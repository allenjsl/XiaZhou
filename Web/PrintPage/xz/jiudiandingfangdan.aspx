<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Print.Master"
    ValidateRequest="false" CodeBehind="jiudiandingfangdan.aspx.cs" Inherits="EyouSoft.Web.PrintPage.xz.jiudiandingfangdan" %>
            ...
            <td colspan="5">
                <asp:Repeater runat="server" ID="rpt_PlanHotelRoomList">
                    <ItemTemplate>
                        ...
                        X
                        <%#Eval("Quantity")%>间 X<%#Eval("days") %>天 (入住：<%#Eval("CheckInDate","{0:yyyy-MM-dd}") %>&nbsp;退房：<%#Eval("CheckOutDate","{0:yyyy-MM-dd}") %>)
                        =
