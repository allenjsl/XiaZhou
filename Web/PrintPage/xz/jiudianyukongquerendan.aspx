<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/Print.Master"
    ValidateRequest="false" CodeBehind="jiudianyukongquerendan.aspx.cs" Inherits="EyouSoft.Web.PrintPage.xz.jiudianyukongquerendan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PrintC1" runat="server">
    ...
    <table width="696" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="0"
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:Label runat="server" ID="lbHotelName">
                </asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:Label runat="server" ID="lbRoomType">
                </asp:Label>
            </td>
            <th width="100" align="right">
                控房数量
            ...
            <td>
                <asp:Label runat="server" ID="lbRoomNum">
                </asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:Label runat="server" ID="lbDate">
                </asp:Label>
            </td>
            <th align="right">
                最后保留日期
        ...
        <tr>
            ...
            <td>
                <asp:Label runat="server" ID="lbRoomPrice">
                </asp:Label>
            </td>
            <th align="right">
                总房金额
            ...
            <td>
                <asp:Label runat="server" ID="lbTotalPrcie">
                </asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <asp:Label runat="server" ID="lbPreMoney">
                </asp:Label>
            </td>
        </tr>
        <tr>
