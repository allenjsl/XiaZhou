<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Web.ResourceCenter.Car.Add" %>
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
            <tr>
                <td width="14%" height="34" align="right" bgcolor="#b7e0f3">
                    <span class="alertboxTableT">车队名称：</span>
                </td>
                <td width="41%">
                ...
                <td width="32%">
                    <select class="inputselect" name="ddl_carType" id="ddl_carType" valid="isNo" errmsg="请选择车型"
                        novalue="-1">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_sueStartTime" runat="server" onfocus="WdatePicker({onpicked:AddPage.WdatePickerCallBack});"
                        CssClass="inputtext formsize80" valid="required" errmsg="预控日期不能为空！"></asp:TextBox>
                    -
                    <asp:TextBox ID="txt_sueEndTime" runat="server" onfocus="WdatePicker({onpicked:AddPage.WdatePickerCallBack});"
                        CssClass="inputtext formsize80" valid="required" errmsg="预控日期不能为空！"></asp:TextBox>
                </td>
                ...
                <td>
                    <asp:TextBox ID="txt_day" CssClass="inputtext formsize80" runat="server" valid="required|RegInteger"
                        errmsg="天数不能为空！|天数不能为负数!"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td height="34" align="right" bgcolor="#b7e0f3">
        ...
        var AddPage = {
            ...
            GetCarType: function(id) {/*获取酒店房型*/
                ...
                $.newAjax({
                    type: "get",
                    cache: false,
                    url: "/ResourceCenter/Car/Add.aspx?" + $.param({ doType: "GetCarType", sourceId: id }),
                    data: {},
                    dataType: "html",
            ...
            Save: function(obj) {
                var that = this;
                if (that.FormCheck()) {
                    var url = '/ResourceCenter/Car/Add.aspx?' + $.param({ sl: '<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>', doType: "Save" });
                    obj = $(obj);
                    obj.unbind("click");
