<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="EyouSoft.Web.ResourceCenter.Other.Add" %>
        ...
        <table width="99%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
            <tr>
                <td width="14%" height="34" align="right" bgcolor="#b7e0f3">
                    <span class="alertboxTableT">其他公司名称：</span>
                </td>
                <td width="41%">
                ...
                <td width="32%">
                    <select class="inputselect" name="ddl_carType" id="ddl_carType" valid="isNo" errmsg="请选择支出类别"
                        novalue="-1">
        ...
        var AddPage = {
            ...
            GetCarType: function(id) {/*获取酒店房型*/
                ...
                $.newAjax({
                    type: "get",
                    cache: false,
                    url: "/ResourceCenter/Other/Add.aspx?" + $.param({ doType: "GetCarType", sourceId: id }),
                    data: {},
                    dataType: "html",
                    ...
                    error: function() {
                        obj.html("<option value=-1>-无可用支出-</option>");
                    }
                });
            ...
            Save: function(obj) {
                var that = this;
                if (that.FormCheck()) {
                    var url = '/ResourceCenter/Other/Add.aspx?' + $.param({ sl: '<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>', doType: "Save" });
                    obj = $(obj);
                    obj.unbind("click");
