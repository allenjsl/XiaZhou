<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="EyouSoft.Web.ResourceCenter.Other.List"  MasterPageFile="~/MasterPage/Front.Master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbox">
        ...
        <div class="searchbox fixed">
            <span class="searchT">
                <p>
                    其他公司名称：<input type="text" name="tavName" class="inputtext formsize180" value="<%=Request.QueryString["tavName"] %>" />
                    支出类别：
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Add: function() {/*添加弹窗*/
                ...
                data.url = "/ResourceCenter/Other/Add.aspx?" + $.param({ sl: Boxy.queryString("sl") });
                this.ShowBoxy(data);
                return false;
            },
            USED: function(obj) {/*已使用数量弹窗*/
                ...
                data.url += "/USED.aspx?" + $.param({
                    ...
                    sourceControlCategory: '<%=(int)EyouSoft.Model.EnumType.SourceStructure.SourceControlCategory.其他%>',
