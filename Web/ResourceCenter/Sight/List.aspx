<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="EyouSoft.Web.ResourceCenter.Sight.List" MasterPageFile="~/MasterPage/Front.Master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbox">
        ...
        <div class="searchbox fixed">
            <span class="searchT">
                <p>
                    景点公司名称：<input type="text" name="tavName" class="inputtext formsize180" value="<%=Request.QueryString["tavName"] %>" />
                    景点名称：
                ...
                <asp:Repeater ID="rpt_list" runat="server">
                    <ItemTemplate>
                        <tr data-id="<%#Eval("Id") %>">
                            ...
                            <td align="center" data-sourcecontroltype="<%#Eval("SourceControlType") %>" data-periodstarttime="<%#EyouSoft.Common.UtilsCommons.GetDateString(Eval("SueStartTime"), ProviderToDate)%>">
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Add: function() {/*添加弹窗*/
                ...
                data.url = "/ResourceCenter/Sight/Add.aspx?" + $.param({ sl: Boxy.queryString("sl") });
                this.ShowBoxy(data);
                return false;
            },
            USED: function(obj) {/*已使用数量弹窗*/
                ...
                data.url += "/USED.aspx?" + $.param({
                    ...
                    sourceControlCategory: '<%=(int)EyouSoft.Model.EnumType.SourceStructure.SourceControlCategory.景点%>',
