...
{
    public partial class AjaxOtherSupplier : BackPage
    {
        ...
        private void ListDataInit(string provice, string city, string name, string tourid)
        {
            ...
            var ms = new MSourceSueOtherSearch();
            ...
            var list = bsource.GetListSueOther(pageIndex, this.pageSize, ref pageCount, tourid, this.SiteUserInfo.UserId, ms);
            ...
            if (list != null)
            {
                ...
                {
                    this.RepList.Controls.Add(new Label() { Text = "<tr><td colspan='9' align='center'>未找到相关其他预控,建议您修改相关查询条件后再查询！</td></tr>" });
        ...
        protected string GetContactInfo(object sid, string type)
        {
            ...
            var model = bll.GetOtherModel(sourceID);
