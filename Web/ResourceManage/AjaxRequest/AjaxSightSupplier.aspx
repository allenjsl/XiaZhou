<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxSightSupplier.aspx.cs" Inherits="EyouSoft.Web.ResourceManage.AjaxRequest.AjaxSightSupplier" %>
            ...
            <asp:repeater id="RepList" runat="server">
                <ItemTemplate>
                         <tr <%# Container.ItemIndex%2!=0? "":"bgcolor='#F3F3F3'" %>>
                            ...
                            <td align="center">
                                <span><%#Eval("SpotName")%></span>
                            </td>
                            <td align="center">
                                <span><%#Eval("ControlNum")%></span>
                            </td>
                            <td align="center">
                                <%#GetPeriodTime(Eval("SourceControlType"), Eval("SueStartTime"), Eval("SueEndTime"))%>
                           </td>
                           <td align="center">
