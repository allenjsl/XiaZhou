<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="CruiseList.aspx.cs" Inherits="Web.ResourceManage.Cruise.CruiseList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#tablelist').find("a[Data-shipname='shipname']").bt({
                contentSelector: function() {
                    return $(this).prev("span").html();
                },
        ...
        <div class="searchbox fixed">
            ...
            <span class="searchT">
                <p>
                    ...
                    游船公司：
                    <input type="text" size="20" class="inputtext" name="txtCruiseCompany" value='<%=Request.QueryString["txtCruiseCompany"]%>'>
                    游船名称：
                    <input type="text" size="20" class="inputtext" name="txtCruiseName" value='<%=Request.QueryString["txtCruiseName"]%>'>
        ...
        <div class="tablelist-box" id="tablelist">
            <table cellspacing="0" border="0" width="100%" id="liststyle">
                <tbody>
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr <%#Container.ItemIndex%2==0?" class=\"odd\" ":""  %>>
                                ...
                                <td align="center">
                                    <a href="javascript:void(0);" class="a_CompanyName" data-id='<%#Eval("GysId") %>'><%#Eval("GysName")%></a>
                                ...
                                <td align="center">
                                    <span style="display: none"><%#GetYouChuanFuDongHTML(Eval("YouChuans"))%></span> 
                                    <a data-shipname="shipname" href="javascript:void(0);" title=""><%#Eval("YouChuanName1")%></a>
                                </td>
                                <td align="center">
                                    <%#Eval("JiaoYiXX.JiaoYiCiShu")%>
                                </td>
                                <td align="center">
                                    <%#Eval("JiaoYiXX.DJiaoYiShuLiang","{0:F2}")%>
                                </td>
                                <td align="center">
                    ...
                    <asp:Literal ID="litMsgEmpty" runat="server"></asp:Literal>
                </tbody>
            </table>
        </div>
        <!--列表结束-->
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $(".a_CompanyName").click(function() {
                var url = "/ResourceManage/Cruise/CruiseEdit.aspx?";
                var self = this;
                url += $.param({
                    sl: '<%=(int)EyouSoft.Model.EnumType.PrivsStructure.Menu2.资源管理_游轮 %>',
                    chakan: "chakan",
                    dotype: "update",
            ...
            $(".i_jiaoyixx_all").click(function() {
                ...
                var _data = { gysid: "all", gysname: "所有游轮供应商", gysleixing: "<%=(int)EyouSoft.Model.EnumType.SourceStructure.SourceType.游轮 %>" };
                Boxy.iframeDialog({ iframeUrl: url, title: "全部游轮供应商-交易明细", modal: true, data: _data, width: "900px", height: "525px" });
                return false;
            });
        })
    ...
    <script type="text/javascript">
        ...
        //添加(弹窗)
        function Add() {
            ShowBoxy({ iframeUrl: "/ResourceManage/Cruise/CruiseEdit.aspx?sl=<%=(int)EyouSoft.Model.EnumType.PrivsStructure.Menu2.资源管理_游轮 %>", title: "新增游轮", height: "570px", width: "990px" });
        }

        //修改(弹窗)---objsArr选中的TR对象
        function Update(objsArr) {
            ShowBoxy({ iframeUrl: "/ResourceManage/Cruise/CruiseEdit.aspx?doType=update&sl=<%=(int)EyouSoft.Model.EnumType.PrivsStructure.Menu2.资源管理_游轮 %>&id=" + objsArr[0].find("input[type='checkbox']").val(), title: "修改游轮", height: "570px", width: "990px" });
        }
