<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transactions.aspx.cs" Inherits="Web.ResourceManage.Ground.Transactions" %>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                        <tr bgcolor="F3F3F3">
                            ...
                            <td align="right">
                                <b class="fontgreen">
                                    <%#EyouSoft.Common.UtilsCommons.GetMoneyString(Convert.ToDecimal(Eval("ClosingCost")), ProviderToMoney)%></b>
                            </td>
