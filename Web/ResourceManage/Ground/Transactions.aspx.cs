...
namespace Web.ResourceManage.Ground
{
    ...
    public partial class Transactions : BackPage
    {
        ...
        private void DataInit(string id)
        {
            ...
            //IList<EyouSoft.Model.SourceStructure.MTravelClosingCostModel> list = bll.GetTravelTradeListModel(id, this.SiteUserInfo.CompanyId, this.pageIndex, pageSize, ref recordCount);
            //if (list != null && list.Count > 0)
            //{
            //    this.lbClosingCostSum.Text = UtilsCommons.GetMoneyString(list[0].ClosingCostSum, ProviderToMoney);
        ...
        private void ListToExcel(string id)
        {
            ...
            s.Append("团号\t线路名称\t人数\t销售员\t计调\t导游\t明细\t金额\t未付金额\n");
            pageIndex = Utils.GetInt(Utils.GetQueryStringValue("page"));
            EyouSoft.BLL.SourceStructure.BSource bll = new EyouSoft.BLL.SourceStructure.BSource();
            //IList<EyouSoft.Model.SourceStructure.MTravelClosingCostModel> list = bll.GetTravelTradeListModel(id, this.SiteUserInfo.CompanyId, this.pageIndex, toXlsRecordCount, ref recordCount);
            //if (list != null && list.Count > 0)
            //{
            ...
            //            UtilsCommons.GetMoneyString(t.ClosingCost, ProviderToMoney),
            ...
            //            "",
            //            "合计",
            //            UtilsCommons.GetMoneyString(list[0].ClosingCostSum, ProviderToMoney),
