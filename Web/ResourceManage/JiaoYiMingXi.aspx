<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JiaoYiMingXi.aspx.cs" Inherits="EyouSoft.Web.ResourceManage.JiaoYiMingXi"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="PageBody">
    <div class="alertbox-outbox" id="alertbox" style="padding-top:5px;">
        ...
        <div class="tanchuT" style="text-align: right">
            <a href="javascript:void(0)" class="toolbar_dayin" onclick="PrintPage('liststyle')"><img src="/images/dayin1-cy.gif" border="0"></a>&nbsp; 
            <a href="javascript:void(0)" class="toolbar_daochu" onclick="toXls1();return false;"><img src="/images/daochu-cy.gif" border="0"></a>
        </div>
        ...
        <div style="width: 98%; margin: 0px auto;">
            ...
            <input type="hidden" name="gysleixing" value="<%=EyouSoft.Common.Utils.GetQueryStringValue("gysleixing") %>" />
        ...
        <div class="tanchuT" style="margin-top:10px;">【与 <b class="fontred"><%= GysName %></b> 的交易情况】</div>
            ...
            <tbody>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                        <tr bgcolor="F3F3F3">
                            ...
                            <%} %>
                            <td align="center">
                                <%#GetShuLiang(Eval("ShuLiang"),Eval("DShuLiang"),Eval("AnPaiLeiXing"))%>
                            </td>                           
                            <td align="center">
                                <%#Eval("FeiYongMingXi")%>
                            </td>
                            <td align="right">
                                <%#GetJinE(Eval("JinE"),Eval("TourStatus"),Eval("TourType"))%>
                            </td>
                            <td align="right">
                ...
                <asp:PlaceHolder runat="server" ID="phHeJi">
                    <tr bgcolor="#e9f4f9" class="odd">
                        <td style="height: 28px" align="right" class="alertboxTableT" colspan="<%=GysId=="all"?"7":"6" %>">
                            合计：
                        </td>
