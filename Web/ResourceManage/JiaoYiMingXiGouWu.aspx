<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JiaoYiMingXiGouWu.aspx.cs"
    Inherits="EyouSoft.Web.ResourceManage.JiaoYiMingXiGouWu" MasterPageFile="~/MasterPage/Boxy.Master" %>
        ...
        <table width="98%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center"
            ...
            <tbody>
                <tr style="background: url(/images/y-formykinfo.gif) repeat-x center top;" class="odd">
                    ...
                    <td bgcolor="#b7e0f3" align="center" class="alertboxTableT" style="width: 70px">
                        销售员
                    </td>
                    <td bgcolor="#b7e0f3" align="center" class="alertboxTableT" style="width: 70px">
                        计调员
