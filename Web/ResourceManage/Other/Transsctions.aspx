<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transsctions.aspx.cs" Inherits="EyouSoft.Web.ResourceManage.Other.Transsctions" %>
        ...
        <table width="98%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center"
            ...
            <tbody>
                ...
                <tr bgcolor="#e9f4f9" class="odd">
                    <td height="23" align="right" class="alertboxTableT" colspan="6">
                        &nbsp;
                    </td>
                ...
                <tr class="">
                    <td height="23" align="right" class="alertboxTableT" colspan="9">
