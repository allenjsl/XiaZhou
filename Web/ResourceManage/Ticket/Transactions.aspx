<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transactions.aspx.cs" Inherits="Web.ResourceManage.Ticket.Transactions" %>

<%@ Register Assembly="ControlLibrary" Namespace="Adpost.Common.ExporPage" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>资源管理-票务-交易情况</title>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                        <tr bgcolor="F3F3F3">
                            ...
                            <td height="28" align="center">
                                <%#((EyouSoft.Model.SourceStructure.MPeopleCountModel)Eval("TicketCountModel")).AdultCount%>+<%#((EyouSoft.Model.SourceStructure.MPeopleCountModel)Eval("TicketCountModel")).ChildrenCount%>
                            </td>
