<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SingleServerEdit.aspx.cs"
    Inherits="Web.SingleServe.SingleServerEdit" %>
...
<body style="background: 0 none;">
    ...
    <div class="alertbox-outbox" style="padding-top:5px;">
        <table id="tablelist" width="99%" align="center" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td class="alertboxTableT" style="text-align: right; height: 28px; background: #b7e0f3;">订单号：</td>
                <td colspan="5"><asp:Literal runat="server" ID="ltrOrderCode"></asp:Literal></td>
            </tr>
            </asp:PlaceHolder>
            <tr>
                ...
                <td width="10%" align="right" bgcolor="#B7E0F3" class="alertboxTableT">
                    <font color="#FF0000">*</font>计调员：
                </td>
                <td width="20%" class="alertboxTableT">
                    <uc4:SellsSelect ID="SellsSelect2" runat="server" SMode="true" />
                </td>
            </tr>
            <tr>
                <td width="10%" align="right" bgcolor="#B7E0F3" class="alertboxTableT">
            ...
            <tr>
                ...
                <td width="20%" bgcolor="#e0e9ef">
                    <asp:DropDownList ID="ddlopeaterStatus" runat="server" class="inputselect">
                        ...
                        <asp:ListItem Value="3">已落实</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td height="28" colspan="5" align="left" style="padding: 5px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="autoAdd" id="Customlist">
                        ...
                        <tr class="showlist">
                            ...
                            <td height="26" align="center">
                                <input name="ContactTel" type="text" class="inputtext formsize80" id="text3" />
                            </td>
                            <td height="26" align="center">
                        ...
                        <tr style="display: none" id="Templist">
                            ...
                            <td height="26" align="center">
                                <input name="ContactTel" type="text" class="inputtext formsize80" id="textfield17" />
                            </td>
                            <td height="26" align="center">
                                <a href="javascript:void(0)" class="addlist">
                                    <img src="/images/addimg.gif" width="48" height="20" /></a> <a href="javascript:void(0)"
                ...
                <td colspan="5" align="left" style="padding: 5px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="autoAdd" id="Customrequire">
                        ...
                        <tr class="showrequire">
                            ...
                            <td height="50" align="center">
                                <input valid="isNumber" errmsg="必须是数字!" name="Price" type="text" id="textfield82"
                                    class="inputtext formsize80 price" />
                            </td>
                            <td height="50" align="center">
                        ...
                        <tr id="Temprequire" style="display: none">
                            ...
                            <td height="50" align="center">
                                <input valid="isNumber" errmsg="必须是数字!" name="Price" type="text" id="text4" class="inputtext formsize80 price"
                                    value="0" />
                            </td>
                            <td height="50" align="center">
                        ...
                        <asp:Repeater ID="rptRequire" runat="server">
                            <ItemTemplate>
                                <tr class="showrequire">
                                    ...
                                    <td height="50" align="center">
                                        <textarea name="ServiceStandard" class="bk pand4 inputtext" id="textarea1"
                                            style="height: 85px;width:350px;"><%#Eval("ServiceStandard") %></textarea>
                                    </td>
                                    <td height="50" align="center">
                                        <input valid="isNumber" errmsg="必须是数字!" name="Price" type="text" id="text4" class="inputtext formsize80 price"
                ...
                <td colspan="5" align="left" style="padding: 5px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="autoAdd i_gysap"
                        ...
                        <tr class="showsourceplan">
                            ...
                            <td height="50" align="center">
                                <textarea name="remarkSource" class="bk pand4 inputtext" style="height: 55px;
                                    width: 160px;"></textarea>
                            </td>
                        ...
                        <asp:Repeater ID="rptsourceplan" runat="server">
                            <ItemTemplate>
                                <tr class="showsourceplan">
                                    ...
                                    <td height="50" align="center">
                                        <input valid="isNumber" errmsg="必须是数字!" name="PlanCost" type="text" class="inputtext formsize50 plancost"
                                            value="<%#EyouSoft.Common.Utils.FilterEndOfTheZeroDecimal(Convert.ToDecimal(Eval("PlanCost"))) %>" />
                                    </td>
                                    <td height="50" align="center">
                                        <select name="PayType" class="inputselect">
                                    ...
                                    <td height="50" align="center">
                                        <textarea name="remarkSource" class="bk pand4 inputtext" style="height: 55px; width:160px;"><%#Eval("CostDetail")%></textarea>
                                    </td>
                                    <td height="50" align="center" class="i_gysap_cz_1">
                                        <a href="javascript:void(0)" class="addsourceplan">
                                            <img src="/images/addimg.gif" width="48" height="20" /></a> <a href="javascript:void(0)"
            ...
            <tr>
                ...
                <td align="right" bgcolor="#b7e0f3" style="padding: 5px;">
                    <span class="alertboxTableT"><font color="#FF0000">*</font>合计支出：</span>
                </td>
                <td align="left" style="padding: 5px;">
                    <asp:TextBox ID="txtTotalEx" BackColor="#dadada" runat="server" class="inputtext formsize80"
                        Text="0" ReadOnly="true"></asp:TextBox>
                </td>
                <td align="right" bgcolor="#b7e0f3" style="padding: 5px;">
                    <span class="alertboxTableT"><font color="#FF0000">*</font>毛利：</span>
                </td>
                <td align="left" style="padding: 5px;">
                    <asp:TextBox ID="txtProfit" BackColor="#dadada" runat="server" class="inputtext formsize80"
        ...
        <div class="alertbox-btn">
            ...
            <a style="text-indent: 0px;" hidefocus="true" href="javascript:void(0);" id="SubmitPlan">提交计调终审</a>
            </asp:PlaceHolder>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var SingleEditPage = {
        ajaxurl: "/SingleServe/SingleServerEdit.aspx",
        ...
        PageInit: function() {
            ...
            $("#link3").click(function() {
                Boxy.iframeDialog({
                    iframeUrl: "/ImportSource/ImportPage.aspx?callback=CallBack&type=4&box=Customlist",
                    title: "导入客户",
                    modal: true,
                    width: "900px",
                    height: "500px"
            ...
            if (_tourStatus == "<%=(int)EyouSoft.Model.EnumType.TourStructure.TourStatus.计调配置完毕 %>") {
                $("#btnSave").remove();
            }
            ...
            if (_tourStatus == "<%=(int)EyouSoft.Model.EnumType.TourStructure.TourStatus.待终审 %>"
                || _tourStatus == "<%=(int)EyouSoft.Model.EnumType.TourStructure.TourStatus.财务核算 %>"
            ...
            $(".Offers").live("click", function() {
                ...
                var url = "/CommonPage/UseSupplier.aspx?aid=" + $(this).attr("id") + "&";
                ...
                url += $.param({ suppliertype: sourceID, hideID: hideObj.attr("id"), callBack: "CallBackSource", ShowID: showObj.attr("id") })
                Boxy.iframeDialog({
                    iframeUrl: url,
                    title: "选择供应商",
                    modal: true,
            ...
            $(".addlist").live("click", function() {
                var tr = "<tr class='showlist'>" + $("#Templist").html() + "</tr>";
            ...
            $(".price").live("keyup", function() {
                ...
                $("#<%=txtProfit.ClientID %>").val(parseFloat($("#<%=txtTotalIn.ClientID %>").val()) - parseFloat($("#<%=txtTotalEx.ClientID %>").val()));
            })
            $(".plancost").live("keyup", function() {
                ...
                $("#<%=txtTotalEx.ClientID %>").val(price);
                $("#<%=txtProfit.ClientID %>").val(parseFloat($("#<%=txtTotalIn.ClientID %>").val()) - parseFloat($("#<%=txtTotalEx.ClientID %>").val()));
            })


            $(".dellist").live("click", function() {
                if ($("#Customlist .showlist").length == 1) {
            ...
            $(".delrequire").live("click", function() {
                ...
                if ($("#Customrequire .showrequire").length > 1) {
                    ...
                    $("#<%=txtTotalIn.ClientID %>").val(price);
                    $("#<%=txtProfit.ClientID %>").val(parseInt($("#<%=txtTotalIn.ClientID %>").val()) - parseInt($("#<%=txtTotalEx.ClientID %>").val()));
                }
                else {
                    tableToolbar._showMsg("请选择要删除的行!");
                }
        ...
        BindBtn: function() {
            ...
            $("#SubmitPlan").click(function() {
                if ($("#<%=ddlopeaterStatus.ClientID %>").val() != "3") {
        ...
        initFuWuLeiBie: function(obj) {
            ...
            var _txt = {
                't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.大交通 %>': "机票、火车票、汽车票\n出发地：\t目的地：\n出发日期：\t返回日期：\n去程航班号：\t回程航班号：\n价格：\t元/张，共\t张\n合计金额：\t元"
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.用车 %>': "车辆租用起始时间：\t年\t月\t日\t时\n停止时间：\t年\t月\t日\t时\n车型：\t数量：\n简要行程：\n合计金额：\t元"
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.房 %>': "酒店所在城市：\t标准：\t\n数量：\t间\n入住时间：\t年\t月\t日\n退房时间：\t年\t月\t日\n共\t晚\n客房单价：\t元/间，合计金额：\t元"
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.餐 %>': ""
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.导服 %>': ""
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.景点 %>': ""
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.保险 %>': ""
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.小交通 %>': ""
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.综费 %>': ""
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.其它 %>': ""
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.国内段 %>': ""
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.签证 %>': ""
                , 't<%=(int)EyouSoft.Model.EnumType.ComStructure.ContainProjectType.游船 %>': ""
            };
    ...
    $(function() {
        ...
        if ('<%=EyouSoft.Common.Utils.GetQueryStringValue("id") %>'.length > 0) { $("#<%=txtWeiTuoRiQi.ClientID %>").attr("readonly", "readonly").css({ "background": "#efefef" }).removeAttr("onfocus"); }
    })
</script>
