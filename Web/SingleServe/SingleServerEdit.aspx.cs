...
namespace Web.SingleServe
{
    ...
    public partial class SingleServerEdit : BackPage
    {
        ...
        {
            Privs_JiDiaoAnPai = this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.单项业务_单项业务_单项计调);
            Privs_Insert = this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.单项业务_单项业务_新增);
            Privs_Update = this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.单项业务_单项业务_修改);
