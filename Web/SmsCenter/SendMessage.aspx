...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="alertboxbk3">
                ...
                <tr>
                    ...
                    <td bgcolor="#FFFFFF">
                        ...
                        <asp:TextBox ID="txtSender" runat="server" CssClass=" inputtext formsize120"></asp:TextBox>
    ...
    <script type="text/javascript">
        var SendSms = {
            ...
            //从客户导入号码
            putInCust: function() {
                return SendSms.openDialog("/CommonPage/ImportCustomerNo.aspx", "从客户导入号码", "800px", "400px");
            },
            //自动填写发送内容
            autoSms: function() {
