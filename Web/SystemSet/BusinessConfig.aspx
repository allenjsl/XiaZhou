<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="BusinessConfig.aspx.cs" Inherits="Web.SystemSet.BusinessConfig" %>
    ...
    <div class="mainbox mainbox-whiteback">
        ...
        <div class="tablelist-box">
            <div style="background: none #f6f6f6;" class="tablehead">
                <ul class="fixed">
                    <li><s class="orderformicon"></s><a class="ztorderform" hidefocus="true" href="PrintConfig.aspx?sl=<%=SL %>">
                        <span>打印配置</span></a></li>
                    <li><s class="orderformicon"></s><a class="ztorderform de-ztorderform" hidefocus="true"
                        href="BusinessConfig.aspx?sl=<%=SL %>"><span>业务配置</span></a></li>
                    <li><s class="orderformicon"></s><a class="ztorderform" hidefocus="true" href="TourCodeSet.aspx?sl=<%=SL %>">
                        <span>团号配置</span></a></li>
                </ul>
            </div>
            <table width="100%" align="center" id="liststyle">
                <tbody>
                    ...
                    <%--<tr>
                        ...
                        <label>
                            欠款额度控制
                            <input type="checkbox" id="chkQianKuaiControl" name="chkQianKuaiControl" runat="server" /></label>
                        </td>
                        <td align="left">
                            <label>
                                财务支出审核
                                <input type="checkbox" id="chkPayOutCheck" name="chkPayOutCheck" runat="server" /></label>
                        </td>
                    </tr>
                    <tr>
                        <td align="left">
                            <label>
                                财务收入审核
                                <input type="checkbox" id="chkIncomeCheck" name="chkIncomeCheck" runat="server" /></label>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#e0e9ef" align="right">
                        ...
                        <td align="left">
                            <span style="font-size: 14px">
                                <input type="text" class="inputtext formsize40" id="txtCreditsPer" name="txtCreditsPer"
                                    runat="server" />
                            </span>
                        </td>
                    </tr>--%>
        ...
        var TourRule = {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/SystemSet/BusinessConfig.aspx?dotype=save&sl=<%=SL %>",
