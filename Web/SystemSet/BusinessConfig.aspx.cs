...
namespace Web.SystemSet
{
    ...
    public partial class BusinessConfig : BackPage
    {
        ...
        protected void PageInit()
        {
            ...
            if (model != null)
            {
                ...
                //txtTipHours.Value = (model.RemindTime / 3600).ToString();
                //txtTipMinutes.Value = ((model.RemindTime % 3600) / 60).ToString();
                //txtTipSecond.Value = ((model.RemindTime % 3600) % 60).ToString();
                //if (model.CountryArea != 0)
                //{
                //    chkCountry.Checked = true;
                //    txtAdvanceDayforCountry.Value = model.CountryArea.ToString();
                //}
                //if (model.ProvinceArea != 0)
                //{
                ...
                //}
                //chkQianKuaiControl.Checked = model.ArrearsRangeControl;
