<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="GuestLevelEdit.aspx.cs"
    Inherits="Web.SystemSet.GuestLevelEdit" %>
            ...
            <tbody>
                <tr>
                    ...
                    <td width="35%" height="28" align="left">
                        <asp:TextBox ID="txtLevelName" runat="server"  CssClass=" inputtext formsize180" Valid="request" errmsg="等级名称不能为空！"></asp:TextBox>
                    </td>
                </tr>
            </tbody>
        </table>
           ...
           var GuestLevelEdit = {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/SystemSet/GuestLevelEdit.aspx?dotype=save&"+$.param(GuestLevelEdit.Params),
                    data: $("#btnSave").closest("form").serialize(),
                    dataType: "json",
                    success: function(ret) {
                        //ajax回发提示
                        if (ret.result == "1") {
                            parent.tableToolbar._showMsg(ret.msg,function(){parent.window.location.href="/SystemSet/GuestLevelList.aspx?&"+$.param(GuestLevelEdit.Params);});
                        } else {
