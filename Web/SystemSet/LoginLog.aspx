<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="LoginLog.aspx.cs" Inherits="EyouSoft.Web.SystemSet.LoginLog" %>
        ...
        <div style="background: none #f6f6f6;" class="tablehead">
            <ul class="fixed">
                <li><s class="orderformicon"></s><a class="ztorderform de-ztorderform" hidefocus="true"
                    href="LoginLog.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>"><span>
                        登录日志</span> </a></li>
                <li><s class="orderformicon"></s><a class="ztorderform" hidefocus="true" href="OperationLog.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>">
                    <span>操作日志</span></a></li>
            </ul>
        </div>
