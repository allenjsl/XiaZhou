<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberTypeEdit.aspx.cs"
    Inherits="Web.SystemSet.MemberTypeEdit" %>
         ...
         var MemberTypeEdit = {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/SystemSet/MemberTypeEdit.aspx?dotype=save&"+$.param(MemberTypeEdit.Params),
                    data: $("#btnSave").closest("form").serialize(),
                    dataType: "json",
                    success: function(ret) {
                        //ajax回发提示
                        if (ret.result == "1") {
                            parent.tableToolbar._showMsg(ret.msg,function(){parent.window.location.href="/SystemSet/MemberTypeList.aspx?&"+$.param(MemberTypeEdit.Params);});
                        } else {
