...
namespace Web.SystemSet
{
    public partial class MemberTypeEdit : BackPage
    {
        ...
        {
            if (!this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.系统设置_基础设置_会员管理栏目))
            {
                Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.系统设置_基础设置_会员管理栏目, false);
                return;
            }
        }
