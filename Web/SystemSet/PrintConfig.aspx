<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="PrintConfig.aspx.cs" Inherits="Web.SystemSet.PrintConfig" %>
        ...
        <div style="background: none #f6f6f6;" class="tablehead">
            <ul class="fixed">
                <li><s class="orderformicon"></s><a class="ztorderform de-ztorderform" hidefocus="true"
                    href="PrintConfig.aspx?sl=<%=SL %>"><span>打印配置</span></a></li>
                <li><s class="orderformicon"></s><a class="ztorderform" hidefocus="true" href="BusinessConfig.aspx?sl=<%=SL %>">
                    <span>业务配置</span></a></li>
      ...
      //提交表单
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/SystemSet/PrintConfig.aspx?dotype=save&sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>",
                    data: $("#btnSave").closest("form").serialize(),
                    dataType: "json",
                    success: function(ret) {
                        //ajax回发提示
                        if (ret.result == "1") {
                            tableToolbar._showMsg(ret.msg,function(){ window.location.href='/SystemSet/PrintConfig.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>';});
                        } else {
