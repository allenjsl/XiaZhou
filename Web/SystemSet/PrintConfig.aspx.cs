...
namespace Web.SystemSet
{
    ...
    /// 修改记录：
    /// 1、2011-10-9 曹胡生 创建
    public partial class PrintConfig : BackPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.UploadGZ.CompanyID = SiteUserInfo.CompanyId;
            this.UploadGZ.IsUploadMore = false;
            this.UploadGZ.IsUploadSelf = true;

            this.UploadYM.FileTypes = "*.jpg;*.jpeg;*.gif;*.png;*.bmp;";
            this.UploadYJ.FileTypes = "*.jpg;*.jpeg;*.gif;*.png;*.bmp;";
            this.UploadGZ.FileTypes = "*.jpg;*.jpeg;*.gif;*.png;*.bmp;";
        ...
        protected void PageInit()
        {
            ...
            if (model != null)
            {
                ...
                if (!string.IsNullOrEmpty(model.CompanyChapter))
                {
                    lblGZ.Text = string.Format("<span class='upload_filename'>&nbsp;<a href='{0}' target='_blank'>查看</a><a href='javascript:void(0);' onclick='PrintConfig.RemoveFile(this);return false;'> <img style='vertical-align:middle' src='/images/cha.gif'></a><input type='hidden' name='hidGZ' value='{0}'/></span>", model.CompanyChapter);
                }
            }
        }
        ...
        {
            if (!this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.系统设置_系统配置_栏目))
            {
                Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs.系统设置_系统配置_栏目, false);
                return;
            }
        }
