<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="QuoteStandardEdit.aspx.cs"
    Inherits="Web.SystemSet.QuoteStandardEdit" %>
        ...
        var QuoteStandardEdit = {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/SystemSet/QuoteStandardEdit.aspx?dotype=save&"+$.param(QuoteStandardEdit.Params),
                    data: $("#btnSave").closest("form").serialize(),
                    dataType: "json",
                    success: function(ret) {
                        //ajax回发提示
                        if (ret.result == "1") {
                            parent.tableToolbar._showMsg(ret.msg,function(){parent.window.location.href="/SystemSet/QuoteStandardList.aspx?&"+$.param(QuoteStandardEdit.Params);});
                        } else {
