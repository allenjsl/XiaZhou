<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="QuoteStandardList.aspx.cs" Inherits="Web.SystemSet.QuoteStandardList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <tr>
                        <cc1:CustomRepeater ID="repList" runat="server">
                            <ItemTemplate>
                                ...
                                <td align="center">
                                    <a class="update_bjbz" target="_blank" href="QuoteStandardEdit.aspx?id=<%#Eval("Id")%>&Name=<%#Server.UrlEncode(Eval("Name").ToString())%>">
    ...
    <script type="text/javascript">
        var QuoteStandardList = {
            ...
            Del: function(id) {
                //删除
                var url = "QuoteStandardList.aspx?ids=" + id + "&state=del&" + $.param(QuoteStandardList.Params);
        ...
        tableToolbar.init({
            ...
            deleteCallBack: function(objsArr) {
                //删除
                var url = "QuoteStandardList.aspx?ids=" + QuoteStandardList.GetSelectItemValue().toString() + "&state=del&" + $.param(QuoteStandardList.Params);
                window.location.href = url;
                return false;
            }
        });
        $(".add_xlqy").click(function() {
            var url = "QuoteStandardEdit.aspx?" + $.param(QuoteStandardList.Params);
