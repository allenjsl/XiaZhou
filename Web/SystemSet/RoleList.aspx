        ...
        var RoleList = {
            ...
            Oper: function(type) {
                $.newAjax({
                    type: "get",
                    cache: false,
                    url: "/SystemSet/RoleList.aspx?dotype=" + type + "&ids=" + RoleList.GetSelectItemValue().toString() + "&sl=" + RoleList.SL,
                    dataType: "json",
            ...
            Init: function() {
                ...
                tableToolbar.init({
                    ...
                    updateCallBack: function(objsArr) {
                        //修改
                        var url = "RolePowerConfig.aspx?id=" + RoleList.GetSelectItemValue().toString() + "&sl=" + RoleList.SL;
                        RoleList.openXLwindow(url, "修改权限", "780px", "680px");
                        return false;
                    },
                    copyCallBack: function(objsArr) {
                        //复制
                        var url = "RolePowerConfig.aspx?state=copy&id=" + RoleList.GetSelectItemValue().toString() + "&sl=" + RoleList.SL;
                ...
                $(".add_xq").click(function() {
                    var url = 'RolePowerConfig.aspx?&sl=' + RoleList.SL;
                    RoleList.openXLwindow(url, "添加权限", "780px", "680px");
                    return false;
                });

                $(".update_xq").click(function() {
                    var url = "RolePowerConfig.aspx?&id=" + $(this).attr("RoleId") + "&sl=" + RoleList.SL;
                    RoleList.openXLwindow(url, "修改权限", "780px", "680px");
                    return false;
                });
            }
