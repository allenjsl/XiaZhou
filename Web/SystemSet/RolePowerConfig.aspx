<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="RolePowerConfig.aspx.cs"
    Inherits="Web.SystemSet.RolePowerConfig" %>
        ...
        var RolePowerConfig = {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/SystemSet/RolePowerConfig.aspx?dotype="+RolePowerConfig.DoType+"&sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>&id=<%=EyouSoft.Common.Utils.GetQueryStringValue("id") %>",
