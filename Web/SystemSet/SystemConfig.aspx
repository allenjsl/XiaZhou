<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="SystemConfig.aspx.cs" Inherits="Web.SystemSet.SystemConfig" %>
        ...
        <div class="tablelist-box">
            <table width="100%" align="center" id="liststyle">
                <tbody>
                    ...
                    <tr>
                        <td bgcolor="#e0e9ef" align="right">
                            手机端LOGO上传(大小:160*30px)：
                        </td>
                        <td align="left" colspan="2">
                            <uc1:UploadControl ID="ucMLogo" runat="server" />
                            <asp:Label ID="lblMLogo" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#e0e9ef" align="right">
                            供应商端LOGO上传(大小:371*64px)：
                        </td>
                        <td align="left" colspan="2">
                            <uc1:UploadControl ID="ucGYSLogo" runat="server" />
                            <asp:Label ID="lblGYSLogo" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#e0e9ef" align="right">
      ...
      //提交表单
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/SystemSet/SystemConfig.aspx?dotype=save&sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>",
                    data: $("#btnSave").closest("form").serialize(),
                    dataType: "json",
                    success: function(ret) {
                        //ajax回发提示
                        if (ret.result == "1") {
                            tableToolbar._showMsg(ret.msg,function(){window.location.href='/SystemSet/SystemConfig.aspx?sl=<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>';});
                        } else {
