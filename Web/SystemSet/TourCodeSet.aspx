<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="TourCodeSet.aspx.cs" Inherits="EyouSoft.Web.SystemSet.TourCodeSet" %>
            ...
            <div style="background: none #f6f6f6;" class="tablehead">
                <ul class="fixed">
                    ...
                    <li><s class="orderformicon"></s><a class="ztorderform de-ztorderform" hidefocus="true"
                        href="TourCodeSet.aspx?sl=<%=SL %>"><span>团号配置</span></a></li>
                </ul>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset>
                                <legend>规则设定</legend>
                                <table cellspacing="0" cellpadding="3" bordercolor="#93b5d7" border="1" align="left" width="100%">
                                    <tbody>
                                        <tr>
           ...
           //常量，代表 分隔符的OptionId
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/SystemSet/TourCodeSet.aspx?dotype=save&sl=<%=SL %>",
            ...
            $("select[name='ddl_Rule']").change(function(){
                ...
                if(changeValue!=TourRule.SEPARATE){
                    if ($(this).prevAll("select[value='" + changeValue + "']").length > 0
					    ...
					    || changeValue == TourIdRuleOption.SERIALNUMBER) {
