<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="UserList.aspx.cs" Inherits="Web.SystemSet.UserList" %>
    ...
    <div class="mainbox">
        ...
        <div class="searchbox fixed">
            <span class="searchT">
                <p>
                    ...
                    角色：<select name="txtRoleId" id="txtRoleId" class="inputselect">                    
                        <%=GetRoleOptions() %>
                    </select>
                    状态：<select name="txtStatus" id="txtStatus" class="inputselect">
                        <%=EyouSoft.Common.UtilsCommons.GetEnumDDL(EyouSoft.Common.EnumObj.GetList(typeof(EyouSoft.Model.EnumType.ComStructure.UserStatus)), EyouSoft.Common.Utils.GetQueryStringValue("txtStatus"), "", "请选择")%>
                    </select>
        ...
        <div class="tablehead" id="temptablehead">
            <ul class="fixed">
                ...
                <li class="line"></li>
                <%} %>
                <li><s class="cancelicon"></s><a class="toolbar_logout" hidefocus="true" href="javascript:" onclick="UserList.UserLogout()">
                    <span>下线</span></a></li>
                <li class="line"></li>
            </ul>
            <div class="pages">
                    ...
                    <cc1:CustomRepeater ID="repList" runat="server">
                        <ItemTemplate>
                            <tr class="<%#Container.ItemIndex%2==0?"":"#odd" %>">
                                ...
                                <td align="center">
                                    <%#EyouSoft.Common.UtilsCommons.GetMoneyString(Eval("Arrears"), ProviderToMoney)%>
                                </td>
                                <td align="center">
                                    <%#Eval("ContactTel")%>
                                </td>
            ...
            Init: function() {
                ...
                tableToolbar.init({
                    ...
                    otherButtons: [{
                        ...
                        updateCallBack: function(obj) {
                            var url = "UserEdit.aspx?sl=" + UserList.sl + "&id=" + UserList.GetSelectItemValue().toString();
                            UserList.openXLwindow(url, "修改用户", "800px", "410px");
                            return false;
                        },
                    ...
                    $(".add_gg").click(function() {
                        var url = "UserEdit.aspx?sl=" + UserList.sl;
                        UserList.openXLwindow(url, "添加用户", "800px", "410px");
                        return false;
                    });
                ...
                Oper: function(type) {
                    $.newAjax({
                        type: "get",
                        cache: false,
                        url: "/SystemSet/UserList.aspx?dotype=" + type + "&ids=" + UserList.GetSelectItemValue().toString() + "&sl=" + UserList.sl,
                        dataType: "json",
