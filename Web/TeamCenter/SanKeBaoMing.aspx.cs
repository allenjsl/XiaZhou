...
{
    public partial class SanKeBaoMing : BackPage
    {
        /// <summary>
        /// 国家编号
        /// </summary>
        ...
        /// 验证客户单位责任销售
        /// </summary>
        void YanZhengZeRenXiaoShou()
        {
            string crmId = Utils.GetQueryStringValue("keHuDanWeiId");
            string sellerId = Utils.GetQueryStringValue("zenRenXiaoShouId");

            var bllRetCode = new EyouSoft.BLL.CrmStructure.BCrm().YanZhengZeRenXiaoShou(crmId, sellerId);

            if (bllRetCode) Utils.RCWE("{\"retCode\":true}");

            Utils.RCWE("{\"retCode\":false}");
        }
    }
