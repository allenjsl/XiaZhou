        ...
        private void PowerControl()
        {
            switch (type)
            {
                case 1:
                    ...
                    if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.组团团队_组团散拼_删除))
                    {
                    ...
                    if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.组团团队_组团散拼_取消))
                    {
                        this.phForCanel.Visible = false;
                    }
                    if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.组团团队_组团散拼_派团给计调))
                    {
                    ...
                    ListPower = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.组团团队_组团散拼_修改).ToString().ToLower() + ",";
                    ListPower += CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.组团团队_组团散拼_派团给计调).ToString().ToLower() + ",";
                    ListPower += CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.组团团队_组团散拼_审核供应商计划).ToString().ToLower() + ",";
                    ListPower += CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.组团团队_组团散拼_新增).ToString().ToLower();
                    break;
                case 2:
                    this.phForAddShort.Visible = false;
                    ...
                    if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.地接团队_组团散拼_删除))
                    {
                        this.phForDelete.Visible = false;
                    }
                    ...
                    if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.地接团队_组团散拼_取消))
                    {
                        this.phForCanel.Visible = false;
                    }
                    if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.地接团队_组团散拼_派团给计调))
                    {
                        this.phForOper.Visible = false;
                    }
                    ...
                    this.phForShemHe.Visible = false;
                    ListPower = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.地接团队_组团散拼_修改).ToString().ToLower() + ",";
                    ListPower += CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.地接团队_组团散拼_派团给计调).ToString().ToLower() + ",";
                    ListPower += "false,";
                    ListPower += CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.地接团队_组团散拼_新增).ToString().ToLower();
                    break;
                case 3:
                    this.phForAddShort.Visible = false;
                    ...
                    if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.出境团队_组团散拼_删除))
                    {
                        this.phForDelete.Visible = false;
                    }
                    ...
                    if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.出境团队_组团散拼_取消))
                    {
                        this.phForCanel.Visible = false;
                    }
                    if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.出境团队_组团散拼_派团给计调))
                    {
                        this.phForOper.Visible = false;
                    }
                    ...
                    this.phForShemHe.Visible = false;
                    this.phForShemHe.Visible = false;
                    ListPower = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.出境团队_组团散拼_修改).ToString().ToLower() + ",";
                    ListPower += CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.出境团队_组团散拼_派团给计调).ToString().ToLower() + ",";
                    ListPower += "false,";
                    ListPower += CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.出境团队_组团散拼_新增).ToString().ToLower();
                    break;
                default:
