<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/UserCenter.Master" AutoEventWireup="true"
    CodeBehind="LaborRemind.aspx.cs" Inherits="Web.UserCenter.WorkAwake.LaborRemind" %>
            ...
            <div style="float: left;">
                <ul class="fixed">
                    <li><s class="orderformicon"></s><a href="LaborRemind.aspx?sl=<%=(int)EyouSoft.Model.EnumType.PrivsStructure.Menu2.个人中心_事务提醒 %>"
                        hidefocus="true" class="ztorderform de-ztorderform"><span>劳动合同</span></a></li>
                    <li><s class="orderformicon"></s><a href="SupplierRemind.aspx?sl=<%=(int)EyouSoft.Model.EnumType.PrivsStructure.Menu2.个人中心_事务提醒 %>"
                        hidefocus="true" class="ztorderform"><span>供应商合同</span></a></li>
                ...
                <div class="tix-text">
                    <b class="fontred">提醒的日期设定：</b>设定提前<input type="text" size="20" class="inputtext formsize40"
                        value="<%=GetLastTime() %>" valid="required|RegInteger" errmsg="请填写天数|天数必须大于0的整数!"
                        name="text" id="txtDay">天提醒
                    <img src="/images/baocunimg.gif" id="btnSave" width="48" height="20" align="top" /></div>
            </div>
            <div class="pages">
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr class="<%#Container.ItemIndex%2==0?"":"odd" %>">
                                ...
                                <td align="center"><%# Eval("FileNo")%></td>
                                <td align="center">
                                        <%# Eval("Name")%>
                                </td>
                                <td align="center">
                                    <%# EyouSoft.Common.Utils.GetDateTime(Eval("MaturityTime").ToString()).ToShortDateString()%>
                                </td>
                                <td align="center">
                                    <%# Eval("ContractNumber")%>
                                </td>
                                <td align="center">
                                    <a href="/ManageCenter/Hr/HrList.aspx?sl=73&danganid=<%#Eval("DangAnId") %>">查看</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
            ...
            $("#btnSave").click(function() {
                ...
                if(ValiDatorForm.validator($(this).closest("form").get(0), "parent")){
                    $.newAjax({
                        ...
                        cache: false,
                        dataType:"json",
                        url: "LaborRemind.aspx?doType=SetLastTime&argument=" + day,
