                        ...
                        <tr class="<%#Container.ItemIndex%2==0?"":"odd" %>">
                            ...
                            <td align="center">
                                <a href="javascript:void(0)" data-class="PlanChange">
                                    <%# Eval("TourCode")%></a><span style="display: none;"><%# GetOperaterInfo(Eval("TourId").ToString())%></span><%#GetTourPlanIschange(Convert.ToBoolean(Eval("State")))%>
                            </td>
                            <td align="left">
                                <%# Eval("RouteName")%>
                            </td>
                                ...
                                <div style="display: none">
                                    <div class="alertbox-outbox" style="width: 550px;" dataclass="Plan_ChangeContent">
                                        ...
                                        <div class="alertbox-btn" style="position: static; width: 99.5%; bottom:0px">
                                            <a id="IsSureChange" href="javascript:void(0)" onclick="SureChange(this)" hidefocus="true"
                            ...
                            <td align="center">
                                <%#Eval("State").ToString() != "False"?"<b class=\"fontgreen\">已确认变更</b>":"<b class=\"fontred\">未确认变更 </b>" %>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
    ...
    <script type="text/javascript">
        ...
        function SureChange(obj)
        {
            ...
            $.newAjax({
                ...
                cache: false,
                dataType:"json",
                url: "PlanChangeRemind.aspx?sl=" + <%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %> + "&doType=IsSureChange&argument=" + tourid,
