<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreControlSight.aspx.cs" Inherits="EyouSoft.Web.UserCenter.WorkAwake.Preview.PreControlSight" MasterPageFile="~/MasterPage/UserCenter.Master" %>
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr class="<%#Container.ItemIndex%2==0?"":"odd" %>">
                                ...
                                <td align="center">
                                    <a class="openInfo" href="javascript:void(0);" ref="RoomUseInfo.aspx?sueId=<%# Eval("Id") %>&sueType=<%=(int)EyouSoft.Model.EnumType.SourceStructure.SourceControlCategory.景点 %>">
                                        <b class="link2">
                                            <%# Eval("AlreadyNum")%></b></a>
                                </td>
                                <td align="center">
             ...
             $("#imgbtnsave").click(function() {
                    ...
                    if(ValiDatorForm.validator($(this).closest("form").get(0), "parent")){
                        $.newAjax({
                            ...
                            cache: false,
                            dataType:"json",
                            url: "PreControlSight.aspx?doType=SetLastTime&argument=" + day,
