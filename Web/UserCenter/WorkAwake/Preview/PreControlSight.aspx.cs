...
{
    public partial class PreControlSight : BackPage
    {
        #region 分页参数
        /// <summary>
        /// 每页显示条数(常量)
        ...
        private void DataInit()
        {
            ...
            var list = bllBIndividual.GetPreControlSightUsedLst(pageSize, pageIndex, ref recordCount, SiteUserInfo.CompanyId, SiteUserInfo.UserId);
        ...
        {
            string msg = string.Empty;
            if (new EyouSoft.BLL.ComStructure.BComSetting().SetSightPreControlRemind(SiteUserInfo.CompanyId, Utils.GetInt(day)))
            {
                msg = UtilsCommons.AjaxReturnJson("true", "您设置景点预控到期前" + day + "提醒成功");
            }
            else
                msg = UtilsCommons.AjaxReturnJson("false", "您设置景点预控到期前" + day + "提醒失败");
        ...
        protected string GetLastTime()
        {
            ...
            if (setting != null) return setting.SightControlRemind.ToString();
