<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/UserCenter.Master" AutoEventWireup="true"
    CodeBehind="PreviewBoat.aspx.cs" Inherits="Web.UserCenter.WorkAwake.Preview.PreviewBoat" %>
        ...
        <div class="tablehead">
            <ul class="fixed">
                ...
                <li><s class="orderformicon"></s><a class="ztorderform de-ztorderform" hidefocus="true"
                    href="javascript:void(0);"><span>游船</span></a></li>
            ...
            <div class="tix-text">
                ...
                <input name="txtDay" id="txtDay" type="text" class="inputtext formsize40" valid="required|RegInteger"
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr class="<%#Container.ItemIndex%2==0?"":"odd" %>">
                                ...
                                <td align="center">
                                    <b>
                                        <%#  EyouSoft.Common.Utils.GetDateTime(Eval("GoShipTime").ToString()).ToShortDateString()%></b></a>
                                </td>
                                <td align="center">
                                    <%#   EyouSoft.Common.Utils.GetDateTime(Eval("LastTime").ToString()).ToShortDateString()%>
                                </td>
                                <td align="center">
                                    <a class="openInfo" href="javascript:void(0);" ref="RoomUseInfo.aspx?sueId=<%# Eval("Id") %>&sueType=<%=(int)EyouSoft.Model.EnumType.SourceStructure.SourceControlCategory.游轮 %>">
                                        <b>
                                            <%# Eval("AlreadyNum")%></b></a>
                                </td>
                                <td align="center">
            ...
            $("#imgbtnsave").click(function() {
                ...
                if(ValiDatorForm.validator($(this).closest("form").get(0), "parent")){
                    $.newAjax({
                        ...
                        cache: false,
                        dataType:"json",
                        url: "PreviewBoat.aspx?doType=SetLastTime&argument=" + day,
