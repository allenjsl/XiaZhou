<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/UserCenter.Master" AutoEventWireup="true"
    CodeBehind="PreviewCar.aspx.cs" Inherits="Web.UserCenter.WorkAwake.Preview.PreviewCar" %>
        ...
        <div class="tablehead">
            <ul class="fixed">
                ...
                <li><s class="orderformicon"></s><a class="ztorderform de-ztorderform" hidefocus="true"
                    href="javascript:void(0);"><span>车辆</span></a></li>
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr class="<%#Container.ItemIndex%2==0?"":"odd" %>">
                                ...
                                <td align="center">
                                    <a class="openInfo" href="javascript:void(0);" ref="RoomUseInfo.aspx?sueId=<%# Eval("Id") %>&sueType=<%=(int)EyouSoft.Model.EnumType.SourceStructure.SourceControlCategory.车辆 %>">
                                        <b class="link2">
                                            <%# Eval("AlreadyNum")%></b></a>
                                </td>
                                <td align="center">
             ...
             $("#imgbtnsave").click(function() {
                    ...
                    if(ValiDatorForm.validator($(this).closest("form").get(0), "parent")){
                        $.newAjax({
                            ...
                            cache: false,
                            dataType:"json",
                            url: "PreviewCar.aspx?doType=SetLastTime&argument=" + day,
