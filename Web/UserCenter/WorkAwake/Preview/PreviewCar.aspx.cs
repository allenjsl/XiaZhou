...
{
    public partial class PreviewCar : BackPage
    {
        /// <summary>
        /// 页面：DOM
        /// </summary>
        ...
        private void DataInit()
        {
            ...
            IList<MSourceSueCar> list = bllBIndividual.GetCarcontrolHotelUsedLst(pageSize, pageIndex, ref recordCount, SiteUserInfo.CompanyId, SiteUserInfo.UserId);
        ...
        {
            string msg = string.Empty;
            if (new EyouSoft.BLL.ComStructure.BComSetting().SetCheLiangYuKongTiXing(SiteUserInfo.CompanyId, Utils.GetInt(day)))
            {
                msg = UtilsCommons.AjaxReturnJson("true", "您设置车辆预控到期前" + day + "提醒成功");
            }
            else
                msg = UtilsCommons.AjaxReturnJson("false", "您设置车辆预控到期前" + day + "提醒失败");
        ...
        protected string GetLastTime()
        {
            ...
            if (setting != null) return setting.CarControlRemind.ToString();
