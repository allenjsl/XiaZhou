...
<span id="<%=ClientUniqueID %>">
    ...
    <select name="<%=ClientUniqueIDOperator %>" class="inputselect" id="<%=ClientUniqueIDOperator %>">
        ...
        <option value="<%=(int)EyouSoft.Model.EnumType.FinStructure.EqualSign.大于等于 %>">
            <%=EyouSoft.Model.EnumType.FinStructure.EqualSign.大于等于 %></option>
        <option value="<%=(int)EyouSoft.Model.EnumType.FinStructure.EqualSign.等于 %>">
            <%=EyouSoft.Model.EnumType.FinStructure.EqualSign.等于 %></option>
        <option value="<%=(int)EyouSoft.Model.EnumType.FinStructure.EqualSign.小于等于 %>">
            <%=EyouSoft.Model.EnumType.FinStructure.EqualSign.小于等于 %></option>
        <option value="<%=(int)EyouSoft.Model.EnumType.FinStructure.EqualSign.不等于 %>">
            <%=EyouSoft.Model.EnumType.FinStructure.EqualSign.不等于 %></option>
    </select>
