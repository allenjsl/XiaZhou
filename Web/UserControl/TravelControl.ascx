<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TravelControl.ascx.cs"
    Inherits="Web.UserControl.TravelControl" %>
<%@ Register Assembly="ControlLibrary" Namespace="ControlLibrary" TagPrefix="cc1" %>
<span class="formtableT formtableT02" style=" position:static">游客信息</span><span class="formtableT formtableT02" style=" position:static"><a
    href="javascript:void(0);" id="btnImportData">导入游客</a></span>
<table width="99%" border="0" style="border-collapse: collapse" id="TravelControl_tbl">
    <tbody>
        ...
        <tr class="tempRow">
            ...
            <td align="center">
                <input type="text" class="inputtext" value="" name="txt_TravelControl_Prove" style="width: 125px">
            </td>
            <td align="center">
            ...
            <td align="center">
                <input type="text" value="" class="inputtext formsize80" name="txt_TravelControl_Phone"
                    valid="isTel" errmsg="输入的电话、手机格式不对!">
            </td>
            <td align="center">
                <a class="baoxian" href="javascript:void(0);" onclick="TravelControl.Open(this);">
                    <img border="0" src="/images/y-cuohao.gif"></a>
                <input type="hidden" name="hideInsuranceID" />
                <input type="hidden" name="hideInsuranceName" />
                <input type="hidden" name="hideInsurancePrice" />
                <input type="hidden" name="hideInsuranceCount" />
            </td>
            <td align="center">
        ...
        <cc1:CustomRepeater ID="rptList" runat="server">
            <ItemTemplate>
                <tr class="tempRow">
                    ...
                    <td align="center">
                        <a class="baoxian" href="javascript:void(0);" onclick="TravelControl.Open(this);">
                            <%#this.GetInsuranceImage(Eval("OrderTravellerInsuranceList"))%></a>
                        <input type="hidden" name="hideInsuranceID" value="<%#this.GetInsuranceID(Eval("OrderTravellerInsuranceList"))%>" />
                        <input type="hidden" name="hideInsuranceName" value="<%#this.GetInsuranceName(Eval("OrderTravellerInsuranceList"))%>" />
                        <input type="hidden" name="hideInsurancePrice" value="<%#this.GetInsurancePrice(Eval("OrderTravellerInsuranceList"))%>" />
                        <input type="hidden" name="hideInsuranceCount" value="<%#this.GetInsuranceCount(Eval("OrderTravellerInsuranceList"))%>" />
                    </td>
                    <td align="center">
                        <input type="text" class="inputtext formsize120" name="txt_TravelControl_Remarks"
                            value="<%#Eval("Remark")%>">
