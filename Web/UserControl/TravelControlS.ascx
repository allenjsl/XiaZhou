<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TravelControlS.ascx.cs"
    Inherits="Web.UserControl.TravelControlS" %>
        ...
        <asp:Repeater ID="rptList" runat="server">
            <ItemTemplate>
                <tr class="tempRow">
                    ...
                    <td align="center">
                        <input type="text" value="<%#Eval("Contact") %>" class="inputtext formsize80" valid="isTel"
                            errmsg="输入的电话、手机格式不对!" name="txt_TravelControlS_ContactTel" />
                    </td>
                    <td align="center">
