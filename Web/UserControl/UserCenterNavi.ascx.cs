    ...
    public partial class UserCenterNavi : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                switch (this.NavIndex)
                {
                    ...
                    default: this.nav_1.Attributes.Add("class", "warmdefault"); break;
                }
            }
        }
        ...
        private void PowerControl()
        {
            ...
            if (!PrivsList.Contains((int)EyouSoft.Model.EnumType.PrivsStructure.Privs.个人中心_事务提醒_变更提醒栏目))
                ...
                this.nav_7.Attributes.Add("href", "/UserCenter/WorkAwake/ChangeRemind.aspx?sl=" + (int)EyouSoft.Model.EnumType.PrivsStructure.Menu2.个人中心_事务提醒);
            if (!PrivsList.Contains((int)EyouSoft.Model.EnumType.PrivsStructure.Privs.个人中心_事务提醒_预控到期提醒栏目))
                this.phnav_8.Visible = false;
            else
                this.nav_8.Attributes.Add("href", "/UserCenter/WorkAwake/Preview/PreviewHotel.aspx?sl=" + (int)EyouSoft.Model.EnumType.PrivsStructure.Menu2.个人中心_事务提醒);
            ...
            if (!PrivsList.Contains((int)EyouSoft.Model.EnumType.PrivsStructure.Privs.个人中心_事务提醒_生日提醒栏目))
                this.phnav_11.Visible = false;
            else
                this.nav_11.Attributes.Add("href", "/UserCenter/WorkAwake/BirthdayRemind.aspx?sl=" + (int)EyouSoft.Model.EnumType.PrivsStructure.Menu2.个人中心_事务提醒);
        }
    }
}