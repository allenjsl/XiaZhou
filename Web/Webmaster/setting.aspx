...
<asp:Content ID="Content1" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitSetting() {
            ...
            $("#txtShouKuanZhiFuFangShi").val(setting.ShouKuanZhiFuFangShi);
            $("#txtFuKuanZhiFuFangShi").val(setting.FuKuanZhiFuFangShi);
        }
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageContent" runat="server">
    <table cellpadding="2" cellspacing="1" style="font-size: 12px; width: 100%;">
        ...
        <tr>   
             <td>
                <span class="unrequired">*</span>是否自动删除无效散拼计划：
                <label>
                    <input type="checkbox" id="chkIsZiDongShanChuSanPinJiHua" name="chkIsZiDongShanChuSanPinJiHua"
                        value="1" />自动删除出团时间超过5天，销售未派计划，没有订单的散拼计划</label>
            </td>
        </tr>
        <tr>   
             <td>
                <span class="unrequired">*</span>默认的收款支付方式：
                <select name="txtShouKuanZhiFuFangShi" id="txtShouKuanZhiFuFangShi">
                    <option value="0">请选择</option>
                    <asp:Literal runat="server" ID="ltrShouKuanZhiFuFangShi"></asp:Literal>
                </select>
            </td>
        </tr>
        <tr>   
             <td>
                <span class="unrequired">*</span>默认的付款支付方式：
                <select name="txtFuKuanZhiFuFangShi" id="txtFuKuanZhiFuFangShi">
                    <option value="0">请选择</option>
                    <asp:Literal runat="server" ID="ltrFuKuanZhiFuFangShi"></asp:Literal>
                </select>
            </td>
        </tr>        
        <tr>
