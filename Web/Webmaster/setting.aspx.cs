    ...
    public partial class setting : WebmasterPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                InitShouKuanZhiFuFangShi();
                InitFuKuanZhiFuFangShi();
            }
        }
        ...
        void InitPrintDefaultSetting()
        {
            ...
            items.Add(new EyouSoft.Model.ComStructure.PrintDocument()
            {
                PrintTemplateType = EyouSoft.Model.EnumType.ComStructure.PrintTemplateType.景点预控确认单,
                PrintTemplate = "/printpage/xz/jingdianyukongquerendan.aspx"
            });
            items.Add(new EyouSoft.Model.ComStructure.PrintDocument()
            {
                PrintTemplateType = EyouSoft.Model.EnumType.ComStructure.PrintTemplateType.其他预控确认单,
                PrintTemplate = "/printpage/xz/qitayukongquerendan.aspx"
            });

            items.Add(new EyouSoft.Model.ComStructure.PrintDocument()
            {
                PrintTemplateType = EyouSoft.Model.EnumType.ComStructure.PrintTemplateType.单项业务游客确认单,
                PrintTemplate = "/printpage/xz/danxiangyewuyoukequerendan.aspx"
            });

            items.Add(new EyouSoft.Model.ComStructure.PrintDocument()
            {
                PrintTemplateType = EyouSoft.Model.EnumType.ComStructure.PrintTemplateType.单项业务供应商确认单,
                PrintTemplate = "/printpage/xz/danxiangyewugysquerendan.aspx"
            });
        ...
        /// <summary>
        /// init shoukuan zhifufangshi
        /// </summary>
        void InitShouKuanZhiFuFangShi()
        {
            var items = new EyouSoft.BLL.ComStructure.BComPayment().GetList(CompanyId,null, EyouSoft.Model.EnumType.ComStructure.ItemType.收入);
            ...
            ltrShouKuanZhiFuFangShi.Text = s.ToString();
        }
