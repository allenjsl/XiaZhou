    ...
    <asp:Repeater runat="server" ID="rptSys" OnItemDataBound="rptSys_ItemDataBound">
        ...
        <ItemTemplate>
            <tr onmouseover="changeTrBgColor(this,'#eeeeee')" onmouseout="changeTrBgColor(this,'#ffffff')">
                ...
                <td>
                    <%#((EyouSoft.Model.ComStructure.MPasswordInfo)Eval("Password")).NoEncryptPassword%>
                </td>                
                <td style="text-align:left;">&nbsp;&nbsp;
                    ...
                    <a href="menu.aspx?sysid=<%#Eval("SysId") %>&cid=<%#Eval("CompanyId") %>">栏目</a>&nbsp;
                    ...
                    <a href="kis.aspx?sysid=<%#Eval("SysId ") %>&cid=<%#Eval("CompanyId") %>">金蝶</a>&nbsp;                    
