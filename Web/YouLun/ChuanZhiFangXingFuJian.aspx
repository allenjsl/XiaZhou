<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChuanZhiFangXingFuJian.aspx.cs"
    Inherits="EyouSoft.Web.YouLun.ChuanZhiFangXingFuJian" ValidateRequest="false" %>
...
<body style="background: none;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="200" align="center">
                                                <input type="hidden" name="hidFuJianId" value="<%#Eval("FuJianId") %>" />
                                                <select id="MingCheng" name="MingCheng" valid="isNo" errmsg="请选择<%=S%>" novalue="-1">
                                                    <%#GetFangXing(Eval("FangXingId")) %>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="200" align="center" colspan="3">
                                                <textarea name="MiaoShu" class="inputtext" style="width: 99%;" valid="required" errmsg="请输入描述"><%#Eval("MiaoShu")%></textarea>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <table width="100%" style="margin-top: 5px; margin-bottom: 5px;" id="Table1">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="200" align="center">
                                            <input type="hidden" name="hidFuJianId" />
                                            <select id="MingCheng" name="MingCheng" valid="isNo" errmsg="请选择<%=S%>" novalue="-1">
                                                    <%=GetFangXing("") %>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="200" align="center" colspan="3">
                                            <textarea name="MiaoShu" class="inputtext" style="width: 99%;" valid="required" errmsg="请输入描述"></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <script type="text/javascript">
        var pageDataJs = {
            Params: { sl: '<%=EyouSoft.Common.Utils.GetQueryStringValue("sl") %>', type: '<%=EyouSoft.Common.Utils.GetQueryStringValue("type") %>', id: '<%=EyouSoft.Common.Utils.GetQueryStringValue("id") %>', t: '<%=EyouSoft.Common.Utils.GetQueryStringValue("t") %>' },
            UnBindBtn: function() {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/youlun/ChuanZhiFangXingFuJian.aspx?save=save&" + $.param(pageDataJs.Params),
