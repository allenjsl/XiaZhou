<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChuanZhiMeiShi.aspx.cs"
    Inherits="EyouSoft.Web.YouLun.ChuanZhiMeiShi" ValidateRequest="false" %>
                                        ...
                                        <tr>
                                            ...
                                            <td width="200" align="center">
                                                <input type="text" value="<%#Eval("MingCheng") %>" class="inputtext formsize180"
                                                    name="MingCheng" valid="required" errmsg="请输入美食名称！" />
                                            </td>
        ...
        var pageDataJs = {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/youlun/ChuanZhiMeiShi.aspx?save=save&" + $.param(pageDataJs.Params),
