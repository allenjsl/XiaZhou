<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="DingDan.aspx.cs" Inherits="EyouSoft.Web.YouLun.DingDan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbox">
        <div style="background: none #f6f6f6;" class="tablehead">
            <ul class="fixed">
                <li><s class="orderformicon"></s><a class="ztorderform de-ztorderform" id="cjyl"
                    hidefocus="true" href="DingDan.aspx?sl=98"><span>长江游轮</span></a></li>
                <li><s class="orderformicon"></s><a class="ztorderform " id="hyyl" hidefocus="true"
                    href="DingDanHaiYang.aspx?sl=98"><span>海洋游轮</span></a></li>
            ...
            <span class="searchT">
                <p>
                    ...
                    订单状态<select name="dingdanzhuangtai" class="inputselect" style="width: 120px;">
                        ...
                        <%=EyouSoft.Common.UtilsCommons.GetEnumDDL(EyouSoft.Common.EnumObj.GetList(typeof(EyouSoft.Model.EnumType.YlStructure.HangQiDingDanStatus), new string[] { "2", "3", "6" }), EyouSoft.Common.Utils.GetQueryStringValue("dingdanzhuangtai"))%>
                    </select>
