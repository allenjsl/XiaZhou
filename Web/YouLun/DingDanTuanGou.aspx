<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="DingDanTuanGou.aspx.cs" Inherits="EyouSoft.Web.YouLun.HangQiTuanGou" %>
    ...
    <div class="mainbox">
        <div style="background: none #f6f6f6;" class="tablehead">
            <ul class="fixed">
                ...
                <li><s class="orderformicon"></s><a class="ztorderform de-ztorderform" id="tgdd"
                    hidefocus="true" href="DingDanTuanGou.aspx?sl=98"><span>团购订单</span></a></li>
            </ul>
        </div>
