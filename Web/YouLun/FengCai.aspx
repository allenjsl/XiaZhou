<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FengCai.aspx.cs" Inherits="EyouSoft.Web.YouLun.FengCai"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="tablelist-box">
            <table width="100%" id="liststyle">
                ...
                <asp:Repeater ID="rpt" runat="server">
                    <ItemTemplate>
                        <tr class="odd" i_fengcaiid="<%#Eval("FengCaiId") %>">
                            <td class="thinputbg" style="text-align: center;">
                                <input type="checkbox" id="checkbox" name="checkbox" value='<%# Eval("FengCaiId") %>'>
                            </td>
                            <td class="th-line">
                                <%#Eval("MingCheng")%>
                            </td>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            insert: function() {
                Boxy.iframeDialog({ iframeUrl: "FengCaiEdit.aspx?sl=<%=SL %>", title: "新增员工风采", modal: true, width: "680px", height: "300px", afterHide: function() { iPage.reload(); } });
            },
            xiuGai: function(obj) {
                var _$tr = $(obj).closest("tr");
                Boxy.iframeDialog({ iframeUrl: "FengCaiEdit.aspx?sl=<%=SL %>&editid=" + _$tr.attr("i_fengcaiid"), title: "修改员工风采", modal: true, width: "680px", height: "300px", afterHide: function() { iPage.reload(); } });
            },
            shanChu: function(obj) {
                if (!confirm("你确定要删除吗?")) return false;
                var _$tr = $(obj).closest("tr");
                var _data = { txtFengCaiId: _$tr.attr("i_fengcaiid") };
                $.ajax({ type: "POST", url: "FengCai.aspx?doType=shanchu&sl=<%=SL %>", data: _data, cache: false, dataType: "json", async: false,
