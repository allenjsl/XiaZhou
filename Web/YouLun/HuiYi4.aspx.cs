...
namespace EyouSoft.Web.YouLun
{
    ...
    /// YL-海洋邮轮会议
    /// </summary>
    public partial class HuiYi4 : EyouSoft.Common.Page.BackPage
    {
        ...
        void InitInfo()
        {
            ...
            var info1 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮会议简介);
            var info2 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮会议详介);
            var info3 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮费用测算);
            txtV1.Value = info1.V;
            txtV2.Value = info2.V;
            txtV3.Value = info3.V;
        }
        ...
        void BaoCun()
        {
            ...
            info1.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮会议简介;
            ...
            info2.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮会议详介;
            ...
            info3.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮费用测算;
