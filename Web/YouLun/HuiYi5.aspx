<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuiYi5.aspx.cs" Inherits="EyouSoft.Web.YouLun.HuiYi5"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            baoCun: function() {
                KEditer.sync();
                $.ajax({ type: "post", cache: false, url: "HuiYi5.aspx?dotype=baocun&sl=<%=SL %>", data: $("#i_baocun").closest("form").serialize(), dataType: "json",
