...
namespace EyouSoft.Web.YouLun
{
    ...
    /// YL-海洋邮轮会议
    /// </summary>
    public partial class HuiYi5 : EyouSoft.Common.Page.BackPage
    {
        ...
        void InitInfo()
        {
            ...
            var info1 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮小型会议接待);
            var info2 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮小型会议场地选择);
            var info3 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮小型会议服务项目及流程);
            txtV1.Value = info1.V;
            txtV2.Value = info2.V;
            txtV3.Value = info3.V;
        }
        ...
        void BaoCun()
        {
            ...
            info1.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮小型会议接待;
            ...
            info2.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮小型会议场地选择;
            ...
            info3.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮小型会议服务项目及流程;
