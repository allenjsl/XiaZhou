...
namespace EyouSoft.Web.YouLun
{
    ...
    /// YL-海洋邮轮会议
    /// </summary>
    public partial class HuiYi6 : EyouSoft.Common.Page.BackPage
    {
        ...
        void InitInfo()
        {
            ...
            var info1 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议包租流程);
            var info2 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议航线介绍);
            var info3 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议包租价格);
            var info4 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议会展服务);
            var info5 = bll.GetKvInfo(CurrentUserCompanyID, EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议关切问题);
            txtV1.Value = info1.V;
            txtV2.Value = info2.V;
            txtV3.Value = info3.V;
            txtV4.Value = info4.V;
        ...
        void BaoCun()
        {
            ...
            info1.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议包租流程;
            ...
            info2.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议航线介绍;
            ...
            info3.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议包租价格;
            ...
            info4.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议会展服务;
            ...
            info5.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮大型会议关切问题;
