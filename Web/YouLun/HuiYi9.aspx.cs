...
namespace EyouSoft.Web.YouLun
{
    ...
    /// YL-会议案例
    /// </summary>
    public partial class HuiYi9 : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        /// <summary>
        /// 每页显示条数
        ...
        void InitRpt()
        {
            ...
            var items = new EyouSoft.BLL.YlStructure.BWz().GetHuiYiAnLis(CurrentUserCompanyID, pageSize, pageIndex, ref recordCount, chaXun);
        ...
        /// </summary>
        /// <returns></returns>
        EyouSoft.Model.YlStructure.MWzHuiYiAnLiChaXunInfo GetChaXunInfo()
        {
            var info = new EyouSoft.Model.YlStructure.MWzHuiYiAnLiChaXunInfo();
        ...
        void ShanChu()
        {
            string txtAnLiId = Utils.GetFormValue("txtAnLiId");

            int bllRetCode = new EyouSoft.BLL.YlStructure.BWz().DeleteHuiYiAnLi(SiteUserInfo.CompanyId, txtAnLiId);
