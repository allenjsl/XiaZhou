<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiPinKaDingDanEdit.aspx.cs"
    Inherits="EyouSoft.Web.YouLun.LiPinKaDingDanEdit" MasterPageFile="~/MasterPage/Boxy.Master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="PageBody">
    <div class="alertbox-outbox">
        ...
        <div style="width: 99%; margin: 0px auto;">
            <table cellspacing="0" cellpadding="0" style="width: 100%; margin: 0 auto" class="firsttable">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Literal runat="server" ID="ltrLiPinKaMingCheng"></asp:Literal>
                    </td>
                </tr>
                <tr>
                    <td style="background: #b7e0f3; height: 30px; text-align: left; width: 80px;" class="addtableT">
                    ...
                    <td>
                        <asp:Literal runat="server" ID="ltrLiPinKaLeiXing"></asp:Literal>
                    </td>
                </tr>
                <tr>
                    <td style="background: #b7e0f3; height: 30px; text-align: left; width: 80px;" class="addtableT">
                    ...
                    <td>
                        <asp:Literal runat="server" ID="ltrLiPinKaJinE"></asp:Literal>
                    </td>
                </tr>
                <tr>
                    <td style="background: #b7e0f3; height: 30px; text-align: left; width: 80px;" class="addtableT">
                ...
                <tr>
                    ...
                    <td style="line-height: 24px;">
                        <asp:Literal runat="server" ID="ltrSlrXingMing"></asp:Literal>
                    </td>
                </tr>
                <tr>
                    <td style="background: #b7e0f3; height: 30px; text-align: left; width: 80px;" class="addtableT">
                    ...
                    <td style="line-height: 24px;">
                        <asp:Literal runat="server" ID="ltrSlrDiZhi"></asp:Literal>
                    </td>
                </tr>
                <tr>
                    <td style="background: #b7e0f3; height: 30px; text-align: left; width: 80px;" class="addtableT">
                    ...
                    <td style="line-height: 24px;">
                        <asp:Literal runat="server" ID="ltrZengYu"></asp:Literal>
                    </td>
                </tr>                
                <tr>
                    <td style="background: #b7e0f3; height: 30px; text-align: left; width: 80px;" class="addtableT">
        ...
        <div style="text-align: right;" class="alertbox-btn">
            <asp:PlaceHolder runat="server" ID="phQuXiao" Visible="false"><a href="javascript:void(0)"
                id="i_quxiao">取消订单</a> </asp:PlaceHolder>
