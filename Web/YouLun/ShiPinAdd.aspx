<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShiPinAdd.aspx.cs" Inherits="EyouSoft.Web.YouLun.ShiPinAdd" %>
...
<body style="background: none;">
        ...
        <table width="99%" cellspacing="0" cellpadding="0" bgcolor="#e9f4f9" align="center"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td height="28" align="left">
                        <select id="txtChuanZhi" name="txtChuanZhi" class="inputselect" valid="required"
                            i_val="<%=ChuanZhiId %>" errmsg="请选择船只！">
                            <option value="">请选择</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td height="28" align="left">
                        <asp:TextBox ID="txtSPName" CssClass=" inputtext formsize180" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td height="28" align="left" bgcolor="#e0e9ef">
                        <asp:TextBox runat="server" ID="txtURL" Height="65" CssClass="inputtext formsize450"
                ...
                <tr>
                    ...
                    <td height="28" align="left" bgcolor="#e0e9ef">
                        <span id="spanPlanContent" style="display: inline-block;">
                            <asp:TextBox ID="txtMiaoShu" Height="65" CssClass="inputtext formsize450" runat="server"
    ...
    <script type="text/javascript">
        var pageDataJs = {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/youlun/shipinadd.aspx?save=save&" + $.param(pageDataJs.Params),
        ...
        $(function() {
            ...
            $("#txtXiLie").bind("change", function() { initChuanZhi(); });
        });

        function initXiLie() {
            if ($("#<%=YLCompanySelect1.CompIDClient %>").val().length < 36) return;
            $.ajax({
                url: "shipinadd.aspx?sl=96&getXL=1&gongsi=" + $("#<%=YLCompanySelect1.CompIDClient %>").val(),
                dataType: "json",
                success: function(ret) {
                    if (ret.result == "1") {
                        $("#txtXiLie").empty();
        ...
        function initChuanZhi() {
            ...
            $.ajax({
                url: "shipinadd.aspx?sl=96&getCZ=1&gongsi=" + $("#<%=YLCompanySelect1.CompIDClient %>").val() + "&xilie=" + $("#txtXiLie").val() + "&sid=",
                dataType: "json",
                success: function(ret) {
                    if (ret.result == "1") {
                        $("#txtChuanZhi").empty();
