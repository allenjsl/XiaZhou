<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucupload.ascx.cs"
    Inherits="Web.YouLun.WUC.wucupload" %>
...
.upload_y_ul li img{ margin-top:14px;}
</style>
