...
namespace EyouSoft.Web.YouLun
{
    ...
    /// YL-网站介绍相关-支付方式
    /// </summary>
    public partial class WangZhan3 : EyouSoft.Common.Page.BackPage
    {
        ...
        void BaoCun()
        {
            ...
            info1.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.支付方式_在线支付;
            ...
            info2.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.支付方式_门店支付;
            ...
            info3.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.支付方式_邮局汇款;
            ...
            info4.K = EyouSoft.Model.EnumType.YlStructure.WzKvKey.支付方式_公司转账;
