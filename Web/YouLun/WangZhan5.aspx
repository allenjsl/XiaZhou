<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WangZhan5.aspx.cs" Inherits="EyouSoft.Web.YouLun.WangZhan5"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbox mainbox-whiteback">
        ...
        <div class="tablelist-box">
            <table width="100%" align="center" id="liststyle">
                ...
                <tr>
                    <th align="center" class="th-line" style="background: #fff;">
                        <textarea runat="server" id="txtV5"></textarea>
                    </th>
                </tr>
            </table>
        </div>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            baoCun: function() {
                KEditer.sync();
                $.ajax({ type: "post", cache: false, url: "wangzhan5.aspx?dotype=baocun&sl=<%=SL %>", data: $("#i_baocun").closest("form").serialize(), dataType: "json",
        ...
        $(document).ready(function() {
            ...
            KEditer.init('<%=txtV5.ClientID %>', _keoptions);
