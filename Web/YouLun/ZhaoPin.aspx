<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZhaoPin.aspx.cs" Inherits="EyouSoft.Web.YouLun.ZhaoPin"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="tablelist-box">
            <table width="100%" id="liststyle">
                ...
                <asp:Repeater ID="rpt" runat="server">
                    <ItemTemplate>
                        <tr class="odd" i_gangweiid="<%#Eval("GangWeiId") %>">
                            <td class="thinputbg" style="text-align: center;">
                                <input type="checkbox" id="checkbox" name="checkbox" value='<%# Eval("GangWeiId") %>'>
                            </td>
                            <td class="th-line">
                                <%#Eval("MingCheng")%>
                            </td>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            insert: function() {
            Boxy.iframeDialog({ iframeUrl: "ZhaoPinEdit.aspx?sl=<%=SL %>", title: "新增招聘岗位", modal: true, width: "680px", height: "300px", afterHide: function() { iPage.reload(); } });
            },
            xiuGai: function(obj) {
                var _$tr = $(obj).closest("tr");
                Boxy.iframeDialog({ iframeUrl: "ZhaoPinEdit.aspx?sl=<%=SL %>&editid=" + _$tr.attr("i_gangweiid"), title: "修改招聘岗位", modal: true, width: "680px", height: "300px", afterHide: function() { iPage.reload(); } });
            },
            shanChu: function(obj) {
                if (!confirm("你确定要删除吗?")) return false;
                var _$tr = $(obj).closest("tr");
                var _data = { txtGangWeiId: _$tr.attr("i_gangweiid") };
                $.ajax({ type: "POST", url: "ZhaoPin.aspx?doType=shanchu&sl=<%=SL %>", data: _data, cache: false, dataType: "json", async: false,
