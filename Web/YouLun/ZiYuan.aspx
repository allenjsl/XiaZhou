<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="ZiYuan.aspx.cs" Inherits="EyouSoft.Web.YouLun.ZiYuan" %>
        ...
        <div class="searchbox fixed">
            <span class="searchT">
                <p>
                    ...
                    公司名称：<input type="text" class=" inputtext formsize120" name="name" id="txtName" value="<%=EyouSoft.Common.Utils.GetQueryStringValue("name") %>" />
                    公司类型：<select name="leixing" id="txtStatus" class="inputselect">
                        <%=EyouSoft.Common.UtilsCommons.GetEnumDDL(EyouSoft.Common.EnumObj.GetList(typeof(EyouSoft.Model.EnumType.YlStructure.YouLunLeiXing)), EyouSoft.Common.Utils.GetQueryStringValue("leixing"), "", "请选择")%>
                    </select>
                        ...
                        <ItemTemplate>
                            <tr class="<%#Container.ItemIndex%2==0?"":"#odd" %>">
                                ...
                                <td align="center">
                                    ...
                                    <input class="hiddenid" type="hidden" value="<%#Eval("GongSiId") %>" />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </cc2:CustomRepeater>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $(".update").click(function() {
                var url = '/YouLun/ZiYuanAdd.aspx?id=' + $(this).closest("td").find(".hiddenid").val() + "&" + $.param(pageDataJs.Params)
                Boxy.iframeDialog({
                    iframeUrl: url,
                    title: "修改",
                    modal: true,
            ...
            $(".toolbar_add").click(function() {
                var url = '/YouLun/ZiYuanAdd.aspx?' + $.param(pageDataJs.Params)
                Boxy.iframeDialog({
                    iframeUrl: url,
                    title: "添加",
                    modal: true,
            ...
            $(".del").click(function() {
                var url = '/YouLun/ZiYuan.aspx?del=1&sl=96&id=' + $(this).closest("td").find(".hiddenid").val()
                $.newAjax({
                    url: url,
                    dataType: "json",
                    type: "post",
