<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LianXi.aspx.cs" Inherits="EyouSoft.YlWeb.Corp.LianXi"
    MasterPageFile="~/MasterPage/M1.Master" Title="联系我们" %>
            ...
            <div class="jifen_leftbox">
                <div class="com_menu">
                    <ul>
                        ...
                        <li><a class="on" href="lianxi.aspx">联系我们</a></li>
