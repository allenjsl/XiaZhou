...
namespace EyouSoft.YlWeb.Corp
{
    ...
    /// 我们的荣誉
    /// </summary>
    public partial class RongYu : WzPage
    {
        ...
        void InitRpt()
        {
            ...
            int pageIndex = 1;
            int recordCount = 0;
            var chaXun = new EyouSoft.Model.YlStructure.MWzGongSiRongYuChaXunInfo();
            var items = new EyouSoft.BLL.YlStructure.BWz().GetGongSiRongYus(YuMingInfo.CompanyId, pageSize, pageIndex,ref recordCount, chaXun);
