<%@ Page Title="海洋游轮详细" Language="C#" MasterPageFile="~/MasterPage/Boxy.Master" AutoEventWireup="true"
    CodeBehind="HaiYangInfo.aspx.cs" Inherits="EyouSoft.YlWeb.Hangqi.HaiYangInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <div class="mainbox" id="ph_Page1">
            ...
            <dl class="yudin_box01_L">
                ...
                <dd style="text-align: center;">
                    <span class="s_price">价格：</span><span class="b_price"><asp:Literal ID="txt_YL_Jiage"
                        runat="server"></asp:Literal></span><span class="s_price">起</span><b class="font_gray"
                            data-id="qijiashuoming">【起价说明】</b><span style="display:none;"><%=FromHangqi.QiShiJiaGeShuoMing%></span><b
                ...
                <dd class="wid50">
                    <span class="dd_t">航线性质：</span><asp:Literal ID="txt_YL_XingZhi" runat="server"></asp:Literal></dd>
                <dd class="wid50">
                    <span class="dd_t">游轮公司：</span>
                    <asp:Literal ID="txt_YL_GongSi" runat="server"></asp:Literal>
                </dd>
                <dd class="wid50">
                    <span class="dd_t">行程天数：</span><asp:Literal ID="txt_YL_XingChengTianShu" runat="server"></asp:Literal></dd>
                <dd class="wid50">
                    <span class="dd_t">船只名称：</span><asp:Literal ID="txt_YL_ChanZhiMingCheng" runat="server"></asp:Literal></dd>
                <dd class="wid50">
                    <span class="dd_t">登船港口：</span><asp:Literal ID="txt_YL_DengChuan" runat="server"></asp:Literal></dd>
                <dd class="wid50">
                    <span class="dd_t">下船港口：</span><asp:Literal ID="txt_YL_XiaChuan" runat="server"></asp:Literal></dd>
                <dd>
                    <span class="dd_t">途经城市：</span><asp:Literal ID="txt_YL_TuJingChengShi" runat="server"></asp:Literal></dd>
                <dd>
                    <span class="dd_t">产品特色：</span><span class="dd_content" style="height: 22px;" data-id="chanpintese"><%=FromHangqi.ChanPinTeSe%></span></dd>
            </dl>
                ...
                <div id="n4Tab1" class="n4Tab_msg">
                    ...
                    <div class="msg_Content">
                        <div id="n4Tab1_Content0" style="display: block;">
                            <div class="yljs_img">
                                <a target="_blank" href="/Youlun/ChuanZhi.aspx?id=<%=FromHangqi.ChuanZhiId %>"><asp:Literal ID="txt_YL_JieShaoImage" runat="server"></asp:Literal></a></div>
                            <div class="yljs_cont">
                                <h3>
                                    <asp:Literal ID="txt_YL_JSName" runat="server"></asp:Literal></h3>
                                <p>
                                    <asp:Literal ID="txt_YL_JScontent" runat="server"></asp:Literal>
                                    <a target="_blank" href="/Youlun/ChuanZhi.aspx?id=<%=FromHangqi.ChuanZhiId %>">【查看全部】</a></p>
                            </div>
                        </div>
                        ...
                        <div class="none" id="n4Tab1_Content2" style="display: none;">
                            <div class="meishijs msjs">
                                ...
                                <div class="chakan_more">
                                    <a target="_blank" href="/Youlun/ChuanZhi.aspx?id= <%=FromHangqi.ChuanZhiId %>#meishi">
                                        查看更多 +</a></div>
                            </div>
                        </div>
                        <div class="none" id="n4Tab1_Content3" style="display: none;">
                            <div class="meishijs msjs">
                                ...
                                <div class="chakan_more">
                                    <a target="_blank" href="/Youlun/ChuanZhi.aspx?id= <%=FromHangqi.ChuanZhiId %>#sheshi">
                                        查看更多 +</a></div>
                            </div>
                        </div>
                        <div class="none" id="n4Tab1_Content4" style="display: none;">
                            <div class="pmt">
                                <a target="_blank" href="/Youlun/ChuanZhi.aspx?id= <%=FromHangqi.ChuanZhiId %>#pingmian"><asp:Literal ID="txt_YL_PingMian" runat="server"></asp:Literal></a>
                                <div class="chakan_more">
                                    <a target="_blank" href="/Youlun/ChuanZhi.aspx?id= <%=FromHangqi.ChuanZhiId %>#pingmian">
                                        查看更多 +</a></div>
                            </div>
                        </div>
        ...
        <div class="yudin_box03 margin_T16" id="ydclickto">
            ...
            <div class="yd_step2 fixed" style="background: #F3E1C0 url(/images/yd-1.jpg) no-repeat;"
                id="showTable">
            </div>
            <div id="i_div_riqi_xx" style="height: 30px; line-height: 30px;">
            </div>
            <div class="yd_step2">
                <h3>
                    请确定房型与人数：
        ...
        <div class="yudin_box04 margin_T16">
            <div id="n4Tab3" class="n4Tab_xch">
                <div class="xch_T hy-xch_T">
                    <ul>
                        ...
                        <li class="normal" onmouseover="nTabs('n4Tab3',this);" id="n4Tab3_Title6"><a href="javascript:void(0);">
                            用户点评</a></li>
                        <li class="normal" onmouseover="nTabs('n4Tab3',this);" id="n4Tab3_Title7"><a href="javascript:void(0);">
                            咨询问答</a></li>
                    </ul>
                </div>
                <div class="xch_Content">
                    ...
                    <div class="none" id="n4Tab3_Content2" style="display: none;">
                        <div class="xch_box02">
                            <div class="icon_title feiyong_t">
                                签证/签注</div>
                            <div class="xc_listbox">
                                <asp:Literal ID="txt_YL_QianZheng" runat="server"></asp:Literal>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="none" id="n4Tab3_Content7" style="display: none;">
                        <div class="xch_box02">
            ...
            <uc1:HistoryView ID="HistoryView" LeiXing="海洋邮轮" runat="server" />
        </div>
    </div>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <asp:Repeater ID="rptList_FujiaDetail" runat="server">
                                <ItemTemplate>
                                    <tr class="i_fujiachanpin">
                                        <td>
                                            <span data-class="fujiachanpin"><%#Eval("XiangMu")%></span>
                                            <span style="display:none;"><%#Eval("JieShao") %></span>
                                        </td>
                                        <td>
                                            <%#Eval("DanJia","{0:C2}")%>
                                        </td>
        ...
        <div class="step_basicbox margin_T16">
            ...
            <div class="jiesuan_box">
                <ul>
                    ...
                    <span id="i_span_youhui">
                        <%--<li><span>优惠信息：提前25天预订，减免400元活动</span><em>-¥400</em></li>--%></span>
                    <li><span>使用积分：<input type="text" id="txtDingDanJiFen" value="0" valid="isInt" errmsg="请从新填写积分!"
                        ...
                        点<font id="KeYongJiFen" style="color: #999;"></font>本产品最多可抵扣：<%=FromHangqi.KeDiKouJinFen%>分</span><em
        ...
        var iPage = {
            ...
            SelectDateFrom: function(obj) {
                ...
                $.ajax({
                    type: "post",
                    cache: false,
                    url: "/Hangqi/HaiYangInfo.aspx?type=selectHtml&id=" + hq + "&date=" + tourid,
                    dataType: "json",
                    data: "",
                    beforeSend: function(){
                    ...
                    success: function(ret) {
                        if (ret.result == "1") {
                            var _html = $(ret.obj);
                            _html.find("tr[data-fx='1']").each(function(i) { if (i > 2) $(this).hide(); });
                            _html.find("a[data-id='fangxingmore']").click(function() { fangxingmore(this); });
                            $(".showHtml").html(_html);
//                            $(".showHtml").find("a.jia").eq(0).click();
        ...
        var PageSet = {
            PageProductSel: function() {
                ...
                jsonItem["DingdanFangXingJinE"] = F2();
                jsonItem["FangXing"] = F1();
                var RiQiId = "";
                var RiQiTime = "";
                $("#showTable").find("div.rili_Dbox").find("td").each(function() {
                    if ($(this).attr("class") == "on") {
                        RiQiId = $(this).attr("data-id");
                        RiQiTime = $(this).attr("id");
                    }
                });
                if (RiQiId == "" && RiQiTime == "") {
                ...
                jsonItem["RiQiId"] = RiQiId;
                jsonItem["ChuFaTime"] = RiQiTime;
                _data["txt"] = (JSON.stringify(jsonItem));

                $.ajax({
                    type: "post",
                    cache: false,
                    url: "/Hangqi/HaiYangInfo.aspx?type=CheckPage",
                    dataType: "json",
                    data: _data,
                    success: function(ret) {
                        if (ret.result == "1") {
                            ...
                            $("#ph_Page2").show();
                            $("#stepHtml").html("");
                            $("#stepHtml").append(ret.obj.html);
                            $("#td_page1renshu").html(tableToolbar.getInt(ret.obj.DingdanRenShu) + "人");
                            $("#td_page1renshu").attr("date-rs", tableToolbar.getInt(ret.obj.DingdanRenShu))
                            $("#td_page1zong").html("￥" + tableToolbar.getFloat(ret.obj.DingdanFangXingJinE));
                            $("#td_page1zong").attr("date-m", tableToolbar.getFloat(ret.obj.DingdanFangXingJinE));
                            $("#td_page1renjun").html("￥" + tableToolbar.getFloat(ret.obj.DingdanRenjun));
                            $("#td_page1renjun").attr("date-rj", tableToolbar.getFloat(ret.obj.DingdanRenjun));
                            $("#Page3_Zong").html("￥" + tableToolbar.getFloat(ret.obj.DingdanFangXingJinE));
                            ...
                            JinEJson.DingDanJinE = tableToolbar.getFloat(ret.obj.DingdanFangXingJinE);
            ...
            JiFenCheck: function() {
                ...
                if (star) {
                    ...
                    $.newAjax({
                        type: "post",
                        cache: false,
                        url: "/Hangqi/HaiYangInfo.aspx?type=jifen",
                        dataType: "json",
                        data: _data,
                        success: function(ret) {
                            if (ret.result == "1") {
            ...
            bkHtml: function() {
                ...
                var json = "";
                var item = {};
                item["hangqiid"] = jsonItem.HangQiId;
                item["options"] = FuJiaChanPinList();
                json = JSON.stringify(item);
                var _date = { jsonHtml: json }

                $.ajax({
                    type: "post",
                    cache: false,
                    url: "/Hangqi/HaiYangInfo.aspx?type=CheckBk",
                    dataType: "json",
                    data: _date,
                    success: function(ret) {
                        if (ret.result == "1") {
                            $("#page3_fj_show").html(ret.obj.html4);
                            jsonItem["HaiYangFuJiaChanPin"] = ret.obj.FuJiaChanPin;
                            $("#<%=hd_page1json.ClientID%>").val(JSON.stringify(jsonItem));
                            var JinE = FuJiaChanPinJinE();

                            var JinEDingdan = F2();
                            $("#Page3_ShiFu").html("￥" + tableToolbar.calculate(JinE, JinEDingdan, "+"));
                            $("#Page3_ShiFu").attr("data-m", tableToolbar.calculate(JinE, JinEDingdan, "+"));
                            $("#Page3_FuJia").html("￥" + tableToolbar.getFloat(JinE));
                            $("#ph_Page1").hide();
                            $("#ph_Page2").hide();
                            $("#ph_Page3").show();
                            JinEJson.FujianChanPinJInE = FuJiaChanPinJinE();
                            _self.getYouHui();
                        }
                        else {
                            tableToolbar._showMsg(ret.msg);
            ...
            sava: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/Hangqi/HaiYangInfo.aspx?type=sava",
                    dataType: "json",
                    ...
                    success: function(ret) {
                        ...
                        if (ret.result == "1") {
                            if (ret.obj.DingDanStatus == "<%=(int)EyouSoft.Model.EnumType.YlStructure.HangQiDingDanStatus.成交 %>") {
                                ...
                                showZZ('<div class="tc-boxbg"><a class="close-btn" href="/huiyuan/dingdan.aspx"></a><div class="tc-cont"><div class="big-txt">您的订单已提交审核 !</div><div class="b_txt01">我们的工作人员将尽快核准您的订单 请您待审核后再进行支付操作</div><div class="tc-btn"><a href="/huiyuan/dingdan.aspx">好的，了解了</a></div><div class="b_txt01"><a href="/haiyang.aspx">【返回海洋邮轮首页】</a></div></div></div>');
                            }
                        }
                        else {
                            tableToolbar._showMsg(ret.msg);
            ...
            AddressSave: function() {
                ...
                if (PageSet.bindCk("in")) {
                    ...
                    $.newAjax({
                        type: "post",
                        cache: false,
                        url: "/Hangqi/HaiYangInfo.aspx?type=address",
                        dataType: "json",
                        data: _data,
                        success: function(ret) {
                            if (ret.result == "1") {
            ...
            PageBindth: function() {
                ...
                $('input:radio[name="IscheckFaPiao"]').click(function() {
                    ...
                    if (value == "1") {
                        ...
                        $("#KuaiDiJinE").html("￥" + tableToolbar.getFloat(Free));
...
+ '	    </div>'
            ...
            initDiZhi: function() {
                $.ajax({
                    type: "post", cache: false, url: "/Hangqi/HaiYangInfo.aspx?type=getdizhi", dataType: "json",
            ...
            getYouHui: function() {
                var _self = this;
                var _data = {};
                _data["txtHangQiId"] = jsonItem.HangQiId;
                _data["txtRiQiId"] = jsonItem.RiQiId;
                _data["txtRenShu"] = jsonItem.DingdanRenShu;
                _data["txtJinE"] = jsonItem.DingdanFangXingJinE;
                _data["txtYouKe"] = "";
        ...
        $(function() {
            ...
            $("a.jian").live("click", function() {
                ...
                $("#heji").html("合计：<em  class=\"b_price\">￥" + F2() + "</em>");
            ...
            $("a.page_jia").live("click", function() {
                var num = tableToolbar.getInt($(this).closest("span").find("input").val()) + 1;
                $(this).closest("span").find("input").val(num);
                var ren = tableToolbar.getInt(jsonItem.DingdanRenShu);
                var FangXingJinE = F2();
                var FuJianJinE = FuJiaChanPinJinE();
                var Page2JinE = tableToolbar.calculate(FangXingJinE, FuJianJinE, "+");
                $("#td_page1zong").html("￥" + Page2JinE);
                var JIen = tableToolbar.calculate(num, $(this).closest("span").find("input").attr("data-dj"), "*");
                $(this).closest("td").next("td").find("span").html("￥" + JIen);
                $("#td_page1renjun").html("￥" + tableToolbar.calculate(Page2JinE, ren, "/"));
            });
            $("a.page_jian").live("click", function() {
                ...
                if (num < 0) {
                    ...
                    $(danxiheji).html("￥0");
                    $(danxiheji).attr("data-m", 0);
                    $("#td_page1zong").html("￥" + tableToolbar.getFloat(FangXingJinE));
                    $("#td_page1renjun").html("￥" + tableToolbar.calculate(FangXingJinE, jsonItem.DingdanRenShu, "/"));
                    $(this).closest("td").next("td").find("span").html("￥0");
                }
                else {
                    ...
                    var FuJianJinE = FuJiaChanPinJinE();
                    var Page2JinE = tableToolbar.calculate(FangXingJinE, FuJianJinE, "+");
                    $("#td_page1zong").html("￥" + tableToolbar.getFloat(Page2JinE));
                    $("#td_page1renjun").html("￥" + tableToolbar.calculate(Page2JinE, jsonItem.DingdanRenShu, "/"));
            ...
            $(".i_fujiachanpin").find("input").blur(function() {
            ...
            $(".i_fujiachanpin").find("input").blur(function() {
                var num = tableToolbar.getInt($(this).val());
                $(this).val(num);
                var JinE = tableToolbar.calculate(F2(), FuJiaChanPinJinE(), "+");
                $("#td_page1zong").html("￥" + tableToolbar.getFloat(JinE));
                $("#td_page1renjun").html("￥" + tableToolbar.calculate(JinE, jsonItem.DingdanRenShu, "/"));
            });
            ...
            $("#shoucang").click(function() {
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/Ashx/Handler.ashx?dotype=collect&cid=" + '<%=EyouSoft.Common.Utils.GetQueryStringValue("id")  %>' + "&lxid=" + '<%=(int)EyouSoft.Model.EnumType.YlStructure.HuiYuanShouCangLeiXing.海洋游轮 %>',
                    dataType: "json",
                    data: null,
                    success: function(ret) {
                        if (ret.result == "1") {
        ...
        function F1() {
            var items = [];
            $(".i_jiage").each(function() {
                var item = {};
                item["FangXingId"] = tableToolbar.getInt($(this).attr("i_fx"));
                item["RongNaRenShu"] = tableToolbar.getInt($(this).attr("i_rnrs"));
                item["LouCeng"] = $(this).attr("i_lc"); ;
                item["FangCha"] = tableToolbar.getFloat($(this).attr("i_fc"));
                item["ShuoMing"] = "";
                item["JiaGes"] = [];

                $(this).find("input").each(function() {
                    var item1 = {};
                    item1["BinKeLeiXingId"] = $(this).attr("data-bk");

                    item1["JiaGe"] = tableToolbar.getFloat($(this).attr("data-m"));
                    item1["RenShu"] = tableToolbar.getInt($(this).val());

                    item["JiaGes"].push(item1);
                });
        ...
        function F2() {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                for (var j = 0; j < item.JiaGes.length; j++) {
                    renshu += item.JiaGes[j].RenShu;
                    var jiage1 = tableToolbar.calculate(item.JiaGes[j].RenShu, item.JiaGes[j].JiaGe, "*")
                    jiage = tableToolbar.calculate(jiage1, jiage, "+")
                }

                /*if (renshu > 0 && renshu < item.RongNaRenShu) {

                    var jiage1 = tableToolbar.calculate(item.RongNaRenShu - renshu, item.FangCha, "*")
                jiage = tableToolbar.calculate(jiage1, jiage, "+")
                }*/

                if (item.RongNaRenShu > 0 && renshu > 0) {
                    var _m = renshu % item.RongNaRenShu;
                    if (_m > 0) {
                        var buFangChaRenShu = item.RongNaRenShu - _m;
                        var fangChaJinE = tableToolbar.calculate(buFangChaRenShu, item.FangCha, "*");
                        jiage = tableToolbar.calculate(fangChaJinE, jiage, "+");
                    }
                }
            }
        ...
        function FuJiaChanPinList() {
            var item = [];
            $(".i_fujiachanpin").find("input").each(function() {
                var items = {};
                if (tableToolbar.getInt($(this).val()) > 0) {
                    ...
                    items["jn"] = tableToolbar.calculate(tableToolbar.getFloat($(this).attr("data-dj")), tableToolbar.getInt($(this).val()), "*");
                    items["lx"] = tableToolbar.getInt($(this).attr("data-lx"));
                    item.push(items);
                }
            });
            return item;
        ...
        function FuJiaChanPinJinE() {
            var item = FuJiaChanPinList();
            var JinE = 0;
            for (var i = 0; i < item.length; i++) {
                var items = item[i];
                if (items.sl > 0) {
                    JinE = tableToolbar.calculate(JinE, items.jn, "+");
                }
            }
            return JinE;
        }

        function fangxingmore(obj) {
            var fs = $(obj).attr("data-fs");

            if (fs == "+") {
                var div = $(obj).closest("div[data-id='fx']");
                div.find("tr[data-fx='1']").each(function(i) { if (i > 2) $(this).show(); });
                $(obj).html('<font style="color:#cc3939;">-</font> 点击收起更多房型</a>');
                $(obj).attr("data-fs", "-");
            }

            if (fs == "-") {
                var div = $(obj).closest("div[data-id='fx']");
                div.find("tr[data-fx='1']").each(function(i) { if (i > 2) $(this).hide(); });
                $(obj).html('<font style="color:#cc3939;">+</font> 点击查看更多房型</a>');
                $(obj).attr("data-fs", "+");
            }
        }
    </script>
