<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Boxy.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="EyouSoft.YlWeb.Hangqi.Search" Title="搜索结果" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageBody" runat="server">
        ...
        <div class="main fixed">
           <div class="leftside s_left">
                ...
                <ul data-id="paixu" class="S-paixu_list">
                    <li data-v="0" data-s="1"><a href="javascript:void(0)">综合</a> | </li>
                    <li data-v="2" data-s="0"><a href="javascript:void(0)">销量<span></span></a></li>
                    <li data-v="3" data-s="0"><a class="on_up" href="javascript:void(0)">价格<span></span></a></li>
                    <li data-v="4" data-s="0"><a href="javascript:void(0)">价格<span></span></a></li>
                </ul>
			  
                <div class="user_page_1" style="float: right; padding-top: 11px; height:22px;">
    ...
    <script type="text/javascript">
        function chaXun(pageIndex) {
            ...
            _params["cz"] = '<%=EyouSoft.Common.Utils.GetQueryStringValue("cz") %>';
            _params["gjz"] = '<%=EyouSoft.Common.Utils.GetQueryStringValue("gjz") %>';
...
//            })
        ...
        function getselect(fl,v,title,text){
            ...
            if($(_dd).length>0){
                ...
                return "<dd data-fl=\""+fl+"\" data-v=\""+v+"\" onclick=\"delselect(this)\"><a href=\"javascript:;\"><span>"+title+"：</span>"+text+"</a></dd>";
            }
        }
        ...
        $(document).ready(function() {
            ...
            if ("<%=LeiXing1 %>" == "0") setNav(1);
            if ("<%=LeiXing1 %>" == "1") setNav(2);
