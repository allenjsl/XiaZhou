...
namespace EyouSoft.YlWeb.Hangqi
{
    public partial class Search : EyouSoft.YlWeb.WzPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (LeiXing.HasValue && LeiXing.Value == EyouSoft.Model.EnumType.YlStructure.YouLunLeiXing.海洋邮轮)
            {
                S1 = "邮轮";
                S2 = "出发港口";
