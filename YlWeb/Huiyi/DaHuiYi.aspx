<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DaHuiYi.aspx.cs" Inherits="EyouSoft.YlWeb.Huiyi.DaHuiYi"
        ...
        <div class="huiyi_box" style="min-height: 550px;">
            <div class="huiyi_nav">
                <ul class="fixed">
                    ...
                    <li><a class="nav_on" href="/Huiyi/DaHuiYi.aspx?type=<%=Request.QueryString["type"] %>">大型会议包租</a></li>
            ...
            <div class="main fixed" id="n4Tab">
                <div class="C_left">
                    <ul class="xilie_menu">
                        <li><a class="on" onclick="nTabs('n4Tab',this);" id="n4Tab_Title0" href="javascript:;">
                            包租流程</a></li>
                        <li><a onclick="nTabs_01('n4Tab',this);" id="n4Tab_Title1" href="javascript:;">游船航线介绍</a></li>
                        <li><a onclick="nTabs_01('n4Tab',this);" id="n4Tab_Title2" href="javascript:;">游船包租价格</a></li>
                        <li><a onclick="nTabs_01('n4Tab',this);" id="n4Tab_Title3" href="javascript:;">会展服务</a></li>
                        <li><a onclick="nTabs_01('n4Tab',this);" id="n4Tab_Title4" href="javascript:;">关切问题</a></li>
                    </ul>
                </div>
                ...
                <div class="huiyi_content02" id="n4Tab_Content1" style="display: none">
                    <p class="huiyi_title02">
                        游船航线介绍</p>
                    <asp:Literal ID="lbjieshao" runat="server"></asp:Literal>
                </div>
                <div class="huiyi_content02" id="n4Tab_Content2" style="display: none">
                    <p class="huiyi_title02">
                        游船包租价格</p>
                    <asp:Literal ID="lbjiage" runat="server"></asp:Literal>
                </div>
                <div class="huiyi_content02" id="n4Tab_Content3" style="display: none">
                    <p class="huiyi_title02">
                        会展服务</p>
                    <asp:Literal ID="lbfuwu" runat="server"></asp:Literal>
                </div>
                <div class="huiyi_content02" id="n4Tab_Content4" style="display: none">
                    <p class="huiyi_title02">
                        关切问题</p>
                    <asp:Literal ID="lbwenti" runat="server"></asp:Literal>
                </div>
            </div>
        </div>
    </div>
