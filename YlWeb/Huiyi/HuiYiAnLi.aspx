        ...
        <div class="huiyi_box" style="min-height: 550px;">
            <div class="huiyi_nav">
                <ul class="fixed">
                    ...
                    <li><a class="nav_on" href="/Huiyi/HuiYiAnLi.aspx?type=<%=Request.QueryString["type"] %>">会议案例精选</a></li>
                ...
                <div class="huiyi_nav-R">
                    <a data-type="<%=(int)EyouSoft.Model.EnumType.YlStructure.WzKvKey.长江游轮会议详介 %>" href="/Huiyi/HuiYiAnLi.aspx?type=<%=(int)EyouSoft.Model.EnumType.YlStructure.WzKvKey.长江游轮会议详介 %>">
                        长江游轮会议</a><a data-type="<%=(int)EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮会议详介 %>"
                            href="/Huiyi/HuiYiAnLi.aspx?type=<%=(int)EyouSoft.Model.EnumType.YlStructure.WzKvKey.海洋邮轮会议详介 %>">海洋游轮会议</a></div>
            </div>
                ...
                <asp:Repeater ID="Repeater1" runat="server" 
                    ...
                    <ItemTemplate>
                        <div class="huiyi_caselist fixed">
                            <div class="hy_caseL">
                                <em><%# Container.DataItem %></em>年</div>
