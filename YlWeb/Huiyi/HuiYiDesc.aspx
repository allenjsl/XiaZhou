<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HuiYiDesc.aspx.cs" Inherits="EyouSoft.YlWeb.Huiyi.HuiYiDesc"
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageBody" runat="server">
    <div class="mainbox">
        ...
        <div class="huiyi_box" style="min-height: 550px;">
            <div class="huiyi_nav">
                <ul class="fixed">
                    <li><a class="nav_on" href="javascript:;" id="i_a_t">海洋游轮会议</a></li>
                    ...
                    <li><a href="/Huiyi/YouLunShangWu.aspx?type=<%=Request.QueryString["type"] %>">
                        游轮商务服务</a></li>
                    <li><a href="/Huiyi/YouLunFeiYong.aspx?type=<%=Request.QueryString["type"] %>">
                        游轮费用测算</a></li>
            ...
            <div class="huiyi_content">
                <asp:PlaceHolder runat="server" ID="PHCJ">
                    <p class="huiyi_title02">
                        维诗达 - 长江游轮会议专家</p>
                    <asp:Literal ID="lbcj" runat="server"></asp:Literal>
                </asp:PlaceHolder>
                <asp:PlaceHolder runat="server" ID="phhy">
                    <p class="huiyi_title02">
                        维诗达 - 海洋邮轮会议的领航者</p>
