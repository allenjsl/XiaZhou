...
namespace EyouSoft.YlWeb
{
    public class TuPian
    {
        ...
        public static byte[] ImgInfo(string url, int width, int height)
        {
            ...
            if (EyouSoft.Common.Utils.GetErpFilepath() == url) return null;
        ...
        /// <returns></returns>
        public static string F1(string filepath, int width, int height)
        {
            //string filepath1 = F2(filepath);

            return F2(filepath, width, height);
        }
        ...
        static string F2(string url)
        {
            ...
            if (EyouSoft.Common.Utils.GetErpFilepath() == url) return DIRPATH;
