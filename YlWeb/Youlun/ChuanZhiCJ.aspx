<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/M1.Master" AutoEventWireup="true"
    CodeBehind="ChuanZhiCJ.aspx.cs" Inherits="EyouSoft.YlWeb.Youlun.ChuanZhiCJ" %>
                    ...
                    <div class="left_sub">
                        ...
                        <ul class="xilie_menu">
                            <asp:Repeater ID="rptxilies" runat="server">
                                <ItemTemplate>
                                    <li class="menubg2">
                                        <a href="javascript:;"><%# Eval("MingCheng")%></a>                                        
                                    </li>
                            ...
                            <ul id="i_ul_rexiao" class="list_paihang">
                                <asp:Repeater ID="rpt_Hot" runat="server">
                                    <ItemTemplate>
                                        <li>
                                            <div class="L_img">
                                                <a href="/Hangqi/<%# Eval("HangQiId")%>.html">
                                                    <%#GetReXiaoImg(Eval("FuJians")) %>
                                                </a>
                                            </div>
                                            <dl>
                                                <dt><a href="/Hangqi/<%# Eval("HangQiId")%>.html">
                                    ...
                                    <ItemTemplate>
                                        <li style="height:auto; overflow:hidden;">
                                            <div class="fangxin_img" data-fangxingid="<%#Eval("FangXingId") %>">
                                                <a href="javascript:;">
                                                    <img src="<%# EyouSoft.YlWeb.TuPian.F1(ErpFilepath+Eval("Filepath").ToString(),300,200)%>" />
                                                </a>
                                            </div>
                                            <dl>
                                                <dt>
                        ...
                        <div class="company_cont">
                            ...
                            <div class="pinmiantu">
                                <asp:Repeater ID="rptpingmians" runat="server">
                                    <ItemTemplate>
                                        <p><img src="<%# ErpFilepath+ Eval("Filepath") %>" /></p>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </div>
                        </div>
                                    ...
                                    <ItemTemplate>
                                        <li>
                                            <div class="hanxian_img">
                                                <a href="javascript:;">
                                                    <%# GetReXiaoImg1(Eval("FuJians"))%></a></div>
                                            <div class="hanxian_R">
                                                <div class="hanxian_T">
                                                    <%# Eval("MingCheng")%></div>
                                                ...
                                                <div class="Rbox">
                                                    <span>价格：<em><%# Eval("QiShiJiaGe","{0:C0}")%></em> 起</span> <a target="_blank" href="/Hangqi/<%# Eval("HangQiId")%>.html">
                                                        立即预订</a>
                                                </div>
                                            </div>
                                        </li>
