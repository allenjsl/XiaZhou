<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Boxy.Master" AutoEventWireup="true"
    CodeBehind="YouLunGongSi.aspx.cs" Inherits="EyouSoft.YlWeb.Youlun.YouLunGongSi" %>
            ...
            <div class="C_left">
                <div class="left_sub">
                    ...
                    <div class="left_cont">
                        ...
                        <asp:Literal runat="server" ID="ltrYouShi"></asp:Literal>
                    </div>
                </div>
                <div class="left_sub margin_T16">
                    ...
                    <div class="left_cont">
                        ...
                        <asp:Literal runat="server" ID="ltrRongYu"></asp:Literal>
                    </div>
                </div>
                <div class="left_sub margin_T16">
                    <div class="left_T fixed">
                        <h5>
                            常见问题</h5>
                       <a href="/corp/zixun.aspx?t=4" class="more">更多>></a></div>
                    <div class="left_cont">
                        <ul class="question_list">
                    ...
                    <div class="left_cont">
                        <ul class="company_list">
                            <asp:Repeater ID="rpthezuos" runat="server">
                                <ItemTemplate>
                                    <li style="overflow: hidden;"><a href="/youlun/YouLunGongSi.aspx?id=<%# Eval("GongSiId") %>" title="<%#Eval("MingCheng") %>">
                                        <img src="<%#EyouSoft.YlWeb.TuPian.F1(ErpFilepath+Eval("Logo"),90,28) %>" style="width:90px; height:28px;" /><p>
                                            <%# Eval("MingCheng") %></p>
                                    </a></li>
                                </ItemTemplate>
                            </asp:Repeater>
